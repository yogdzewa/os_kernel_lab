...
exit(int error_code) {
  ...
  800306:	c7 04 24 58 11 80 00 	movl   $0x801158,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004e9:	05 84 12 80 00       	add    $0x801284,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80063d:	8b 04 85 a8 12 80 00 	mov    0x8012a8(,%eax,4),%eax
  ...
  80073f:	c7 44 24 08 9e 12 80 	movl   $0x80129e,0x8(%esp)
  800746:	00 
  ...
  80076b:	75 05                	jne    800772 <vprintfmt+0x1a3>
                p = "(null)";
  80076d:	be a1 12 80 00       	mov    $0x8012a1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801011:	c7 04 24 00 14 80 00 	movl   $0x801400,(%esp)
  ...
  80102b:	75 0e                	jne    80103b <main+0x33>
        cprintf("I am the child. spinning ...\n");
  80102d:	c7 04 24 27 14 80 00 	movl   $0x801427,(%esp)
  801034:	e8 e7 f0 ff ff       	call   800120 <cprintf>
        while (1);
  801039:	eb fe                	jmp    801039 <main+0x31>
    }
    cprintf("I am the parent. Running the child...\n");
  80103b:	c7 04 24 48 14 80 00 	movl   $0x801448,(%esp)
  801042:	e8 d9 f0 ff ff       	call   800120 <cprintf>

    yield();
  801047:	e8 11 f3 ff ff       	call   80035d <yield>
    yield();
  80104c:	e8 0c f3 ff ff       	call   80035d <yield>
    yield();
  801051:	e8 07 f3 ff ff       	call   80035d <yield>

    cprintf("I am the parent.  Killing the child...\n");
  801056:	c7 04 24 70 14 80 00 	movl   $0x801470,(%esp)
  80105d:	e8 be f0 ff ff       	call   800120 <cprintf>

    assert((ret = kill(pid)) == 0);
  801062:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801066:	89 04 24             	mov    %eax,(%esp)
  801069:	e8 ff f2 ff ff       	call   80036d <kill>
  80106e:	89 44 24 18          	mov    %eax,0x18(%esp)
  801072:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801077:	74 24                	je     80109d <main+0x95>
  801079:	c7 44 24 0c 98 14 80 	movl   $0x801498,0xc(%esp)
  801080:	00 
  801081:	c7 44 24 08 af 14 80 	movl   $0x8014af,0x8(%esp)
  801088:	00 
  801089:	c7 44 24 04 14 00 00 	movl   $0x14,0x4(%esp)
  801090:	00 
  801091:	c7 04 24 c4 14 80 00 	movl   $0x8014c4,(%esp)
  801098:	e8 92 ef ff ff       	call   80002f <__panic>
    cprintf("kill returns %d\n", ret);
  80109d:	8b 44 24 18          	mov    0x18(%esp),%eax
  8010a1:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010a5:	c7 04 24 d0 14 80 00 	movl   $0x8014d0,(%esp)
  8010ac:	e8 6f f0 ff ff       	call   800120 <cprintf>
  ...
  8010c0:	e8 7c f2 ff ff       	call   800341 <waitpid>
  8010c5:	89 44 24 18          	mov    %eax,0x18(%esp)
  8010c9:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8010ce:	74 24                	je     8010f4 <main+0xec>
  8010d0:	c7 44 24 0c e4 14 80 	movl   $0x8014e4,0xc(%esp)
  8010d7:	00 
  8010d8:	c7 44 24 08 af 14 80 	movl   $0x8014af,0x8(%esp)
  8010df:	00 
  8010e0:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  8010e7:	00 
  8010e8:	c7 04 24 c4 14 80 00 	movl   $0x8014c4,(%esp)
  8010ef:	e8 3b ef ff ff       	call   80002f <__panic>
    cprintf("wait returns %d\n", ret);
  8010f4:	8b 44 24 18          	mov    0x18(%esp),%eax
  8010f8:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010fc:	c7 04 24 04 15 80 00 	movl   $0x801504,(%esp)
  801103:	e8 18 f0 ff ff       	call   800120 <cprintf>

    cprintf("spin may pass.\n");
  801108:	c7 04 24 15 15 80 00 	movl   $0x801515,(%esp)
  80110f:	e8 0c f0 ff ff       	call   800120 <cprintf>
    return 0;
