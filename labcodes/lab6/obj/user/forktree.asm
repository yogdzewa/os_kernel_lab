...
exit(int error_code) {
  ...
  800306:	c7 04 24 38 11 80 00 	movl   $0x801138,(%esp)
...
umain(void) {
  ...
  8003c9:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003cc:	e8 f4 0c 00 00       	call   8010c5 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004e9:	05 64 12 80 00       	add    $0x801264,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80063d:	8b 04 85 88 12 80 00 	mov    0x801288(,%eax,4),%eax
  ...
  80073f:	c7 44 24 08 7e 12 80 	movl   $0x80127e,0x8(%esp)
  800746:	00 
  ...
  80076b:	75 05                	jne    800772 <vprintfmt+0x1a3>
                p = "(null)";
  80076d:	be 81 12 80 00       	mov    $0x801281,%esi
            }
            if (width > 0 && padc != '-') {
...
forkchild(const char *cur, char branch) {
  ...
  80100b:	83 ec 48             	sub    $0x48,%esp
  80100e:	8b 45 0c             	mov    0xc(%ebp),%eax
  801011:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  801014:	8b 45 08             	mov    0x8(%ebp),%eax
  801017:	89 04 24             	mov    %eax,(%esp)
  80101a:	e8 33 fb ff ff       	call   800b52 <strlen>
  80101f:	83 f8 03             	cmp    $0x3,%eax
  801022:	77 4f                	ja     801073 <forkchild+0x6b>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  801024:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  801028:	89 44 24 10          	mov    %eax,0x10(%esp)
  80102c:	8b 45 08             	mov    0x8(%ebp),%eax
  80102f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801033:	c7 44 24 08 e0 13 80 	movl   $0x8013e0,0x8(%esp)
  80103a:	00 
  80103b:	c7 44 24 04 05 00 00 	movl   $0x5,0x4(%esp)
  801042:	00 
  801043:	8d 45 f3             	lea    -0xd(%ebp),%eax
  801046:	89 04 24             	mov    %eax,(%esp)
  801049:	e8 90 f9 ff ff       	call   8009de <snprintf>
    if (fork() == 0) {
  80104e:	e8 c1 f2 ff ff       	call   800314 <fork>
  801053:	85 c0                	test   %eax,%eax
  801055:	75 1d                	jne    801074 <forkchild+0x6c>
        forktree(nxt);
  801057:	8d 45 f3             	lea    -0xd(%ebp),%eax
  80105a:	89 04 24             	mov    %eax,(%esp)
  80105d:	e8 16 00 00 00       	call   801078 <forktree>
        yield();
  801062:	e8 f6 f2 ff ff       	call   80035d <yield>
        exit(0);
  801067:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80106e:	e8 82 f2 ff ff       	call   8002f5 <exit>
        return;
  801073:	90                   	nop
    }
}
...
forktree(const char *cur) {
  ...
  80107b:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  80107e:	e8 ff f2 ff ff       	call   800382 <getpid>
  801083:	8b 55 08             	mov    0x8(%ebp),%edx
  801086:	89 54 24 08          	mov    %edx,0x8(%esp)
  80108a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80108e:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
  801095:	e8 86 f0 ff ff       	call   800120 <cprintf>
  ...
  8010a8:	e8 5b ff ff ff       	call   801008 <forkchild>
    forkchild(cur, '1');
  8010ad:	c7 44 24 04 31 00 00 	movl   $0x31,0x4(%esp)
  8010b4:	00 
  8010b5:	8b 45 08             	mov    0x8(%ebp),%eax
  8010b8:	89 04 24             	mov    %eax,(%esp)
  8010bb:	e8 48 ff ff ff       	call   801008 <forkchild>
}
  8010c0:	90                   	nop
...
main(void) {
  ...
  8010d5:	e8 9e ff ff ff       	call   801078 <forktree>
    return 0;
