...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800049:	c7 04 24 00 10 80 00 	movl   $0x801000,(%esp)
  ...
  800062:	e8 84 00 00 00       	call   8000eb <vcprintf>
    cprintf("\n");
  800067:	c7 04 24 1a 10 80 00 	movl   $0x80101a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800099:	c7 04 24 1c 10 80 00 	movl   $0x80101c,(%esp)
  ...
  8000b2:	e8 34 00 00 00       	call   8000eb <vcprintf>
    cprintf("\n");
  8000b7:	c7 04 24 1a 10 80 00 	movl   $0x80101a,(%esp)
...
exit(int error_code) {
  ...
  8002d2:	c7 04 24 38 10 80 00 	movl   $0x801038,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800490:	05 64 11 80 00       	add    $0x801164,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8005e4:	8b 04 85 88 11 80 00 	mov    0x801188(,%eax,4),%eax
  ...
  8006e6:	c7 44 24 08 7e 11 80 	movl   $0x80117e,0x8(%esp)
  8006ed:	00 
  ...
  800712:	75 05                	jne    800719 <vprintfmt+0x1a3>
                p = "(null)";
  800714:	be 81 11 80 00       	mov    $0x801181,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fb5:	83 ec 10             	sub    $0x10,%esp
    cprintf("Hello world!!.\n");
  800fb8:	c7 04 24 e0 12 80 00 	movl   $0x8012e0,(%esp)
  800fbf:	e8 5c f1 ff ff       	call   800120 <cprintf>
    cprintf("I am process %d.\n", getpid());
  800fc4:	e8 85 f3 ff ff       	call   80034e <getpid>
  800fc9:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fcd:	c7 04 24 f0 12 80 00 	movl   $0x8012f0,(%esp)
  800fd4:	e8 47 f1 ff ff       	call   800120 <cprintf>
    cprintf("hello pass.\n");
  800fd9:	c7 04 24 02 13 80 00 	movl   $0x801302,(%esp)
  800fe0:	e8 3b f1 ff ff       	call   800120 <cprintf>
    return 0;
