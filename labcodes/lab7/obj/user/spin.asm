...
exit(int error_code) {
  ...
  800323:	c7 04 24 b8 11 80 00 	movl   $0x8011b8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80051b:	05 e4 12 80 00       	add    $0x8012e4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80066f:	8b 04 85 08 13 80 00 	mov    0x801308(,%eax,4),%eax
  ...
  800771:	c7 44 24 08 fe 12 80 	movl   $0x8012fe,0x8(%esp)
  800778:	00 
  ...
  80079d:	75 05                	jne    8007a4 <vprintfmt+0x1a3>
                p = "(null)";
  80079f:	be 01 13 80 00       	mov    $0x801301,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801043:	c7 04 24 60 14 80 00 	movl   $0x801460,(%esp)
  ...
  80105d:	75 0e                	jne    80106d <main+0x33>
        cprintf("I am the child. spinning ...\n");
  80105f:	c7 04 24 87 14 80 00 	movl   $0x801487,(%esp)
  801066:	e8 b5 f0 ff ff       	call   800120 <cprintf>
        while (1);
  80106b:	eb fe                	jmp    80106b <main+0x31>
    }else if (pid<0) {
  80106d:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801072:	79 1c                	jns    801090 <main+0x56>
        panic("fork child error\n");
  801074:	c7 44 24 08 a5 14 80 	movl   $0x8014a5,0x8(%esp)
  80107b:	00 
  80107c:	c7 44 24 04 0d 00 00 	movl   $0xd,0x4(%esp)
  801083:	00 
  801084:	c7 04 24 b7 14 80 00 	movl   $0x8014b7,(%esp)
  80108b:	e8 9f ef ff ff       	call   80002f <__panic>
    }
    cprintf("I am the parent. Running the child...\n");
  801090:	c7 04 24 c4 14 80 00 	movl   $0x8014c4,(%esp)
  801097:	e8 84 f0 ff ff       	call   800120 <cprintf>

    yield();
  80109c:	e8 d9 f2 ff ff       	call   80037a <yield>
    yield();
  8010a1:	e8 d4 f2 ff ff       	call   80037a <yield>
    yield();
  8010a6:	e8 cf f2 ff ff       	call   80037a <yield>
    
    cprintf("I am the parent.  Killing the child...\n");
  8010ab:	c7 04 24 ec 14 80 00 	movl   $0x8014ec,(%esp)
  8010b2:	e8 69 f0 ff ff       	call   800120 <cprintf>

    assert((ret = kill(pid)) == 0);
  8010b7:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010bb:	89 04 24             	mov    %eax,(%esp)
  8010be:	e8 c7 f2 ff ff       	call   80038a <kill>
  8010c3:	89 44 24 18          	mov    %eax,0x18(%esp)
  8010c7:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8010cc:	74 24                	je     8010f2 <main+0xb8>
  8010ce:	c7 44 24 0c 14 15 80 	movl   $0x801514,0xc(%esp)
  8010d5:	00 
  8010d6:	c7 44 24 08 2b 15 80 	movl   $0x80152b,0x8(%esp)
  8010dd:	00 
  8010de:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  8010e5:	00 
  8010e6:	c7 04 24 b7 14 80 00 	movl   $0x8014b7,(%esp)
  8010ed:	e8 3d ef ff ff       	call   80002f <__panic>
    cprintf("kill returns %d\n", ret);
  8010f2:	8b 44 24 18          	mov    0x18(%esp),%eax
  8010f6:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010fa:	c7 04 24 40 15 80 00 	movl   $0x801540,(%esp)
  801101:	e8 1a f0 ff ff       	call   800120 <cprintf>

    assert((ret = waitpid(pid, NULL)) == 0);
  801106:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80110d:	00 
  80110e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801112:	89 04 24             	mov    %eax,(%esp)
  801115:	e8 44 f2 ff ff       	call   80035e <waitpid>
  80111a:	89 44 24 18          	mov    %eax,0x18(%esp)
  80111e:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801123:	74 24                	je     801149 <main+0x10f>
  801125:	c7 44 24 0c 54 15 80 	movl   $0x801554,0xc(%esp)
  80112c:	00 
  80112d:	c7 44 24 08 2b 15 80 	movl   $0x80152b,0x8(%esp)
  801134:	00 
  801135:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  80113c:	00 
  80113d:	c7 04 24 b7 14 80 00 	movl   $0x8014b7,(%esp)
  801144:	e8 e6 ee ff ff       	call   80002f <__panic>
    cprintf("wait returns %d\n", ret);
  801149:	8b 44 24 18          	mov    0x18(%esp),%eax
  80114d:	89 44 24 04          	mov    %eax,0x4(%esp)
  801151:	c7 04 24 74 15 80 00 	movl   $0x801574,(%esp)
  801158:	e8 c3 ef ff ff       	call   800120 <cprintf>

    cprintf("spin may pass.\n");
  80115d:	c7 04 24 85 15 80 00 	movl   $0x801585,(%esp)
  801164:	e8 b7 ef ff ff       	call   800120 <cprintf>
    return 0;
