...
main(void) {
  ...
  80100e:	83 ec 10             	sub    $0x10,%esp
    cprintf("Hello world!!.\n");
  801011:	c7 04 24 40 13 80 00 	movl   $0x801340,(%esp)
  801018:	e8 03 f1 ff ff       	call   800120 <cprintf>
    cprintf("I am process %d.\n", getpid());
  80101d:	e8 60 f3 ff ff       	call   800382 <getpid>
  801022:	89 44 24 04          	mov    %eax,0x4(%esp)
  801026:	c7 04 24 50 13 80 00 	movl   $0x801350,(%esp)
  80102d:	e8 ee f0 ff ff       	call   800120 <cprintf>
    cprintf("hello pass.\n");
  801032:	c7 04 24 62 13 80 00 	movl   $0x801362,(%esp)
  801039:	e8 e2 f0 ff ff       	call   800120 <cprintf>
    return 0;
