...
exit(int error_code) {
  ...
  800323:	c7 04 24 58 11 80 00 	movl   $0x801158,(%esp)
...
umain(void) {
  ...
  8003fb:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003fe:	e8 f4 0c 00 00       	call   8010f7 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80051b:	05 84 12 80 00       	add    $0x801284,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80066f:	8b 04 85 a8 12 80 00 	mov    0x8012a8(,%eax,4),%eax
  ...
  800771:	c7 44 24 08 9e 12 80 	movl   $0x80129e,0x8(%esp)
  800778:	00 
  ...
  80079d:	75 05                	jne    8007a4 <vprintfmt+0x1a3>
                p = "(null)";
  80079f:	be a1 12 80 00       	mov    $0x8012a1,%esi
            }
            if (width > 0 && padc != '-') {
...
forkchild(const char *cur, char branch) {
  ...
  80103d:	83 ec 48             	sub    $0x48,%esp
  801040:	8b 45 0c             	mov    0xc(%ebp),%eax
  801043:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  801046:	8b 45 08             	mov    0x8(%ebp),%eax
  801049:	89 04 24             	mov    %eax,(%esp)
  80104c:	e8 33 fb ff ff       	call   800b84 <strlen>
  801051:	83 f8 03             	cmp    $0x3,%eax
  801054:	77 4f                	ja     8010a5 <forkchild+0x6b>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  801056:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  80105a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80105e:	8b 45 08             	mov    0x8(%ebp),%eax
  801061:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801065:	c7 44 24 08 00 14 80 	movl   $0x801400,0x8(%esp)
  80106c:	00 
  80106d:	c7 44 24 04 05 00 00 	movl   $0x5,0x4(%esp)
  801074:	00 
  801075:	8d 45 f3             	lea    -0xd(%ebp),%eax
  801078:	89 04 24             	mov    %eax,(%esp)
  80107b:	e8 90 f9 ff ff       	call   800a10 <snprintf>
    if (fork() == 0) {
  801080:	e8 ac f2 ff ff       	call   800331 <fork>
  801085:	85 c0                	test   %eax,%eax
  801087:	75 1d                	jne    8010a6 <forkchild+0x6c>
        forktree(nxt);
  801089:	8d 45 f3             	lea    -0xd(%ebp),%eax
  80108c:	89 04 24             	mov    %eax,(%esp)
  80108f:	e8 16 00 00 00       	call   8010aa <forktree>
        yield();
  801094:	e8 e1 f2 ff ff       	call   80037a <yield>
        exit(0);
  801099:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8010a0:	e8 6d f2 ff ff       	call   800312 <exit>
        return;
  8010a5:	90                   	nop
    }
}
...
forktree(const char *cur) {
  ...
  8010ad:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  8010b0:	e8 ea f2 ff ff       	call   80039f <getpid>
  8010b5:	8b 55 08             	mov    0x8(%ebp),%edx
  8010b8:	89 54 24 08          	mov    %edx,0x8(%esp)
  8010bc:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010c0:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  8010c7:	e8 54 f0 ff ff       	call   800120 <cprintf>

    forkchild(cur, '0');
  8010cc:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
  8010d3:	00 
  8010d4:	8b 45 08             	mov    0x8(%ebp),%eax
  8010d7:	89 04 24             	mov    %eax,(%esp)
  8010da:	e8 5b ff ff ff       	call   80103a <forkchild>
    forkchild(cur, '1');
  8010df:	c7 44 24 04 31 00 00 	movl   $0x31,0x4(%esp)
  8010e6:	00 
  8010e7:	8b 45 08             	mov    0x8(%ebp),%eax
  8010ea:	89 04 24             	mov    %eax,(%esp)
  8010ed:	e8 48 ff ff ff       	call   80103a <forkchild>
}
  8010f2:	90                   	nop
...
main(void) {
  ...
  8010fa:	83 e4 f0             	and    $0xfffffff0,%esp
  8010fd:	83 ec 10             	sub    $0x10,%esp
    forktree("");
  801100:	c7 04 24 16 14 80 00 	movl   $0x801416,(%esp)
  801107:	e8 9e ff ff ff       	call   8010aa <forktree>
    return 0;
