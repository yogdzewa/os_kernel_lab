...
main(void) {
  ...
  800fc1:	c7 04 24 e0 12 80 00 	movl   $0x8012e0,(%esp)
  800fc8:	e8 53 f1 ff ff       	call   800120 <cprintf>
    print_pgdir();
  800fcd:	e8 8b f3 ff ff       	call   80035d <print_pgdir>
    cprintf("pgdir pass.\n");
  800fd2:	c7 04 24 f7 12 80 00 	movl   $0x8012f7,(%esp)
  800fd9:	e8 42 f1 ff ff       	call   800120 <cprintf>
    return 0;
