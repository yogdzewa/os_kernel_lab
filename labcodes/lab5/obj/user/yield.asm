...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800066:	68 9a 0f 80 00       	push   $0x800f9a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	68 9c 0f 80 00       	push   $0x800f9c
  ...
  8000b4:	68 9a 0f 80 00       	push   $0x800f9a
...
exit(int error_code) {
  ...
  800279:	68 b8 0f 80 00       	push   $0x800fb8
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800411:	05 e4 10 80 00       	add    $0x8010e4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800556:	8b 04 85 08 11 80 00 	mov    0x801108(,%eax,4),%eax
  ...
  800628:	8b 34 9d 80 10 80 00 	mov    0x801080(,%ebx,4),%esi
  80062f:	85 f6                	test   %esi,%esi
  800631:	75 19                	jne    80064c <vprintfmt+0x164>
                printfmt(putch, putdat, "error %d", err);
  800633:	53                   	push   %ebx
  800634:	68 f5 10 80 00       	push   $0x8010f5
  ...
  800647:	e9 37 02 00 00       	jmp    800883 <vprintfmt+0x39b>
                printfmt(putch, putdat, "%s", p);
  80064c:	56                   	push   %esi
  80064d:	68 fe 10 80 00       	push   $0x8010fe
  ...
  800672:	75 05                	jne    800679 <vprintfmt+0x191>
                p = "(null)";
  800674:	be 01 11 80 00       	mov    $0x801101,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800ee9:	e8 fb f3 ff ff       	call   8002e9 <getpid>
  800eee:	83 ec 08             	sub    $0x8,%esp
  800ef1:	50                   	push   %eax
  800ef2:	68 60 12 80 00       	push   $0x801260
  800ef7:	e8 15 f2 ff ff       	call   800111 <cprintf>
  800efc:	83 c4 10             	add    $0x10,%esp
    for (i = 0; i < 5; i ++) {
  800eff:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  800f06:	eb 22                	jmp    800f2a <main+0x52>
        yield();
  800f08:	e8 b8 f3 ff ff       	call   8002c5 <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  800f0d:	e8 d7 f3 ff ff       	call   8002e9 <getpid>
  800f12:	83 ec 04             	sub    $0x4,%esp
  800f15:	ff 75 f4             	pushl  -0xc(%ebp)
  800f18:	50                   	push   %eax
  800f19:	68 7c 12 80 00       	push   $0x80127c
  800f1e:	e8 ee f1 ff ff       	call   800111 <cprintf>
  800f23:	83 c4 10             	add    $0x10,%esp
    for (i = 0; i < 5; i ++) {
  800f26:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  800f2a:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
  800f2e:	7e d8                	jle    800f08 <main+0x30>
    }
    cprintf("All done in process %d.\n", getpid());
  800f30:	e8 b4 f3 ff ff       	call   8002e9 <getpid>
  800f35:	83 ec 08             	sub    $0x8,%esp
  800f38:	50                   	push   %eax
  800f39:	68 9f 12 80 00       	push   $0x80129f
  800f3e:	e8 ce f1 ff ff       	call   800111 <cprintf>
  800f43:	83 c4 10             	add    $0x10,%esp
    cprintf("yield pass.\n");
  800f46:	83 ec 0c             	sub    $0xc,%esp
  800f49:	68 b8 12 80 00       	push   $0x8012b8
  800f4e:	e8 be f1 ff ff       	call   800111 <cprintf>
  800f53:	83 c4 10             	add    $0x10,%esp
    return 0;
  800f56:	b8 00 00 00 00       	mov    $0x0,%eax
}
  800f5b:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  800f5e:	c9                   	leave  
  800f5f:	8d 61 fc             	lea    -0x4(%ecx),%esp
  800f62:	c3                   	ret    
