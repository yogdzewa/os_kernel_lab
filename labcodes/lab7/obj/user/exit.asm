...
exit(int error_code) {
  ...
  800323:	c7 04 24 d8 11 80 00 	movl   $0x8011d8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80051b:	05 04 13 80 00       	add    $0x801304,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80066f:	8b 04 85 28 13 80 00 	mov    0x801328(,%eax,4),%eax
  ...
  800771:	c7 44 24 08 1e 13 80 	movl   $0x80131e,0x8(%esp)
  800778:	00 
  ...
  80079d:	75 05                	jne    8007a4 <vprintfmt+0x1a3>
                p = "(null)";
  80079f:	be 21 13 80 00       	mov    $0x801321,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801043:	c7 04 24 80 14 80 00 	movl   $0x801480,(%esp)
  80104a:	e8 d1 f0 ff ff       	call   800120 <cprintf>
    if ((pid = fork()) == 0) {
  80104f:	e8 dd f2 ff ff       	call   800331 <fork>
  801054:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  801058:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  80105d:	75 3c                	jne    80109b <main+0x61>
        cprintf("I am the child.\n");
  80105f:	c7 04 24 a7 14 80 00 	movl   $0x8014a7,(%esp)
  801066:	e8 b5 f0 ff ff       	call   800120 <cprintf>
        yield();
  80106b:	e8 0a f3 ff ff       	call   80037a <yield>
        yield();
  801070:	e8 05 f3 ff ff       	call   80037a <yield>
        yield();
  801075:	e8 00 f3 ff ff       	call   80037a <yield>
        yield();
  80107a:	e8 fb f2 ff ff       	call   80037a <yield>
        yield();
  80107f:	e8 f6 f2 ff ff       	call   80037a <yield>
        yield();
  801084:	e8 f1 f2 ff ff       	call   80037a <yield>
        yield();
  801089:	e8 ec f2 ff ff       	call   80037a <yield>
        exit(magic);
  80108e:	a1 08 20 80 00       	mov    0x802008,%eax
  801093:	89 04 24             	mov    %eax,(%esp)
  801096:	e8 77 f2 ff ff       	call   800312 <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  80109b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80109f:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010a3:	c7 04 24 b8 14 80 00 	movl   $0x8014b8,(%esp)
  8010aa:	e8 71 f0 ff ff       	call   800120 <cprintf>
    }
    assert(pid > 0);
  8010af:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8010b4:	7f 24                	jg     8010da <main+0xa0>
  8010b6:	c7 44 24 0c da 14 80 	movl   $0x8014da,0xc(%esp)
  8010bd:	00 
  8010be:	c7 44 24 08 e2 14 80 	movl   $0x8014e2,0x8(%esp)
  8010c5:	00 
  8010c6:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  8010cd:	00 
  8010ce:	c7 04 24 f7 14 80 00 	movl   $0x8014f7,(%esp)
  8010d5:	e8 55 ef ff ff       	call   80002f <__panic>
    cprintf("I am the parent, waiting now..\n");
  8010da:	c7 04 24 04 15 80 00 	movl   $0x801504,(%esp)
  8010e1:	e8 3a f0 ff ff       	call   800120 <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  8010e6:	8d 44 24 18          	lea    0x18(%esp),%eax
  8010ea:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010ee:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010f2:	89 04 24             	mov    %eax,(%esp)
  8010f5:	e8 64 f2 ff ff       	call   80035e <waitpid>
  8010fa:	85 c0                	test   %eax,%eax
  8010fc:	75 0d                	jne    80110b <main+0xd1>
  8010fe:	8b 54 24 18          	mov    0x18(%esp),%edx
  801102:	a1 08 20 80 00       	mov    0x802008,%eax
  801107:	39 c2                	cmp    %eax,%edx
  801109:	74 24                	je     80112f <main+0xf5>
  80110b:	c7 44 24 0c 24 15 80 	movl   $0x801524,0xc(%esp)
  801112:	00 
  801113:	c7 44 24 08 e2 14 80 	movl   $0x8014e2,0x8(%esp)
  80111a:	00 
  80111b:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  801122:	00 
  801123:	c7 04 24 f7 14 80 00 	movl   $0x8014f7,(%esp)
  80112a:	e8 00 ef ff ff       	call   80002f <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  80112f:	8d 44 24 18          	lea    0x18(%esp),%eax
  801133:	89 44 24 04          	mov    %eax,0x4(%esp)
  801137:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80113b:	89 04 24             	mov    %eax,(%esp)
  80113e:	e8 1b f2 ff ff       	call   80035e <waitpid>
  801143:	85 c0                	test   %eax,%eax
  801145:	74 09                	je     801150 <main+0x116>
  801147:	e8 f4 f1 ff ff       	call   800340 <wait>
  80114c:	85 c0                	test   %eax,%eax
  80114e:	75 24                	jne    801174 <main+0x13a>
  801150:	c7 44 24 0c 50 15 80 	movl   $0x801550,0xc(%esp)
  801157:	00 
  801158:	c7 44 24 08 e2 14 80 	movl   $0x8014e2,0x8(%esp)
  80115f:	00 
  801160:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  801167:	00 
  801168:	c7 04 24 f7 14 80 00 	movl   $0x8014f7,(%esp)
  80116f:	e8 bb ee ff ff       	call   80002f <__panic>
    cprintf("waitpid %d ok.\n", pid);
  801174:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801178:	89 44 24 04          	mov    %eax,0x4(%esp)
  80117c:	c7 04 24 78 15 80 00 	movl   $0x801578,(%esp)
  801183:	e8 98 ef ff ff       	call   800120 <cprintf>

    cprintf("exit pass.\n");
  801188:	c7 04 24 88 15 80 00 	movl   $0x801588,(%esp)
  80118f:	e8 8c ef ff ff       	call   800120 <cprintf>
    return 0;
