...
main(void) {
  ...
  800ef1:	50                   	push   %eax
  800ef2:	68 20 12 80 00       	push   $0x801220
  800ef7:	e8 15 f2 ff ff       	call   800111 <cprintf>
  800efc:	83 c4 10             	add    $0x10,%esp
    print_pgdir();
  800eff:	e8 f2 f3 ff ff       	call   8002f6 <print_pgdir>
    cprintf("pgdir pass.\n");
  800f04:	83 ec 0c             	sub    $0xc,%esp
  800f07:	68 37 12 80 00       	push   $0x801237
  800f0c:	e8 00 f2 ff ff       	call   800111 <cprintf>
  ...
  800f1c:	c9                   	leave  
  800f1d:	8d 61 fc             	lea    -0x4(%ecx),%esp
  800f20:	c3                   	ret    
