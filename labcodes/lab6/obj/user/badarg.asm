...
exit(int error_code) {
  ...
  800306:	c7 04 24 98 11 80 00 	movl   $0x801198,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004e9:	05 c4 12 80 00       	add    $0x8012c4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80063d:	8b 04 85 e8 12 80 00 	mov    0x8012e8(,%eax,4),%eax
  ...
  80073f:	c7 44 24 08 de 12 80 	movl   $0x8012de,0x8(%esp)
  800746:	00 
  ...
  80076b:	75 05                	jne    800772 <vprintfmt+0x1a3>
                p = "(null)";
  80076d:	be e1 12 80 00       	mov    $0x8012e1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  80100e:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  801011:	e8 fe f2 ff ff       	call   800314 <fork>
  801016:	89 44 24 18          	mov    %eax,0x18(%esp)
  80101a:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80101f:	75 32                	jne    801053 <main+0x4b>
        cprintf("fork ok.\n");
  801021:	c7 04 24 40 14 80 00 	movl   $0x801440,(%esp)
  801028:	e8 f3 f0 ff ff       	call   800120 <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  80102d:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801034:	00 
  801035:	eb 09                	jmp    801040 <main+0x38>
            yield();
  801037:	e8 21 f3 ff ff       	call   80035d <yield>
        for (i = 0; i < 10; i ++) {
  80103c:	ff 44 24 1c          	incl   0x1c(%esp)
  801040:	83 7c 24 1c 09       	cmpl   $0x9,0x1c(%esp)
  801045:	7e f0                	jle    801037 <main+0x2f>
        }
        exit(0xbeaf);
  801047:	c7 04 24 af be 00 00 	movl   $0xbeaf,(%esp)
  80104e:	e8 a2 f2 ff ff       	call   8002f5 <exit>
    }
    assert(pid > 0);
  801053:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801058:	7f 24                	jg     80107e <main+0x76>
  80105a:	c7 44 24 0c 4a 14 80 	movl   $0x80144a,0xc(%esp)
  801061:	00 
  801062:	c7 44 24 08 52 14 80 	movl   $0x801452,0x8(%esp)
  801069:	00 
  80106a:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  801071:	00 
  801072:	c7 04 24 67 14 80 00 	movl   $0x801467,(%esp)
  801079:	e8 b1 ef ff ff       	call   80002f <__panic>
    assert(waitpid(-1, NULL) != 0);
  80107e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801085:	00 
  801086:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  80108d:	e8 af f2 ff ff       	call   800341 <waitpid>
  801092:	85 c0                	test   %eax,%eax
  801094:	75 24                	jne    8010ba <main+0xb2>
  801096:	c7 44 24 0c 75 14 80 	movl   $0x801475,0xc(%esp)
  80109d:	00 
  80109e:	c7 44 24 08 52 14 80 	movl   $0x801452,0x8(%esp)
  8010a5:	00 
  8010a6:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  8010ad:	00 
  8010ae:	c7 04 24 67 14 80 00 	movl   $0x801467,(%esp)
  8010b5:	e8 75 ef ff ff       	call   80002f <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  8010ba:	c7 44 24 04 00 00 00 	movl   $0xc0000000,0x4(%esp)
  8010c1:	c0 
  8010c2:	8b 44 24 18          	mov    0x18(%esp),%eax
  8010c6:	89 04 24             	mov    %eax,(%esp)
  8010c9:	e8 73 f2 ff ff       	call   800341 <waitpid>
  8010ce:	85 c0                	test   %eax,%eax
  8010d0:	75 24                	jne    8010f6 <main+0xee>
  8010d2:	c7 44 24 0c 8c 14 80 	movl   $0x80148c,0xc(%esp)
  8010d9:	00 
  8010da:	c7 44 24 08 52 14 80 	movl   $0x801452,0x8(%esp)
  8010e1:	00 
  8010e2:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  8010e9:	00 
  8010ea:	c7 04 24 67 14 80 00 	movl   $0x801467,(%esp)
  8010f1:	e8 39 ef ff ff       	call   80002f <__panic>
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  8010f6:	8d 44 24 14          	lea    0x14(%esp),%eax
  8010fa:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010fe:	8b 44 24 18          	mov    0x18(%esp),%eax
  801102:	89 04 24             	mov    %eax,(%esp)
  801105:	e8 37 f2 ff ff       	call   800341 <waitpid>
  80110a:	85 c0                	test   %eax,%eax
  80110c:	75 0b                	jne    801119 <main+0x111>
  80110e:	8b 44 24 14          	mov    0x14(%esp),%eax
  801112:	3d af be 00 00       	cmp    $0xbeaf,%eax
  801117:	74 24                	je     80113d <main+0x135>
  801119:	c7 44 24 0c b4 14 80 	movl   $0x8014b4,0xc(%esp)
  801120:	00 
  801121:	c7 44 24 08 52 14 80 	movl   $0x801452,0x8(%esp)
  801128:	00 
  801129:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  801130:	00 
  801131:	c7 04 24 67 14 80 00 	movl   $0x801467,(%esp)
  801138:	e8 f2 ee ff ff       	call   80002f <__panic>
    cprintf("badarg pass.\n");
  80113d:	c7 04 24 e9 14 80 00 	movl   $0x8014e9,(%esp)
  801144:	e8 d7 ef ff ff       	call   800120 <cprintf>
    return 0;
