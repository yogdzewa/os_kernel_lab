...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800044:	68 40 10 80 00       	push   $0x801040
  ...
  800066:	68 5a 10 80 00       	push   $0x80105a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	68 5c 10 80 00       	push   $0x80105c
  ...
  8000b4:	68 5a 10 80 00       	push   $0x80105a
...
exit(int error_code) {
  ...
  800279:	68 78 10 80 00       	push   $0x801078
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800411:	05 a4 11 80 00       	add    $0x8011a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800556:	8b 04 85 c8 11 80 00 	mov    0x8011c8(,%eax,4),%eax
  ...
  800628:	8b 34 9d 40 11 80 00 	mov    0x801140(,%ebx,4),%esi
  80062f:	85 f6                	test   %esi,%esi
  800631:	75 19                	jne    80064c <vprintfmt+0x164>
                printfmt(putch, putdat, "error %d", err);
  800633:	53                   	push   %ebx
  800634:	68 b5 11 80 00       	push   $0x8011b5
  ...
  800647:	e9 37 02 00 00       	jmp    800883 <vprintfmt+0x39b>
                printfmt(putch, putdat, "%s", p);
  80064c:	56                   	push   %esi
  80064d:	68 be 11 80 00       	push   $0x8011be
  ...
  800672:	75 05                	jne    800679 <vprintfmt+0x191>
                p = "(null)";
  800674:	be c1 11 80 00       	mov    $0x8011c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800ee5:	51                   	push   %ecx
  800ee6:	83 ec 14             	sub    $0x14,%esp
    int pid, code;
    cprintf("I am the parent. Forking the child...\n");
  800ee9:	83 ec 0c             	sub    $0xc,%esp
  800eec:	68 20 13 80 00       	push   $0x801320
  800ef1:	e8 1b f2 ff ff       	call   800111 <cprintf>
  800ef6:	83 c4 10             	add    $0x10,%esp
    if ((pid = fork()) == 0) {
  800ef9:	e8 8a f3 ff ff       	call   800288 <fork>
  800efe:	89 45 f4             	mov    %eax,-0xc(%ebp)
  800f01:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  800f05:	75 41                	jne    800f48 <main+0x70>
        cprintf("I am the child.\n");
  800f07:	83 ec 0c             	sub    $0xc,%esp
  800f0a:	68 47 13 80 00       	push   $0x801347
  800f0f:	e8 fd f1 ff ff       	call   800111 <cprintf>
  800f14:	83 c4 10             	add    $0x10,%esp
        yield();
  800f17:	e8 a9 f3 ff ff       	call   8002c5 <yield>
        yield();
  800f1c:	e8 a4 f3 ff ff       	call   8002c5 <yield>
        yield();
  800f21:	e8 9f f3 ff ff       	call   8002c5 <yield>
        yield();
  800f26:	e8 9a f3 ff ff       	call   8002c5 <yield>
        yield();
  800f2b:	e8 95 f3 ff ff       	call   8002c5 <yield>
        yield();
  800f30:	e8 90 f3 ff ff       	call   8002c5 <yield>
        yield();
  800f35:	e8 8b f3 ff ff       	call   8002c5 <yield>
        exit(magic);
  800f3a:	a1 08 20 80 00       	mov    0x802008,%eax
  800f3f:	83 ec 0c             	sub    $0xc,%esp
  800f42:	50                   	push   %eax
  800f43:	e8 1a f3 ff ff       	call   800262 <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  800f48:	83 ec 08             	sub    $0x8,%esp
  800f4b:	ff 75 f4             	pushl  -0xc(%ebp)
  800f4e:	68 58 13 80 00       	push   $0x801358
  800f53:	e8 b9 f1 ff ff       	call   800111 <cprintf>
  800f58:	83 c4 10             	add    $0x10,%esp
    }
    assert(pid > 0);
  800f5b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  800f5f:	7f 16                	jg     800f77 <main+0x9f>
  800f61:	68 7a 13 80 00       	push   $0x80137a
  800f66:	68 82 13 80 00       	push   $0x801382
  800f6b:	6a 18                	push   $0x18
  800f6d:	68 97 13 80 00       	push   $0x801397
  800f72:	e8 b8 f0 ff ff       	call   80002f <__panic>
    cprintf("I am the parent, waiting now..\n");
  800f77:	83 ec 0c             	sub    $0xc,%esp
  800f7a:	68 a4 13 80 00       	push   $0x8013a4
  800f7f:	e8 8d f1 ff ff       	call   800111 <cprintf>
  ...
  800f91:	e8 16 f3 ff ff       	call   8002ac <waitpid>
  800f96:	83 c4 10             	add    $0x10,%esp
  800f99:	85 c0                	test   %eax,%eax
  800f9b:	75 0c                	jne    800fa9 <main+0xd1>
  800f9d:	8b 55 f0             	mov    -0x10(%ebp),%edx
  800fa0:	a1 08 20 80 00       	mov    0x802008,%eax
  800fa5:	39 c2                	cmp    %eax,%edx
  800fa7:	74 16                	je     800fbf <main+0xe7>
  800fa9:	68 c4 13 80 00       	push   $0x8013c4
  800fae:	68 82 13 80 00       	push   $0x801382
  800fb3:	6a 1b                	push   $0x1b
  800fb5:	68 97 13 80 00       	push   $0x801397
  800fba:	e8 70 f0 ff ff       	call   80002f <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  800fbf:	83 ec 08             	sub    $0x8,%esp
  800fc2:	8d 45 f0             	lea    -0x10(%ebp),%eax
  800fc5:	50                   	push   %eax
  800fc6:	ff 75 f4             	pushl  -0xc(%ebp)
  800fc9:	e8 de f2 ff ff       	call   8002ac <waitpid>
  800fce:	83 c4 10             	add    $0x10,%esp
  800fd1:	85 c0                	test   %eax,%eax
  800fd3:	74 09                	je     800fde <main+0x106>
  800fd5:	e8 bb f2 ff ff       	call   800295 <wait>
  800fda:	85 c0                	test   %eax,%eax
  800fdc:	75 16                	jne    800ff4 <main+0x11c>
  800fde:	68 f0 13 80 00       	push   $0x8013f0
  800fe3:	68 82 13 80 00       	push   $0x801382
  800fe8:	6a 1c                	push   $0x1c
  800fea:	68 97 13 80 00       	push   $0x801397
  800fef:	e8 3b f0 ff ff       	call   80002f <__panic>
    cprintf("waitpid %d ok.\n", pid);
  800ff4:	83 ec 08             	sub    $0x8,%esp
  800ff7:	ff 75 f4             	pushl  -0xc(%ebp)
  800ffa:	68 18 14 80 00       	push   $0x801418
  800fff:	e8 0d f1 ff ff       	call   800111 <cprintf>
  801004:	83 c4 10             	add    $0x10,%esp

    cprintf("exit pass.\n");
  801007:	83 ec 0c             	sub    $0xc,%esp
  80100a:	68 28 14 80 00       	push   $0x801428
  80100f:	e8 fd f0 ff ff       	call   800111 <cprintf>
  ...
  80101f:	c9                   	leave  
  801020:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801023:	c3                   	ret    
