...
main(void) {
  ...
  801043:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80104a:	00 
  80104b:	eb 5f                	jmp    8010ac <main+0x72>
        if ((pid = fork()) == 0) {
  80104d:	e8 df f2 ff ff       	call   800331 <fork>
  801052:	89 44 24 18          	mov    %eax,0x18(%esp)
  801056:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80105b:	75 20                	jne    80107d <main+0x43>
            cprintf("I am child %d\n", n);
  80105d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801061:	89 44 24 04          	mov    %eax,0x4(%esp)
  801065:	c7 04 24 44 14 80 00 	movl   $0x801444,(%esp)
  80106c:	e8 af f0 ff ff       	call   800120 <cprintf>
            exit(0);
  801071:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801078:	e8 95 f2 ff ff       	call   800312 <exit>
        }
        assert(pid > 0);
  80107d:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801082:	7f 24                	jg     8010a8 <main+0x6e>
  801084:	c7 44 24 0c 53 14 80 	movl   $0x801453,0xc(%esp)
  80108b:	00 
  80108c:	c7 44 24 08 5b 14 80 	movl   $0x80145b,0x8(%esp)
  801093:	00 
  801094:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  80109b:	00 
  80109c:	c7 04 24 70 14 80 00 	movl   $0x801470,(%esp)
  8010a3:	e8 87 ef ff ff       	call   80002f <__panic>
    for (n = 0; n < max_child; n ++) {
  8010a8:	ff 44 24 1c          	incl   0x1c(%esp)
  8010ac:	b8 20 00 00 00       	mov    $0x20,%eax
  8010b1:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  8010b5:	7c 96                	jl     80104d <main+0x13>
    }

    if (n > max_child) {
  8010b7:	b8 20 00 00 00       	mov    $0x20,%eax
  8010bc:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  8010c0:	7e 4d                	jle    80110f <main+0xd5>
        panic("fork claimed to work %d times!\n", n);
  8010c2:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010c6:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010ca:	c7 44 24 08 80 14 80 	movl   $0x801480,0x8(%esp)
  8010d1:	00 
  8010d2:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  8010d9:	00 
  8010da:	c7 04 24 70 14 80 00 	movl   $0x801470,(%esp)
  8010e1:	e8 49 ef ff ff       	call   80002f <__panic>
    }

    for (; n > 0; n --) {
        if (wait() != 0) {
  8010e6:	e8 55 f2 ff ff       	call   800340 <wait>
  8010eb:	85 c0                	test   %eax,%eax
  8010ed:	74 1c                	je     80110b <main+0xd1>
            panic("wait stopped early\n");
  8010ef:	c7 44 24 08 a0 14 80 	movl   $0x8014a0,0x8(%esp)
  8010f6:	00 
  8010f7:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  8010fe:	00 
  8010ff:	c7 04 24 70 14 80 00 	movl   $0x801470,(%esp)
  801106:	e8 24 ef ff ff       	call   80002f <__panic>
    for (; n > 0; n --) {
  80110b:	ff 4c 24 1c          	decl   0x1c(%esp)
  80110f:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801114:	7f d0                	jg     8010e6 <main+0xac>
        }
    }

    if (wait() == 0) {
  801116:	e8 25 f2 ff ff       	call   800340 <wait>
  80111b:	85 c0                	test   %eax,%eax
  80111d:	75 1c                	jne    80113b <main+0x101>
        panic("wait got too many\n");
  80111f:	c7 44 24 08 b4 14 80 	movl   $0x8014b4,0x8(%esp)
  801126:	00 
  801127:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  80112e:	00 
  80112f:	c7 04 24 70 14 80 00 	movl   $0x801470,(%esp)
  801136:	e8 f4 ee ff ff       	call   80002f <__panic>
    }

    cprintf("forktest pass.\n");
  80113b:	c7 04 24 c7 14 80 00 	movl   $0x8014c7,(%esp)
  801142:	e8 d9 ef ff ff       	call   800120 <cprintf>
    return 0;
