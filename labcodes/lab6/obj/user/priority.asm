...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800049:	c7 04 24 e0 12 80 00 	movl   $0x8012e0,(%esp)
  ...
  800062:	e8 84 00 00 00       	call   8000eb <vcprintf>
    cprintf("\n");
  800067:	c7 04 24 fa 12 80 00 	movl   $0x8012fa,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800099:	c7 04 24 fc 12 80 00 	movl   $0x8012fc,(%esp)
  ...
  8000b2:	e8 34 00 00 00       	call   8000eb <vcprintf>
    cprintf("\n");
  8000b7:	c7 04 24 fa 12 80 00 	movl   $0x8012fa,(%esp)
...
exit(int error_code) {
  ...
  800306:	c7 04 24 18 13 80 00 	movl   $0x801318,(%esp)
...
umain(void) {
  ...
  8003c9:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003cc:	e8 66 0c 00 00       	call   801037 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004e9:	05 44 14 80 00       	add    $0x801444,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80063d:	8b 04 85 68 14 80 00 	mov    0x801468(,%eax,4),%eax
  ...
  80073f:	c7 44 24 08 5e 14 80 	movl   $0x80145e,0x8(%esp)
  800746:	00 
  ...
  80076b:	75 05                	jne    800772 <vprintfmt+0x1a3>
                p = "(null)";
  80076d:	be 61 14 80 00       	mov    $0x801461,%esi
            }
            if (width > 0 && padc != '-') {
...
spin_delay(void)
{
  ...
  801015:	eb 11                	jmp    801028 <spin_delay+0x20>
     {
          j = !j;
  ...
  801028:	81 7d fc c8 00 00 00 	cmpl   $0xc8,-0x4(%ebp)
  80102f:	75 e6                	jne    801017 <spin_delay+0xf>
     }
}
  801031:	90                   	nop
  801032:	90                   	nop
...
main(void) {
  ...
  801043:	89 5d fc             	mov    %ebx,-0x4(%ebp)
     int i,time;
     memset(pids, 0, sizeof(pids));
  801046:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
  80104d:	00 
  80104e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801055:	00 
  801056:	c7 04 24 30 20 80 00 	movl   $0x802030,(%esp)
  80105d:	e8 1a fe ff ff       	call   800e7c <memset>
     lab6_set_priority(TOTAL + 1);
  801062:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  801069:	e8 42 f3 ff ff       	call   8003b0 <lab6_set_priority>

     for (i = 0; i < TOTAL; i ++) {
  80106e:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801075:	00 
  801076:	e9 fc 00 00 00       	jmp    801177 <main+0x140>
          acc[i]=0;
  80107b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80107f:	c7 04 85 08 20 80 00 	movl   $0x0,0x802008(,%eax,4)
  801086:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  80108a:	e8 85 f2 ff ff       	call   800314 <fork>
  80108f:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801093:	89 04 95 30 20 80 00 	mov    %eax,0x802030(,%edx,4)
  80109a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80109e:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  8010a5:	85 c0                	test   %eax,%eax
  8010a7:	0f 85 b3 00 00 00    	jne    801160 <main+0x129>
               lab6_set_priority(i + 1);
  8010ad:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010b1:	40                   	inc    %eax
  8010b2:	89 04 24             	mov    %eax,(%esp)
  8010b5:	e8 f6 f2 ff ff       	call   8003b0 <lab6_set_priority>
               acc[i] = 0;
  8010ba:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010be:	c7 04 85 08 20 80 00 	movl   $0x0,0x802008(,%eax,4)
  8010c5:	00 00 00 00 
               while (1) {
                    spin_delay();
  8010c9:	e8 3a ff ff ff       	call   801008 <spin_delay>
                    ++ acc[i];
  8010ce:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010d2:	8b 04 85 08 20 80 00 	mov    0x802008(,%eax,4),%eax
  8010d9:	8d 50 01             	lea    0x1(%eax),%edx
  8010dc:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010e0:	89 14 85 08 20 80 00 	mov    %edx,0x802008(,%eax,4)
                    if(acc[i]%4000==0) {
  8010e7:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010eb:	8b 0c 85 08 20 80 00 	mov    0x802008(,%eax,4),%ecx
  8010f2:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  8010f7:	89 c8                	mov    %ecx,%eax
  8010f9:	f7 e2                	mul    %edx
  8010fb:	89 d0                	mov    %edx,%eax
  8010fd:	c1 e8 08             	shr    $0x8,%eax
  801100:	69 d0 a0 0f 00 00    	imul   $0xfa0,%eax,%edx
  801106:	89 c8                	mov    %ecx,%eax
  801108:	29 d0                	sub    %edx,%eax
  80110a:	85 c0                	test   %eax,%eax
  80110c:	75 bb                	jne    8010c9 <main+0x92>
                        if((time=gettime_msec())>MAX_TIME) {
  80110e:	e8 8e f2 ff ff       	call   8003a1 <gettime_msec>
  801113:	89 44 24 18          	mov    %eax,0x18(%esp)
  801117:	81 7c 24 18 e8 03 00 	cmpl   $0x3e8,0x18(%esp)
  80111e:	00 
  80111f:	7e a8                	jle    8010c9 <main+0x92>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  801121:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801125:	8b 1c 85 08 20 80 00 	mov    0x802008(,%eax,4),%ebx
  80112c:	e8 51 f2 ff ff       	call   800382 <getpid>
  801131:	8b 54 24 18          	mov    0x18(%esp),%edx
  801135:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801139:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80113d:	89 44 24 04          	mov    %eax,0x4(%esp)
  801141:	c7 04 24 c0 15 80 00 	movl   $0x8015c0,(%esp)
  801148:	e8 d3 ef ff ff       	call   800120 <cprintf>
                            exit(acc[i]);
  80114d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801151:	8b 04 85 08 20 80 00 	mov    0x802008(,%eax,4),%eax
  801158:	89 04 24             	mov    %eax,(%esp)
  80115b:	e8 95 f1 ff ff       	call   8002f5 <exit>
                        }
                    }
               }
          ...
          if (pids[i] < 0) {
  801160:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801164:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  80116b:	85 c0                	test   %eax,%eax
  80116d:	0f 88 06 01 00 00    	js     801279 <main+0x242>
     for (i = 0; i < TOTAL; i ++) {
  801173:	ff 44 24 1c          	incl   0x1c(%esp)
  801177:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  80117c:	0f 8e f9 fe ff ff    	jle    80107b <main+0x44>
               goto failed;
          }
     }

     cprintf("main: fork ok,now need to wait pids.\n");
  801182:	c7 04 24 e0 15 80 00 	movl   $0x8015e0,(%esp)
  801189:	e8 92 ef ff ff       	call   800120 <cprintf>

     for (i = 0; i < TOTAL; i ++) {
  80118e:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801195:	00 
  801196:	eb 6a                	jmp    801202 <main+0x1cb>
         status[i]=0;
  801198:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80119c:	c7 04 85 1c 20 80 00 	movl   $0x0,0x80201c(,%eax,4)
  8011a3:	00 00 00 00 
         waitpid(pids[i],&status[i]);
  8011a7:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8011ab:	c1 e0 02             	shl    $0x2,%eax
  8011ae:	8d 90 1c 20 80 00    	lea    0x80201c(%eax),%edx
  8011b4:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8011b8:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  8011bf:	89 54 24 04          	mov    %edx,0x4(%esp)
  8011c3:	89 04 24             	mov    %eax,(%esp)
  8011c6:	e8 76 f1 ff ff       	call   800341 <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  8011cb:	e8 d1 f1 ff ff       	call   8003a1 <gettime_msec>
  8011d0:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8011d4:	8b 0c 95 1c 20 80 00 	mov    0x80201c(,%edx,4),%ecx
  8011db:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8011df:	8b 14 95 30 20 80 00 	mov    0x802030(,%edx,4),%edx
  8011e6:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8011ea:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  8011ee:	89 54 24 04          	mov    %edx,0x4(%esp)
  8011f2:	c7 04 24 08 16 80 00 	movl   $0x801608,(%esp)
  8011f9:	e8 22 ef ff ff       	call   800120 <cprintf>
     for (i = 0; i < TOTAL; i ++) {
  8011fe:	ff 44 24 1c          	incl   0x1c(%esp)
  801202:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801207:	7e 8f                	jle    801198 <main+0x161>
     }
     cprintf("main: wait pids over\n");
  801209:	c7 04 24 27 16 80 00 	movl   $0x801627,(%esp)
  801210:	e8 0b ef ff ff       	call   800120 <cprintf>
     cprintf("stride sched correct result:");
  801215:	c7 04 24 3d 16 80 00 	movl   $0x80163d,(%esp)
  80121c:	e8 ff ee ff ff       	call   800120 <cprintf>
     for (i = 0; i < TOTAL; i ++)
  801221:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801228:	00 
  801229:	eb 34                	jmp    80125f <main+0x228>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
  80122b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80122f:	8b 04 85 1c 20 80 00 	mov    0x80201c(,%eax,4),%eax
  801236:	01 c0                	add    %eax,%eax
  801238:	8b 1d 1c 20 80 00    	mov    0x80201c,%ebx
  80123e:	99                   	cltd   
  80123f:	f7 fb                	idiv   %ebx
  801241:	40                   	inc    %eax
  801242:	89 c2                	mov    %eax,%edx
  801244:	c1 ea 1f             	shr    $0x1f,%edx
  801247:	01 d0                	add    %edx,%eax
  801249:	d1 f8                	sar    %eax
  80124b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80124f:	c7 04 24 5a 16 80 00 	movl   $0x80165a,(%esp)
  801256:	e8 c5 ee ff ff       	call   800120 <cprintf>
     for (i = 0; i < TOTAL; i ++)
  80125b:	ff 44 24 1c          	incl   0x1c(%esp)
  80125f:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801264:	7e c5                	jle    80122b <main+0x1f4>
     }
     cprintf("\n");
  801266:	c7 04 24 5e 16 80 00 	movl   $0x80165e,(%esp)
  80126d:	e8 ae ee ff ff       	call   800120 <cprintf>

     return 0;
  801272:	b8 00 00 00 00       	mov    $0x0,%eax
  801277:	eb 54                	jmp    8012cd <main+0x296>
               goto failed;
  801279:	90                   	nop

failed:
     for (i = 0; i < TOTAL; i ++) {
  80127a:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801281:	00 
  801282:	eb 26                	jmp    8012aa <main+0x273>
          if (pids[i] > 0) {
  801284:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801288:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  80128f:	85 c0                	test   %eax,%eax
  801291:	7e 13                	jle    8012a6 <main+0x26f>
               kill(pids[i]);
  801293:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801297:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  80129e:	89 04 24             	mov    %eax,(%esp)
  8012a1:	e8 c7 f0 ff ff       	call   80036d <kill>
     for (i = 0; i < TOTAL; i ++) {
  8012a6:	ff 44 24 1c          	incl   0x1c(%esp)
  8012aa:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  8012af:	7e d3                	jle    801284 <main+0x24d>
          }
     }
     panic("FAIL: T.T\n");
  8012b1:	c7 44 24 08 60 16 80 	movl   $0x801660,0x8(%esp)
  8012b8:	00 
  8012b9:	c7 44 24 04 4b 00 00 	movl   $0x4b,0x4(%esp)
  8012c0:	00 
  8012c1:	c7 04 24 6b 16 80 00 	movl   $0x80166b,(%esp)
  8012c8:	e8 62 ed ff ff       	call   80002f <__panic>
}
