...
exit(int error_code) {
  ...
  800306:	c7 04 24 38 14 80 00 	movl   $0x801438,(%esp)
...
umain(void) {
  ...
  8003c9:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003cc:	e8 67 0e 00 00       	call   801238 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004e9:	05 64 15 80 00       	add    $0x801564,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80063d:	8b 04 85 88 15 80 00 	mov    0x801588(,%eax,4),%eax
  ...
  80073f:	c7 44 24 08 7e 15 80 	movl   $0x80157e,0x8(%esp)
  800746:	00 
  ...
  80076b:	75 05                	jne    800772 <vprintfmt+0x1a3>
                p = "(null)";
  80076d:	be 81 15 80 00       	mov    $0x801581,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  80100e:	89 5d fc             	mov    %ebx,-0x4(%ebp)
    int i, j, k, size = MATSIZE;
  801011:	c7 45 e8 0a 00 00 00 	movl   $0xa,-0x18(%ebp)
    for (i = 0; i < size; i ++) {
  801018:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80101f:	eb 63                	jmp    801084 <work+0x7c>
        for (j = 0; j < size; j ++) {
  801021:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801028:	eb 4f                	jmp    801079 <work+0x71>
            mata[i][j] = matb[i][j] = 1;
  ...
  80103b:	c7 04 85 c0 21 80 00 	movl   $0x1,0x8021c0(,%eax,4)
  801042:	01 00 00 00 
  801046:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801049:	89 d0                	mov    %edx,%eax
  80104b:	c1 e0 02             	shl    $0x2,%eax
  80104e:	01 d0                	add    %edx,%eax
  801050:	01 c0                	add    %eax,%eax
  801052:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801055:	01 d0                	add    %edx,%eax
  801057:	8b 14 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%edx
  80105e:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801061:	89 c8                	mov    %ecx,%eax
  801063:	c1 e0 02             	shl    $0x2,%eax
  801066:	01 c8                	add    %ecx,%eax
  801068:	01 c0                	add    %eax,%eax
  80106a:	8b 4d f0             	mov    -0x10(%ebp),%ecx
  80106d:	01 c8                	add    %ecx,%eax
  80106f:	89 14 85 20 20 80 00 	mov    %edx,0x802020(,%eax,4)
        for (j = 0; j < size; j ++) {
  801076:	ff 45 f0             	incl   -0x10(%ebp)
  801079:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80107c:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80107f:	7c a9                	jl     80102a <work+0x22>
    for (i = 0; i < size; i ++) {
  801081:	ff 45 f4             	incl   -0xc(%ebp)
  801084:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801087:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80108a:	7c 95                	jl     801021 <work+0x19>
        }
    }

    yield();
  80108c:	e8 cc f2 ff ff       	call   80035d <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  801091:	e8 ec f2 ff ff       	call   800382 <getpid>
  801096:	8b 55 08             	mov    0x8(%ebp),%edx
  801099:	89 54 24 08          	mov    %edx,0x8(%esp)
  80109d:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010a1:	c7 04 24 e0 16 80 00 	movl   $0x8016e0,(%esp)
  8010a8:	e8 73 f0 ff ff       	call   800120 <cprintf>

    while (times -- > 0) {
  8010ad:	e9 54 01 00 00       	jmp    801206 <work+0x1fe>
        for (i = 0; i < size; i ++) {
  8010b2:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8010b9:	e9 b4 00 00 00       	jmp    801172 <work+0x16a>
            for (j = 0; j < size; j ++) {
  8010be:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  8010c5:	e9 99 00 00 00       	jmp    801163 <work+0x15b>
                matc[i][j] = 0;
  ...
  8010db:	c7 04 85 60 23 80 00 	movl   $0x0,0x802360(,%eax,4)
  8010e2:	00 00 00 00 
                for (k = 0; k < size; k ++) {
  8010e6:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8010ed:	eb 69                	jmp    801158 <work+0x150>
  ...
  801100:	8b 1c 85 60 23 80 00 	mov    0x802360(,%eax,4),%ebx
  801107:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80110a:	89 d0                	mov    %edx,%eax
  80110c:	c1 e0 02             	shl    $0x2,%eax
  80110f:	01 d0                	add    %edx,%eax
  801111:	01 c0                	add    %eax,%eax
  801113:	8b 55 ec             	mov    -0x14(%ebp),%edx
  801116:	01 d0                	add    %edx,%eax
  801118:	8b 0c 85 20 20 80 00 	mov    0x802020(,%eax,4),%ecx
  ...
  801130:	8b 04 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%eax
  801137:	0f af c1             	imul   %ecx,%eax
  80113a:	8d 0c 03             	lea    (%ebx,%eax,1),%ecx
  ...
  80114e:	89 0c 85 60 23 80 00 	mov    %ecx,0x802360(,%eax,4)
                for (k = 0; k < size; k ++) {
  801155:	ff 45 ec             	incl   -0x14(%ebp)
  801158:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80115b:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80115e:	7c 8f                	jl     8010ef <work+0xe7>
            for (j = 0; j < size; j ++) {
  801160:	ff 45 f0             	incl   -0x10(%ebp)
  801163:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801166:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801169:	0f 8c 5b ff ff ff    	jl     8010ca <work+0xc2>
        for (i = 0; i < size; i ++) {
  80116f:	ff 45 f4             	incl   -0xc(%ebp)
  801172:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801175:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801178:	0f 8c 40 ff ff ff    	jl     8010be <work+0xb6>
                }
            }
        }
        for (i = 0; i < size; i ++) {
  80117e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801185:	eb 77                	jmp    8011fe <work+0x1f6>
            for (j = 0; j < size; j ++) {
  801187:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  80118e:	eb 63                	jmp    8011f3 <work+0x1eb>
                mata[i][j] = matb[i][j] = matc[i][j];
  801190:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801193:	89 d0                	mov    %edx,%eax
  801195:	c1 e0 02             	shl    $0x2,%eax
  801198:	01 d0                	add    %edx,%eax
  80119a:	01 c0                	add    %eax,%eax
  80119c:	8b 55 f0             	mov    -0x10(%ebp),%edx
  80119f:	01 d0                	add    %edx,%eax
  8011a1:	8b 14 85 60 23 80 00 	mov    0x802360(,%eax,4),%edx
  8011a8:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  8011ab:	89 c8                	mov    %ecx,%eax
  8011ad:	c1 e0 02             	shl    $0x2,%eax
  8011b0:	01 c8                	add    %ecx,%eax
  8011b2:	01 c0                	add    %eax,%eax
  8011b4:	8b 4d f0             	mov    -0x10(%ebp),%ecx
  8011b7:	01 c8                	add    %ecx,%eax
  8011b9:	89 14 85 c0 21 80 00 	mov    %edx,0x8021c0(,%eax,4)
  8011c0:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  8011d1:	8b 14 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%edx
  8011d8:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  ...
  8011e9:	89 14 85 20 20 80 00 	mov    %edx,0x802020(,%eax,4)
            for (j = 0; j < size; j ++) {
  8011f0:	ff 45 f0             	incl   -0x10(%ebp)
  8011f3:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8011f6:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8011f9:	7c 95                	jl     801190 <work+0x188>
        for (i = 0; i < size; i ++) {
  8011fb:	ff 45 f4             	incl   -0xc(%ebp)
  8011fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801201:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801204:	7c 81                	jl     801187 <work+0x17f>
    while (times -- > 0) {
  801206:	8b 45 08             	mov    0x8(%ebp),%eax
  801209:	8d 50 ff             	lea    -0x1(%eax),%edx
  80120c:	89 55 08             	mov    %edx,0x8(%ebp)
  80120f:	85 c0                	test   %eax,%eax
  801211:	0f 85 9b fe ff ff    	jne    8010b2 <work+0xaa>
            }
        }
    }
    cprintf("pid %d done!.\n", getpid());
  801217:	e8 66 f1 ff ff       	call   800382 <getpid>
  80121c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801220:	c7 04 24 00 17 80 00 	movl   $0x801700,(%esp)
  801227:	e8 f4 ee ff ff       	call   800120 <cprintf>
    exit(0);
  80122c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801233:	e8 bd f0 ff ff       	call   8002f5 <exit>
...
int
main(void) {
  801238:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  80123c:	83 e4 f0             	and    $0xfffffff0,%esp
  80123f:	ff 71 fc             	pushl  -0x4(%ecx)
  801242:	55                   	push   %ebp
  801243:	89 e5                	mov    %esp,%ebp
  801245:	53                   	push   %ebx
  801246:	51                   	push   %ecx
  801247:	83 ec 20             	sub    $0x20,%esp
  80124a:	89 e0                	mov    %esp,%eax
  80124c:	89 c3                	mov    %eax,%ebx
    int pids[total];
  80124e:	b8 15 00 00 00       	mov    $0x15,%eax
  801253:	48                   	dec    %eax
  801254:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801257:	b8 15 00 00 00       	mov    $0x15,%eax
  ...
  801277:	6b c0 10             	imul   $0x10,%eax,%eax
  80127a:	29 c4                	sub    %eax,%esp
  80127c:	8d 44 24 0c          	lea    0xc(%esp),%eax
  801280:	83 c0 03             	add    $0x3,%eax
  801283:	c1 e8 02             	shr    $0x2,%eax
  801286:	c1 e0 02             	shl    $0x2,%eax
  801289:	89 45 ec             	mov    %eax,-0x14(%ebp)
    memset(pids, 0, sizeof(pids));
  80128c:	b8 15 00 00 00       	mov    $0x15,%eax
  801291:	c1 e0 02             	shl    $0x2,%eax
  801294:	89 44 24 08          	mov    %eax,0x8(%esp)
  801298:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80129f:	00 
  8012a0:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8012a3:	89 04 24             	mov    %eax,(%esp)
  8012a6:	e8 d1 fb ff ff       	call   800e7c <memset>

    int i;
    for (i = 0; i < total; i ++) {
  8012ab:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8012b2:	eb 7b                	jmp    80132f <main+0xf7>
        if ((pids[i] = fork()) == 0) {
  8012b4:	e8 5b f0 ff ff       	call   800314 <fork>
  8012b9:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8012bc:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  8012bf:	89 04 8a             	mov    %eax,(%edx,%ecx,4)
  8012c2:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8012c5:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8012c8:	8b 04 90             	mov    (%eax,%edx,4),%eax
  8012cb:	85 c0                	test   %eax,%eax
  8012cd:	75 50                	jne    80131f <main+0xe7>
            srand(i * i);
  8012cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8012d2:	0f af c0             	imul   %eax,%eax
  8012d5:	89 04 24             	mov    %eax,(%esp)
  8012d8:	e8 5c f8 ff ff       	call   800b39 <srand>
            int times = (((unsigned int)rand()) % total);
  8012dd:	e8 98 f7 ff ff       	call   800a7a <rand>
  8012e2:	ba 15 00 00 00       	mov    $0x15,%edx
  8012e7:	89 d1                	mov    %edx,%ecx
  8012e9:	ba 00 00 00 00       	mov    $0x0,%edx
  8012ee:	f7 f1                	div    %ecx
  8012f0:	89 d0                	mov    %edx,%eax
  8012f2:	89 45 e8             	mov    %eax,-0x18(%ebp)
            times = (times * times + 10) * 100;
  8012f5:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8012f8:	0f af c0             	imul   %eax,%eax
  8012fb:	8d 50 0a             	lea    0xa(%eax),%edx
  ...
  80130e:	c1 e0 02             	shl    $0x2,%eax
  801311:	89 45 e8             	mov    %eax,-0x18(%ebp)
            work(times);
  801314:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801317:	89 04 24             	mov    %eax,(%esp)
  80131a:	e8 e9 fc ff ff       	call   801008 <work>
        }
        if (pids[i] < 0) {
  80131f:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801322:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801325:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801328:	85 c0                	test   %eax,%eax
  80132a:	78 5f                	js     80138b <main+0x153>
    for (i = 0; i < total; i ++) {
  80132c:	ff 45 f4             	incl   -0xc(%ebp)
  80132f:	b8 15 00 00 00       	mov    $0x15,%eax
  801334:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801337:	0f 8c 77 ff ff ff    	jl     8012b4 <main+0x7c>
            goto failed;
        }
    }

    cprintf("fork ok.\n");
  80133d:	c7 04 24 14 17 80 00 	movl   $0x801714,(%esp)
  801344:	e8 d7 ed ff ff       	call   800120 <cprintf>

    for (i = 0; i < total; i ++) {
  801349:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801350:	eb 1a                	jmp    80136c <main+0x134>
        if (wait() != 0) {
  801352:	e8 cc ef ff ff       	call   800323 <wait>
  801357:	85 c0                	test   %eax,%eax
  801359:	74 0e                	je     801369 <main+0x131>
            cprintf("wait failed.\n");
  80135b:	c7 04 24 1e 17 80 00 	movl   $0x80171e,(%esp)
  801362:	e8 b9 ed ff ff       	call   800120 <cprintf>
            goto failed;
  801367:	eb 23                	jmp    80138c <main+0x154>
    for (i = 0; i < total; i ++) {
  801369:	ff 45 f4             	incl   -0xc(%ebp)
  80136c:	b8 15 00 00 00       	mov    $0x15,%eax
  801371:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801374:	7c dc                	jl     801352 <main+0x11a>
        }
    }

    cprintf("matrix pass.\n");
  801376:	c7 04 24 2c 17 80 00 	movl   $0x80172c,(%esp)
  80137d:	e8 9e ed ff ff       	call   800120 <cprintf>
    return 0;
  801382:	b8 00 00 00 00       	mov    $0x0,%eax
  801387:	89 dc                	mov    %ebx,%esp
  801389:	eb 51                	jmp    8013dc <main+0x1a4>
            goto failed;
  80138b:	90                   	nop

failed:
    for (i = 0; i < total; i ++) {
  80138c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801393:	eb 21                	jmp    8013b6 <main+0x17e>
        if (pids[i] > 0) {
  801395:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801398:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80139b:	8b 04 90             	mov    (%eax,%edx,4),%eax
  80139e:	85 c0                	test   %eax,%eax
  8013a0:	7e 11                	jle    8013b3 <main+0x17b>
            kill(pids[i]);
  8013a2:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8013a5:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8013a8:	8b 04 90             	mov    (%eax,%edx,4),%eax
  8013ab:	89 04 24             	mov    %eax,(%esp)
  8013ae:	e8 ba ef ff ff       	call   80036d <kill>
    for (i = 0; i < total; i ++) {
  8013b3:	ff 45 f4             	incl   -0xc(%ebp)
  8013b6:	b8 15 00 00 00       	mov    $0x15,%eax
  8013bb:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  8013be:	7c d5                	jl     801395 <main+0x15d>
        }
    }
    panic("FAIL: T.T\n");
  8013c0:	c7 44 24 08 3a 17 80 	movl   $0x80173a,0x8(%esp)
  8013c7:	00 
  8013c8:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  8013cf:	00 
  8013d0:	c7 04 24 45 17 80 00 	movl   $0x801745,(%esp)
  8013d7:	e8 53 ec ff ff       	call   80002f <__panic>
}
  8013dc:	8d 65 f8             	lea    -0x8(%ebp),%esp
  8013df:	59                   	pop    %ecx
  8013e0:	5b                   	pop    %ebx
  8013e1:	5d                   	pop    %ebp
  8013e2:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8013e5:	c3                   	ret    
