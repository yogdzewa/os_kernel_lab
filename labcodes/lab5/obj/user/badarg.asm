...
exit(int error_code) {
  ...
  8002d2:	c7 04 24 38 11 80 00 	movl   $0x801138,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800490:	05 64 12 80 00       	add    $0x801264,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8005e4:	8b 04 85 88 12 80 00 	mov    0x801288(,%eax,4),%eax
  ...
  8006e6:	c7 44 24 08 7e 12 80 	movl   $0x80127e,0x8(%esp)
  8006ed:	00 
  ...
  800712:	75 05                	jne    800719 <vprintfmt+0x1a3>
                p = "(null)";
  800714:	be 81 12 80 00       	mov    $0x801281,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fb5:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  800fb8:	e8 23 f3 ff ff       	call   8002e0 <fork>
  800fbd:	89 44 24 18          	mov    %eax,0x18(%esp)
  800fc1:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  800fc6:	75 32                	jne    800ffa <main+0x4b>
        cprintf("fork ok.\n");
  800fc8:	c7 04 24 e0 13 80 00 	movl   $0x8013e0,(%esp)
  800fcf:	e8 4c f1 ff ff       	call   800120 <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  800fd4:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  800fdb:	00 
  800fdc:	eb 09                	jmp    800fe7 <main+0x38>
            yield();
  800fde:	e8 46 f3 ff ff       	call   800329 <yield>
        for (i = 0; i < 10; i ++) {
  800fe3:	ff 44 24 1c          	incl   0x1c(%esp)
  800fe7:	83 7c 24 1c 09       	cmpl   $0x9,0x1c(%esp)
  800fec:	7e f0                	jle    800fde <main+0x2f>
        }
        exit(0xbeaf);
  800fee:	c7 04 24 af be 00 00 	movl   $0xbeaf,(%esp)
  800ff5:	e8 c7 f2 ff ff       	call   8002c1 <exit>
    }
    assert(pid > 0);
  800ffa:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  800fff:	7f 24                	jg     801025 <main+0x76>
  801001:	c7 44 24 0c ea 13 80 	movl   $0x8013ea,0xc(%esp)
  801008:	00 
  801009:	c7 44 24 08 f2 13 80 	movl   $0x8013f2,0x8(%esp)
  801010:	00 
  801011:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  801018:	00 
  801019:	c7 04 24 07 14 80 00 	movl   $0x801407,(%esp)
  801020:	e8 0a f0 ff ff       	call   80002f <__panic>
    assert(waitpid(-1, NULL) != 0);
  801025:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80102c:	00 
  80102d:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801034:	e8 d4 f2 ff ff       	call   80030d <waitpid>
  801039:	85 c0                	test   %eax,%eax
  80103b:	75 24                	jne    801061 <main+0xb2>
  80103d:	c7 44 24 0c 15 14 80 	movl   $0x801415,0xc(%esp)
  801044:	00 
  801045:	c7 44 24 08 f2 13 80 	movl   $0x8013f2,0x8(%esp)
  80104c:	00 
  80104d:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  801054:	00 
  801055:	c7 04 24 07 14 80 00 	movl   $0x801407,(%esp)
  80105c:	e8 ce ef ff ff       	call   80002f <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  801061:	c7 44 24 04 00 00 00 	movl   $0xc0000000,0x4(%esp)
  801068:	c0 
  801069:	8b 44 24 18          	mov    0x18(%esp),%eax
  80106d:	89 04 24             	mov    %eax,(%esp)
  801070:	e8 98 f2 ff ff       	call   80030d <waitpid>
  801075:	85 c0                	test   %eax,%eax
  801077:	75 24                	jne    80109d <main+0xee>
  801079:	c7 44 24 0c 2c 14 80 	movl   $0x80142c,0xc(%esp)
  801080:	00 
  801081:	c7 44 24 08 f2 13 80 	movl   $0x8013f2,0x8(%esp)
  801088:	00 
  801089:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  801090:	00 
  801091:	c7 04 24 07 14 80 00 	movl   $0x801407,(%esp)
  801098:	e8 92 ef ff ff       	call   80002f <__panic>
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  80109d:	8d 44 24 14          	lea    0x14(%esp),%eax
  8010a1:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010a5:	8b 44 24 18          	mov    0x18(%esp),%eax
  8010a9:	89 04 24             	mov    %eax,(%esp)
  8010ac:	e8 5c f2 ff ff       	call   80030d <waitpid>
  8010b1:	85 c0                	test   %eax,%eax
  8010b3:	75 0b                	jne    8010c0 <main+0x111>
  8010b5:	8b 44 24 14          	mov    0x14(%esp),%eax
  8010b9:	3d af be 00 00       	cmp    $0xbeaf,%eax
  8010be:	74 24                	je     8010e4 <main+0x135>
  8010c0:	c7 44 24 0c 54 14 80 	movl   $0x801454,0xc(%esp)
  8010c7:	00 
  8010c8:	c7 44 24 08 f2 13 80 	movl   $0x8013f2,0x8(%esp)
  8010cf:	00 
  8010d0:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  8010d7:	00 
  8010d8:	c7 04 24 07 14 80 00 	movl   $0x801407,(%esp)
  8010df:	e8 4b ef ff ff       	call   80002f <__panic>
    cprintf("badarg pass.\n");
  8010e4:	c7 04 24 89 14 80 00 	movl   $0x801489,(%esp)
  8010eb:	e8 30 f0 ff ff       	call   800120 <cprintf>
    return 0;
  8010f0:	b8 00 00 00 00       	mov    $0x0,%eax
}
  8010f5:	89 ec                	mov    %ebp,%esp
  8010f7:	5d                   	pop    %ebp
  8010f8:	c3                   	ret    
