...
exit(int error_code) {
  ...
  800323:	c7 04 24 f8 10 80 00 	movl   $0x8010f8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80051b:	05 24 12 80 00       	add    $0x801224,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80066f:	8b 04 85 48 12 80 00 	mov    0x801248(,%eax,4),%eax
  ...
  800771:	c7 44 24 08 3e 12 80 	movl   $0x80123e,0x8(%esp)
  800778:	00 
  ...
  80079d:	75 05                	jne    8007a4 <vprintfmt+0x1a3>
                p = "(null)";
  80079f:	be 41 12 80 00       	mov    $0x801241,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801043:	e8 57 f3 ff ff       	call   80039f <getpid>
  801048:	89 44 24 04          	mov    %eax,0x4(%esp)
  80104c:	c7 04 24 a0 13 80 00 	movl   $0x8013a0,(%esp)
  801053:	e8 c8 f0 ff ff       	call   800120 <cprintf>
    for (i = 0; i < 5; i ++) {
  801058:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80105f:	00 
  801060:	eb 26                	jmp    801088 <main+0x4e>
        yield();
  801062:	e8 13 f3 ff ff       	call   80037a <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  801067:	e8 33 f3 ff ff       	call   80039f <getpid>
  80106c:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801070:	89 54 24 08          	mov    %edx,0x8(%esp)
  801074:	89 44 24 04          	mov    %eax,0x4(%esp)
  801078:	c7 04 24 bc 13 80 00 	movl   $0x8013bc,(%esp)
  80107f:	e8 9c f0 ff ff       	call   800120 <cprintf>
    for (i = 0; i < 5; i ++) {
  801084:	ff 44 24 1c          	incl   0x1c(%esp)
  801088:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  80108d:	7e d3                	jle    801062 <main+0x28>
    }
    cprintf("All done in process %d.\n", getpid());
  80108f:	e8 0b f3 ff ff       	call   80039f <getpid>
  801094:	89 44 24 04          	mov    %eax,0x4(%esp)
  801098:	c7 04 24 df 13 80 00 	movl   $0x8013df,(%esp)
  80109f:	e8 7c f0 ff ff       	call   800120 <cprintf>
    cprintf("yield pass.\n");
  8010a4:	c7 04 24 f8 13 80 00 	movl   $0x8013f8,(%esp)
  8010ab:	e8 70 f0 ff ff       	call   800120 <cprintf>
    return 0;
