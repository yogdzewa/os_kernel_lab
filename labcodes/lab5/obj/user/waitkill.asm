...
exit(int error_code) {
  ...
  8002d2:	c7 04 24 98 11 80 00 	movl   $0x801198,(%esp)
...
umain(void) {
  ...
  800370:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  800373:	e8 e2 0c 00 00       	call   80105a <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800490:	05 c4 12 80 00       	add    $0x8012c4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8005e4:	8b 04 85 e8 12 80 00 	mov    0x8012e8(,%eax,4),%eax
  ...
  8006e6:	c7 44 24 08 de 12 80 	movl   $0x8012de,0x8(%esp)
  8006ed:	00 
  ...
  800712:	75 05                	jne    800719 <vprintfmt+0x1a3>
                p = "(null)";
  800714:	be e1 12 80 00       	mov    $0x8012e1,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  800fb2:	83 ec 08             	sub    $0x8,%esp
    yield();
  800fb5:	e8 6f f3 ff ff       	call   800329 <yield>
    yield();
  800fba:	e8 6a f3 ff ff       	call   800329 <yield>
    yield();
  800fbf:	e8 65 f3 ff ff       	call   800329 <yield>
    yield();
  800fc4:	e8 60 f3 ff ff       	call   800329 <yield>
    yield();
  800fc9:	e8 5b f3 ff ff       	call   800329 <yield>
    yield();
  800fce:	e8 56 f3 ff ff       	call   800329 <yield>
}
  800fd3:	90                   	nop
...
loop(void) {
  ...
  800fdb:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  800fde:	c7 04 24 40 14 80 00 	movl   $0x801440,(%esp)
  800fe5:	e8 36 f1 ff ff       	call   800120 <cprintf>
    while (1);
  800fea:	eb fe                	jmp    800fea <loop+0x12>
...
work(void) {
  ...
  800fef:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  800ff2:	c7 04 24 4a 14 80 00 	movl   $0x80144a,(%esp)
  800ff9:	e8 22 f1 ff ff       	call   800120 <cprintf>
    do_yield();
  800ffe:	e8 ac ff ff ff       	call   800faf <do_yield>
    if (kill(parent) == 0) {
  801003:	a1 08 20 80 00       	mov    0x802008,%eax
  801008:	89 04 24             	mov    %eax,(%esp)
  80100b:	e8 29 f3 ff ff       	call   800339 <kill>
  801010:	85 c0                	test   %eax,%eax
  801012:	75 3a                	jne    80104e <work+0x62>
        cprintf("kill parent ok.\n");
  801014:	c7 04 24 54 14 80 00 	movl   $0x801454,(%esp)
  80101b:	e8 00 f1 ff ff       	call   800120 <cprintf>
        do_yield();
  801020:	e8 8a ff ff ff       	call   800faf <do_yield>
        if (kill(pid1) == 0) {
  801025:	a1 0c 20 80 00       	mov    0x80200c,%eax
  80102a:	89 04 24             	mov    %eax,(%esp)
  80102d:	e8 07 f3 ff ff       	call   800339 <kill>
  801032:	85 c0                	test   %eax,%eax
  801034:	75 18                	jne    80104e <work+0x62>
            cprintf("kill child1 ok.\n");
  801036:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  80103d:	e8 de f0 ff ff       	call   800120 <cprintf>
            exit(0);
  801042:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801049:	e8 73 f2 ff ff       	call   8002c1 <exit>
        }
    }
    exit(-1);
  80104e:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801055:	e8 67 f2 ff ff       	call   8002c1 <exit>
...
main(void) {
  ...
  80105d:	83 e4 f0             	and    $0xfffffff0,%esp
  801060:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  801063:	e8 e6 f2 ff ff       	call   80034e <getpid>
  801068:	a3 08 20 80 00       	mov    %eax,0x802008
    if ((pid1 = fork()) == 0) {
  80106d:	e8 6e f2 ff ff       	call   8002e0 <fork>
  801072:	a3 0c 20 80 00       	mov    %eax,0x80200c
  801077:	a1 0c 20 80 00       	mov    0x80200c,%eax
  80107c:	85 c0                	test   %eax,%eax
  80107e:	75 05                	jne    801085 <main+0x2b>
        loop();
  801080:	e8 53 ff ff ff       	call   800fd8 <loop>
    }

    assert(pid1 > 0);
  801085:	a1 0c 20 80 00       	mov    0x80200c,%eax
  80108a:	85 c0                	test   %eax,%eax
  80108c:	7f 24                	jg     8010b2 <main+0x58>
  80108e:	c7 44 24 0c 76 14 80 	movl   $0x801476,0xc(%esp)
  801095:	00 
  801096:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  80109d:	00 
  80109e:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  8010a5:	00 
  8010a6:	c7 04 24 94 14 80 00 	movl   $0x801494,(%esp)
  8010ad:	e8 7d ef ff ff       	call   80002f <__panic>

    if ((pid2 = fork()) == 0) {
  8010b2:	e8 29 f2 ff ff       	call   8002e0 <fork>
  8010b7:	a3 10 20 80 00       	mov    %eax,0x802010
  8010bc:	a1 10 20 80 00       	mov    0x802010,%eax
  8010c1:	85 c0                	test   %eax,%eax
  8010c3:	75 05                	jne    8010ca <main+0x70>
        work();
  8010c5:	e8 22 ff ff ff       	call   800fec <work>
    }
    if (pid2 > 0) {
  8010ca:	a1 10 20 80 00       	mov    0x802010,%eax
  8010cf:	85 c0                	test   %eax,%eax
  8010d1:	7e 46                	jle    801119 <main+0xbf>
        cprintf("wait child 1.\n");
  8010d3:	c7 04 24 a4 14 80 00 	movl   $0x8014a4,(%esp)
  8010da:	e8 41 f0 ff ff       	call   800120 <cprintf>
        waitpid(pid1, NULL);
  8010df:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8010e4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8010eb:	00 
  8010ec:	89 04 24             	mov    %eax,(%esp)
  8010ef:	e8 19 f2 ff ff       	call   80030d <waitpid>
        panic("waitpid %d returns\n", pid1);
  8010f4:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8010f9:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010fd:	c7 44 24 08 b3 14 80 	movl   $0x8014b3,0x8(%esp)
  801104:	00 
  801105:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  80110c:	00 
  80110d:	c7 04 24 94 14 80 00 	movl   $0x801494,(%esp)
  801114:	e8 16 ef ff ff       	call   80002f <__panic>
    }
    else {
        kill(pid1);
  801119:	a1 0c 20 80 00       	mov    0x80200c,%eax
  80111e:	89 04 24             	mov    %eax,(%esp)
  801121:	e8 13 f2 ff ff       	call   800339 <kill>
    }
    panic("FAIL: T.T\n");
  801126:	c7 44 24 08 c7 14 80 	movl   $0x8014c7,0x8(%esp)
  80112d:	00 
  80112e:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  801135:	00 
  801136:	c7 04 24 94 14 80 00 	movl   $0x801494,(%esp)
  80113d:	e8 ed ee ff ff       	call   80002f <__panic>
