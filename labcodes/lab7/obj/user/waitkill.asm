...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800049:	c7 04 24 e0 11 80 00 	movl   $0x8011e0,(%esp)
  ...
  800062:	e8 84 00 00 00       	call   8000eb <vcprintf>
    cprintf("\n");
  800067:	c7 04 24 fa 11 80 00 	movl   $0x8011fa,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800099:	c7 04 24 fc 11 80 00 	movl   $0x8011fc,(%esp)
  ...
  8000b2:	e8 34 00 00 00       	call   8000eb <vcprintf>
    cprintf("\n");
  8000b7:	c7 04 24 fa 11 80 00 	movl   $0x8011fa,(%esp)
...
exit(int error_code) {
  ...
  800323:	c7 04 24 18 12 80 00 	movl   $0x801218,(%esp)
...
umain(void) {
  ...
  8003fb:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003fe:	e8 e2 0c 00 00       	call   8010e5 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80051b:	05 44 13 80 00       	add    $0x801344,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80066f:	8b 04 85 68 13 80 00 	mov    0x801368(,%eax,4),%eax
  ...
  800771:	c7 44 24 08 5e 13 80 	movl   $0x80135e,0x8(%esp)
  800778:	00 
  ...
  80079d:	75 05                	jne    8007a4 <vprintfmt+0x1a3>
                p = "(null)";
  80079f:	be 61 13 80 00       	mov    $0x801361,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  80103d:	83 ec 08             	sub    $0x8,%esp
    yield();
  801040:	e8 35 f3 ff ff       	call   80037a <yield>
    yield();
  801045:	e8 30 f3 ff ff       	call   80037a <yield>
    yield();
  80104a:	e8 2b f3 ff ff       	call   80037a <yield>
    yield();
  80104f:	e8 26 f3 ff ff       	call   80037a <yield>
    yield();
  801054:	e8 21 f3 ff ff       	call   80037a <yield>
    yield();
  801059:	e8 1c f3 ff ff       	call   80037a <yield>
}
  80105e:	90                   	nop
...
loop(void) {
  ...
  801066:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  801069:	c7 04 24 c0 14 80 00 	movl   $0x8014c0,(%esp)
  801070:	e8 ab f0 ff ff       	call   800120 <cprintf>
    while (1);
  801075:	eb fe                	jmp    801075 <loop+0x12>
...
work(void) {
  ...
  80107a:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  80107d:	c7 04 24 ca 14 80 00 	movl   $0x8014ca,(%esp)
  801084:	e8 97 f0 ff ff       	call   800120 <cprintf>
    do_yield();
  801089:	e8 ac ff ff ff       	call   80103a <do_yield>
    if (kill(parent) == 0) {
  80108e:	a1 08 20 80 00       	mov    0x802008,%eax
  801093:	89 04 24             	mov    %eax,(%esp)
  801096:	e8 ef f2 ff ff       	call   80038a <kill>
  80109b:	85 c0                	test   %eax,%eax
  80109d:	75 3a                	jne    8010d9 <work+0x62>
        cprintf("kill parent ok.\n");
  80109f:	c7 04 24 d4 14 80 00 	movl   $0x8014d4,(%esp)
  8010a6:	e8 75 f0 ff ff       	call   800120 <cprintf>
        do_yield();
  8010ab:	e8 8a ff ff ff       	call   80103a <do_yield>
        if (kill(pid1) == 0) {
  8010b0:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8010b5:	89 04 24             	mov    %eax,(%esp)
  8010b8:	e8 cd f2 ff ff       	call   80038a <kill>
  8010bd:	85 c0                	test   %eax,%eax
  8010bf:	75 18                	jne    8010d9 <work+0x62>
            cprintf("kill child1 ok.\n");
  8010c1:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
  8010c8:	e8 53 f0 ff ff       	call   800120 <cprintf>
            exit(0);
  8010cd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8010d4:	e8 39 f2 ff ff       	call   800312 <exit>
        }
    }
    exit(-1);
  8010d9:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  8010e0:	e8 2d f2 ff ff       	call   800312 <exit>
...
main(void) {
  ...
  8010e8:	83 e4 f0             	and    $0xfffffff0,%esp
  8010eb:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  8010ee:	e8 ac f2 ff ff       	call   80039f <getpid>
  8010f3:	a3 08 20 80 00       	mov    %eax,0x802008
    if ((pid1 = fork()) == 0) {
  8010f8:	e8 34 f2 ff ff       	call   800331 <fork>
  8010fd:	a3 0c 20 80 00       	mov    %eax,0x80200c
  801102:	a1 0c 20 80 00       	mov    0x80200c,%eax
  801107:	85 c0                	test   %eax,%eax
  801109:	75 05                	jne    801110 <main+0x2b>
        loop();
  80110b:	e8 53 ff ff ff       	call   801063 <loop>
    }

    assert(pid1 > 0);
  801110:	a1 0c 20 80 00       	mov    0x80200c,%eax
  801115:	85 c0                	test   %eax,%eax
  801117:	7f 24                	jg     80113d <main+0x58>
  801119:	c7 44 24 0c f6 14 80 	movl   $0x8014f6,0xc(%esp)
  801120:	00 
  801121:	c7 44 24 08 ff 14 80 	movl   $0x8014ff,0x8(%esp)
  801128:	00 
  801129:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  801130:	00 
  801131:	c7 04 24 14 15 80 00 	movl   $0x801514,(%esp)
  801138:	e8 f2 ee ff ff       	call   80002f <__panic>

    if ((pid2 = fork()) == 0) {
  80113d:	e8 ef f1 ff ff       	call   800331 <fork>
  801142:	a3 10 20 80 00       	mov    %eax,0x802010
  801147:	a1 10 20 80 00       	mov    0x802010,%eax
  80114c:	85 c0                	test   %eax,%eax
  80114e:	75 05                	jne    801155 <main+0x70>
        work();
  801150:	e8 22 ff ff ff       	call   801077 <work>
    }
    if (pid2 > 0) {
  801155:	a1 10 20 80 00       	mov    0x802010,%eax
  80115a:	85 c0                	test   %eax,%eax
  80115c:	7e 46                	jle    8011a4 <main+0xbf>
        cprintf("wait child 1.\n");
  80115e:	c7 04 24 24 15 80 00 	movl   $0x801524,(%esp)
  801165:	e8 b6 ef ff ff       	call   800120 <cprintf>
        waitpid(pid1, NULL);
  80116a:	a1 0c 20 80 00       	mov    0x80200c,%eax
  80116f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801176:	00 
  801177:	89 04 24             	mov    %eax,(%esp)
  80117a:	e8 df f1 ff ff       	call   80035e <waitpid>
        panic("waitpid %d returns\n", pid1);
  80117f:	a1 0c 20 80 00       	mov    0x80200c,%eax
  801184:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801188:	c7 44 24 08 33 15 80 	movl   $0x801533,0x8(%esp)
  80118f:	00 
  801190:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  801197:	00 
  801198:	c7 04 24 14 15 80 00 	movl   $0x801514,(%esp)
  80119f:	e8 8b ee ff ff       	call   80002f <__panic>
    }
    else {
        kill(pid1);
  8011a4:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8011a9:	89 04 24             	mov    %eax,(%esp)
  8011ac:	e8 d9 f1 ff ff       	call   80038a <kill>
    }
    panic("FAIL: T.T\n");
  8011b1:	c7 44 24 08 47 15 80 	movl   $0x801547,0x8(%esp)
  8011b8:	00 
  8011b9:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  8011c0:	00 
  8011c1:	c7 04 24 14 15 80 00 	movl   $0x801514,(%esp)
  8011c8:	e8 62 ee ff ff       	call   80002f <__panic>
