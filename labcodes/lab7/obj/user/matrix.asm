...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800049:	c7 04 24 20 14 80 00 	movl   $0x801420,(%esp)
  ...
  800062:	e8 84 00 00 00       	call   8000eb <vcprintf>
    cprintf("\n");
  800067:	c7 04 24 3a 14 80 00 	movl   $0x80143a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800099:	c7 04 24 3c 14 80 00 	movl   $0x80143c,(%esp)
  ...
  8000b2:	e8 34 00 00 00       	call   8000eb <vcprintf>
    cprintf("\n");
  8000b7:	c7 04 24 3a 14 80 00 	movl   $0x80143a,(%esp)
...
exit(int error_code) {
  ...
  800323:	c7 04 24 58 14 80 00 	movl   $0x801458,(%esp)
...
umain(void) {
  ...
  8003fb:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003fe:	e8 67 0e 00 00       	call   80126a <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80051b:	05 84 15 80 00       	add    $0x801584,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80066f:	8b 04 85 a8 15 80 00 	mov    0x8015a8(,%eax,4),%eax
  ...
  800771:	c7 44 24 08 9e 15 80 	movl   $0x80159e,0x8(%esp)
  800778:	00 
  ...
  80079d:	75 05                	jne    8007a4 <vprintfmt+0x1a3>
                p = "(null)";
  80079f:	be a1 15 80 00       	mov    $0x8015a1,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  801040:	89 5d fc             	mov    %ebx,-0x4(%ebp)
    int i, j, k, size = MATSIZE;
  801043:	c7 45 e8 0a 00 00 00 	movl   $0xa,-0x18(%ebp)
    for (i = 0; i < size; i ++) {
  80104a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801051:	eb 63                	jmp    8010b6 <work+0x7c>
        for (j = 0; j < size; j ++) {
  801053:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  80105a:	eb 4f                	jmp    8010ab <work+0x71>
            mata[i][j] = matb[i][j] = 1;
  ...
  80106d:	c7 04 85 c0 21 80 00 	movl   $0x1,0x8021c0(,%eax,4)
  801074:	01 00 00 00 
  ...
  801089:	8b 14 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%edx
  801090:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801093:	89 c8                	mov    %ecx,%eax
  801095:	c1 e0 02             	shl    $0x2,%eax
  801098:	01 c8                	add    %ecx,%eax
  80109a:	01 c0                	add    %eax,%eax
  80109c:	8b 4d f0             	mov    -0x10(%ebp),%ecx
  80109f:	01 c8                	add    %ecx,%eax
  8010a1:	89 14 85 20 20 80 00 	mov    %edx,0x802020(,%eax,4)
        for (j = 0; j < size; j ++) {
  8010a8:	ff 45 f0             	incl   -0x10(%ebp)
  8010ab:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8010ae:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8010b1:	7c a9                	jl     80105c <work+0x22>
    for (i = 0; i < size; i ++) {
  8010b3:	ff 45 f4             	incl   -0xc(%ebp)
  8010b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8010b9:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8010bc:	7c 95                	jl     801053 <work+0x19>
        }
    }
  ...
  8010c3:	e8 d7 f2 ff ff       	call   80039f <getpid>
  8010c8:	8b 55 08             	mov    0x8(%ebp),%edx
  8010cb:	89 54 24 08          	mov    %edx,0x8(%esp)
  8010cf:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010d3:	c7 04 24 00 17 80 00 	movl   $0x801700,(%esp)
  8010da:	e8 41 f0 ff ff       	call   800120 <cprintf>

    while (times -- > 0) {
  8010df:	e9 54 01 00 00       	jmp    801238 <work+0x1fe>
        for (i = 0; i < size; i ++) {
  8010e4:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8010eb:	e9 b4 00 00 00       	jmp    8011a4 <work+0x16a>
            for (j = 0; j < size; j ++) {
  8010f0:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  8010f7:	e9 99 00 00 00       	jmp    801195 <work+0x15b>
                matc[i][j] = 0;
  8010fc:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8010ff:	89 d0                	mov    %edx,%eax
  801101:	c1 e0 02             	shl    $0x2,%eax
  801104:	01 d0                	add    %edx,%eax
  801106:	01 c0                	add    %eax,%eax
  801108:	8b 55 f0             	mov    -0x10(%ebp),%edx
  80110b:	01 d0                	add    %edx,%eax
  80110d:	c7 04 85 60 23 80 00 	movl   $0x0,0x802360(,%eax,4)
  801114:	00 00 00 00 
                for (k = 0; k < size; k ++) {
  801118:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  80111f:	eb 69                	jmp    80118a <work+0x150>
  ...
  801132:	8b 1c 85 60 23 80 00 	mov    0x802360(,%eax,4),%ebx
  801139:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80113c:	89 d0                	mov    %edx,%eax
  80113e:	c1 e0 02             	shl    $0x2,%eax
  801141:	01 d0                	add    %edx,%eax
  801143:	01 c0                	add    %eax,%eax
  801145:	8b 55 ec             	mov    -0x14(%ebp),%edx
  801148:	01 d0                	add    %edx,%eax
  80114a:	8b 0c 85 20 20 80 00 	mov    0x802020(,%eax,4),%ecx
  801151:	8b 55 ec             	mov    -0x14(%ebp),%edx
  801154:	89 d0                	mov    %edx,%eax
  801156:	c1 e0 02             	shl    $0x2,%eax
  801159:	01 d0                	add    %edx,%eax
  80115b:	01 c0                	add    %eax,%eax
  80115d:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801160:	01 d0                	add    %edx,%eax
  801162:	8b 04 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%eax
  801169:	0f af c1             	imul   %ecx,%eax
  80116c:	8d 0c 03             	lea    (%ebx,%eax,1),%ecx
  ...
  801180:	89 0c 85 60 23 80 00 	mov    %ecx,0x802360(,%eax,4)
                for (k = 0; k < size; k ++) {
  801187:	ff 45 ec             	incl   -0x14(%ebp)
  80118a:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80118d:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801190:	7c 8f                	jl     801121 <work+0xe7>
            for (j = 0; j < size; j ++) {
  801192:	ff 45 f0             	incl   -0x10(%ebp)
  801195:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801198:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80119b:	0f 8c 5b ff ff ff    	jl     8010fc <work+0xc2>
        for (i = 0; i < size; i ++) {
  8011a1:	ff 45 f4             	incl   -0xc(%ebp)
  8011a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8011a7:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8011aa:	0f 8c 40 ff ff ff    	jl     8010f0 <work+0xb6>
                }
            }
        }
        for (i = 0; i < size; i ++) {
  8011b0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8011b7:	eb 77                	jmp    801230 <work+0x1f6>
            for (j = 0; j < size; j ++) {
  8011b9:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  8011c0:	eb 63                	jmp    801225 <work+0x1eb>
  ...
  8011d3:	8b 14 85 60 23 80 00 	mov    0x802360(,%eax,4),%edx
  8011da:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  8011dd:	89 c8                	mov    %ecx,%eax
  8011df:	c1 e0 02             	shl    $0x2,%eax
  8011e2:	01 c8                	add    %ecx,%eax
  8011e4:	01 c0                	add    %eax,%eax
  8011e6:	8b 4d f0             	mov    -0x10(%ebp),%ecx
  8011e9:	01 c8                	add    %ecx,%eax
  8011eb:	89 14 85 c0 21 80 00 	mov    %edx,0x8021c0(,%eax,4)
  8011f2:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8011f5:	89 d0                	mov    %edx,%eax
  8011f7:	c1 e0 02             	shl    $0x2,%eax
  8011fa:	01 d0                	add    %edx,%eax
  8011fc:	01 c0                	add    %eax,%eax
  8011fe:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801201:	01 d0                	add    %edx,%eax
  801203:	8b 14 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%edx
  80120a:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  80120d:	89 c8                	mov    %ecx,%eax
  80120f:	c1 e0 02             	shl    $0x2,%eax
  801212:	01 c8                	add    %ecx,%eax
  801214:	01 c0                	add    %eax,%eax
  801216:	8b 4d f0             	mov    -0x10(%ebp),%ecx
  801219:	01 c8                	add    %ecx,%eax
  80121b:	89 14 85 20 20 80 00 	mov    %edx,0x802020(,%eax,4)
            for (j = 0; j < size; j ++) {
  801222:	ff 45 f0             	incl   -0x10(%ebp)
  801225:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801228:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80122b:	7c 95                	jl     8011c2 <work+0x188>
        for (i = 0; i < size; i ++) {
  80122d:	ff 45 f4             	incl   -0xc(%ebp)
  801230:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801233:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801236:	7c 81                	jl     8011b9 <work+0x17f>
    while (times -- > 0) {
  801238:	8b 45 08             	mov    0x8(%ebp),%eax
  80123b:	8d 50 ff             	lea    -0x1(%eax),%edx
  80123e:	89 55 08             	mov    %edx,0x8(%ebp)
  801241:	85 c0                	test   %eax,%eax
  801243:	0f 85 9b fe ff ff    	jne    8010e4 <work+0xaa>
            }
        }
    }
    cprintf("pid %d done!.\n", getpid());
  801249:	e8 51 f1 ff ff       	call   80039f <getpid>
  80124e:	89 44 24 04          	mov    %eax,0x4(%esp)
  801252:	c7 04 24 20 17 80 00 	movl   $0x801720,(%esp)
  801259:	e8 c2 ee ff ff       	call   800120 <cprintf>
    exit(0);
  80125e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801265:	e8 a8 f0 ff ff       	call   800312 <exit>
...
int
main(void) {
  80126a:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  80126e:	83 e4 f0             	and    $0xfffffff0,%esp
  801271:	ff 71 fc             	pushl  -0x4(%ecx)
  801274:	55                   	push   %ebp
  801275:	89 e5                	mov    %esp,%ebp
  801277:	53                   	push   %ebx
  801278:	51                   	push   %ecx
  801279:	83 ec 20             	sub    $0x20,%esp
  80127c:	89 e0                	mov    %esp,%eax
  80127e:	89 c3                	mov    %eax,%ebx
    int pids[total];
  801280:	b8 15 00 00 00       	mov    $0x15,%eax
  801285:	48                   	dec    %eax
  801286:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801289:	b8 15 00 00 00       	mov    $0x15,%eax
  80128e:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801295:	b8 10 00 00 00       	mov    $0x10,%eax
  80129a:	48                   	dec    %eax
  80129b:	01 d0                	add    %edx,%eax
  80129d:	b9 10 00 00 00       	mov    $0x10,%ecx
  8012a2:	ba 00 00 00 00       	mov    $0x0,%edx
  8012a7:	f7 f1                	div    %ecx
  8012a9:	6b c0 10             	imul   $0x10,%eax,%eax
  8012ac:	29 c4                	sub    %eax,%esp
  8012ae:	8d 44 24 0c          	lea    0xc(%esp),%eax
  8012b2:	83 c0 03             	add    $0x3,%eax
  8012b5:	c1 e8 02             	shr    $0x2,%eax
  8012b8:	c1 e0 02             	shl    $0x2,%eax
  8012bb:	89 45 ec             	mov    %eax,-0x14(%ebp)
    memset(pids, 0, sizeof(pids));
  8012be:	b8 15 00 00 00       	mov    $0x15,%eax
  8012c3:	c1 e0 02             	shl    $0x2,%eax
  8012c6:	89 44 24 08          	mov    %eax,0x8(%esp)
  8012ca:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8012d1:	00 
  8012d2:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8012d5:	89 04 24             	mov    %eax,(%esp)
  8012d8:	e8 d1 fb ff ff       	call   800eae <memset>

    int i;
    for (i = 0; i < total; i ++) {
  8012dd:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8012e4:	eb 7b                	jmp    801361 <main+0xf7>
        if ((pids[i] = fork()) == 0) {
  8012e6:	e8 46 f0 ff ff       	call   800331 <fork>
  8012eb:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8012ee:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  8012f1:	89 04 8a             	mov    %eax,(%edx,%ecx,4)
  8012f4:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8012f7:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8012fa:	8b 04 90             	mov    (%eax,%edx,4),%eax
  8012fd:	85 c0                	test   %eax,%eax
  8012ff:	75 50                	jne    801351 <main+0xe7>
            srand(i * i);
  801301:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801304:	0f af c0             	imul   %eax,%eax
  801307:	89 04 24             	mov    %eax,(%esp)
  80130a:	e8 5c f8 ff ff       	call   800b6b <srand>
            int times = (((unsigned int)rand()) % total);
  80130f:	e8 98 f7 ff ff       	call   800aac <rand>
  801314:	ba 15 00 00 00       	mov    $0x15,%edx
  801319:	89 d1                	mov    %edx,%ecx
  80131b:	ba 00 00 00 00       	mov    $0x0,%edx
  801320:	f7 f1                	div    %ecx
  801322:	89 d0                	mov    %edx,%eax
  801324:	89 45 e8             	mov    %eax,-0x18(%ebp)
            times = (times * times + 10) * 100;
  801327:	8b 45 e8             	mov    -0x18(%ebp),%eax
  80132a:	0f af c0             	imul   %eax,%eax
  80132d:	8d 50 0a             	lea    0xa(%eax),%edx
  ...
  801357:	8b 04 90             	mov    (%eax,%edx,4),%eax
  80135a:	85 c0                	test   %eax,%eax
  80135c:	78 5f                	js     8013bd <main+0x153>
    for (i = 0; i < total; i ++) {
  80135e:	ff 45 f4             	incl   -0xc(%ebp)
  801361:	b8 15 00 00 00       	mov    $0x15,%eax
  801366:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801369:	0f 8c 77 ff ff ff    	jl     8012e6 <main+0x7c>
            goto failed;
        }
    }

    cprintf("fork ok.\n");
  80136f:	c7 04 24 34 17 80 00 	movl   $0x801734,(%esp)
  801376:	e8 a5 ed ff ff       	call   800120 <cprintf>

    for (i = 0; i < total; i ++) {
  80137b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801382:	eb 1a                	jmp    80139e <main+0x134>
        if (wait() != 0) {
  801384:	e8 b7 ef ff ff       	call   800340 <wait>
  801389:	85 c0                	test   %eax,%eax
  80138b:	74 0e                	je     80139b <main+0x131>
            cprintf("wait failed.\n");
  80138d:	c7 04 24 3e 17 80 00 	movl   $0x80173e,(%esp)
  801394:	e8 87 ed ff ff       	call   800120 <cprintf>
            goto failed;
  801399:	eb 23                	jmp    8013be <main+0x154>
    for (i = 0; i < total; i ++) {
  80139b:	ff 45 f4             	incl   -0xc(%ebp)
  80139e:	b8 15 00 00 00       	mov    $0x15,%eax
  8013a3:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  8013a6:	7c dc                	jl     801384 <main+0x11a>
        }
    }

    cprintf("matrix pass.\n");
  8013a8:	c7 04 24 4c 17 80 00 	movl   $0x80174c,(%esp)
  8013af:	e8 6c ed ff ff       	call   800120 <cprintf>
    return 0;
  8013b4:	b8 00 00 00 00       	mov    $0x0,%eax
  8013b9:	89 dc                	mov    %ebx,%esp
  8013bb:	eb 51                	jmp    80140e <main+0x1a4>
            goto failed;
  8013bd:	90                   	nop

failed:
    for (i = 0; i < total; i ++) {
  8013be:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8013c5:	eb 21                	jmp    8013e8 <main+0x17e>
        if (pids[i] > 0) {
  8013c7:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8013ca:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8013cd:	8b 04 90             	mov    (%eax,%edx,4),%eax
  8013d0:	85 c0                	test   %eax,%eax
  8013d2:	7e 11                	jle    8013e5 <main+0x17b>
            kill(pids[i]);
  8013d4:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8013d7:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8013da:	8b 04 90             	mov    (%eax,%edx,4),%eax
  8013dd:	89 04 24             	mov    %eax,(%esp)
  8013e0:	e8 a5 ef ff ff       	call   80038a <kill>
    for (i = 0; i < total; i ++) {
  8013e5:	ff 45 f4             	incl   -0xc(%ebp)
  8013e8:	b8 15 00 00 00       	mov    $0x15,%eax
  8013ed:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  8013f0:	7c d5                	jl     8013c7 <main+0x15d>
        }
    }
    panic("FAIL: T.T\n");
  8013f2:	c7 44 24 08 5a 17 80 	movl   $0x80175a,0x8(%esp)
  8013f9:	00 
  8013fa:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  801401:	00 
  801402:	c7 04 24 65 17 80 00 	movl   $0x801765,(%esp)
  801409:	e8 21 ec ff ff       	call   80002f <__panic>
}
  80140e:	8d 65 f8             	lea    -0x8(%ebp),%esp
  801411:	59                   	pop    %ecx
  801412:	5b                   	pop    %ebx
  801413:	5d                   	pop    %ebp
  801414:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801417:	c3                   	ret    
