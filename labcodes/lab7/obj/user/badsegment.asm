...
main(void) {
  ...
  801043:	66 b8 28 00          	mov    $0x28,%ax
  801047:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  801049:	c7 44 24 08 60 13 80 	movl   $0x801360,0x8(%esp)
  801050:	00 
  801051:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  801058:	00 
  801059:	c7 04 24 6b 13 80 00 	movl   $0x80136b,(%esp)
