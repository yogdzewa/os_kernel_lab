...
main(void) {
  ...
  800eec:	68 c0 12 80 00       	push   $0x8012c0
  800ef1:	e8 1b f2 ff ff       	call   800111 <cprintf>
  800ef6:	83 c4 10             	add    $0x10,%esp
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  800ef9:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  800f00:	eb 26                	jmp    800f28 <main+0x50>
        if (bigarray[i] != 0) {
  800f02:	8b 45 f4             	mov    -0xc(%ebp),%eax
  800f05:	8b 04 85 20 20 80 00 	mov    0x802020(,%eax,4),%eax
  800f0c:	85 c0                	test   %eax,%eax
  800f0e:	74 14                	je     800f24 <main+0x4c>
            panic("bigarray[%d] isn't cleared!\n", i);
  800f10:	ff 75 f4             	pushl  -0xc(%ebp)
  800f13:	68 e0 12 80 00       	push   $0x8012e0
  800f18:	6a 0e                	push   $0xe
  800f1a:	68 fd 12 80 00       	push   $0x8012fd
  800f1f:	e8 0b f1 ff ff       	call   80002f <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  800f24:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  800f28:	81 7d f4 ff ff 0f 00 	cmpl   $0xfffff,-0xc(%ebp)
  800f2f:	7e d1                	jle    800f02 <main+0x2a>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  800f31:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  800f38:	eb 11                	jmp    800f4b <main+0x73>
        bigarray[i] = i;
  800f3a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  800f3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  800f40:	89 14 85 20 20 80 00 	mov    %edx,0x802020(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
  800f47:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  800f4b:	81 7d f4 ff ff 0f 00 	cmpl   $0xfffff,-0xc(%ebp)
  800f52:	7e e6                	jle    800f3a <main+0x62>
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  800f54:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  800f5b:	eb 29                	jmp    800f86 <main+0xae>
        if (bigarray[i] != i) {
  800f5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  800f60:	8b 14 85 20 20 80 00 	mov    0x802020(,%eax,4),%edx
  ...
  800f71:	68 0c 13 80 00       	push   $0x80130c
  800f76:	6a 16                	push   $0x16
  800f78:	68 fd 12 80 00       	push   $0x8012fd
  800f7d:	e8 ad f0 ff ff       	call   80002f <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  800f82:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  800f86:	81 7d f4 ff ff 0f 00 	cmpl   $0xfffff,-0xc(%ebp)
  800f8d:	7e ce                	jle    800f5d <main+0x85>
        }
    }

    cprintf("Yes, good.  Now doing a wild write off the end...\n");
  800f8f:	83 ec 0c             	sub    $0xc,%esp
  800f92:	68 34 13 80 00       	push   $0x801334
  800f97:	e8 75 f1 ff ff       	call   800111 <cprintf>
  800f9c:	83 c4 10             	add    $0x10,%esp
    cprintf("testbss may pass.\n");
  800f9f:	83 ec 0c             	sub    $0xc,%esp
  800fa2:	68 67 13 80 00       	push   $0x801367
  800fa7:	e8 65 f1 ff ff       	call   800111 <cprintf>
  800fac:	83 c4 10             	add    $0x10,%esp

    bigarray[ARRAYSIZE + 1024] = 0;
  800faf:	c7 05 20 30 c0 00 00 	movl   $0x0,0xc03020
  800fb6:	00 00 00 
    asm volatile ("int $0x14");
  800fb9:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  800fbb:	83 ec 04             	sub    $0x4,%esp
  800fbe:	68 7a 13 80 00       	push   $0x80137a
  800fc3:	6a 1f                	push   $0x1f
  800fc5:	68 fd 12 80 00       	push   $0x8012fd
  800fca:	e8 60 f0 ff ff       	call   80002f <__panic>
