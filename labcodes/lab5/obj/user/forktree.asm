...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800044:	68 c0 0f 80 00       	push   $0x800fc0
  ...
  800066:	68 da 0f 80 00       	push   $0x800fda
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	68 dc 0f 80 00       	push   $0x800fdc
  ...
  8000b4:	68 da 0f 80 00       	push   $0x800fda
...
exit(int error_code) {
  ...
  800279:	68 f8 0f 80 00       	push   $0x800ff8
...
umain(void) {
  ...
  800307:	83 ec 18             	sub    $0x18,%esp
    int ret = main();
  80030a:	e8 72 0c 00 00       	call   800f81 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800411:	05 24 11 80 00       	add    $0x801124,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800556:	8b 04 85 48 11 80 00 	mov    0x801148(,%eax,4),%eax
  ...
  800628:	8b 34 9d c0 10 80 00 	mov    0x8010c0(,%ebx,4),%esi
  80062f:	85 f6                	test   %esi,%esi
  800631:	75 19                	jne    80064c <vprintfmt+0x164>
                printfmt(putch, putdat, "error %d", err);
  800633:	53                   	push   %ebx
  800634:	68 35 11 80 00       	push   $0x801135
  ...
  800647:	e9 37 02 00 00       	jmp    800883 <vprintfmt+0x39b>
                printfmt(putch, putdat, "%s", p);
  80064c:	56                   	push   %esi
  80064d:	68 3e 11 80 00       	push   $0x80113e
  ...
  800672:	75 05                	jne    800679 <vprintfmt+0x191>
                p = "(null)";
  800674:	be 41 11 80 00       	mov    $0x801141,%esi
            }
            if (width > 0 && padc != '-') {
...
forkchild(const char *cur, char branch) {
  ...
  800ee1:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  800ee4:	83 ec 0c             	sub    $0xc,%esp
  800ee7:	ff 75 08             	pushl  0x8(%ebp)
  800eea:	e8 32 fb ff ff       	call   800a21 <strlen>
  800eef:	83 c4 10             	add    $0x10,%esp
  800ef2:	83 f8 03             	cmp    $0x3,%eax
  800ef5:	77 45                	ja     800f3c <forkchild+0x64>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  800ef7:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  800efb:	83 ec 0c             	sub    $0xc,%esp
  800efe:	50                   	push   %eax
  800eff:	ff 75 08             	pushl  0x8(%ebp)
  800f02:	68 a0 12 80 00       	push   $0x8012a0
  800f07:	6a 05                	push   $0x5
  800f09:	8d 45 f3             	lea    -0xd(%ebp),%eax
  800f0c:	50                   	push   %eax
  800f0d:	e8 b4 f9 ff ff       	call   8008c6 <snprintf>
  800f12:	83 c4 20             	add    $0x20,%esp
    if (fork() == 0) {
  800f15:	e8 6e f3 ff ff       	call   800288 <fork>
  800f1a:	85 c0                	test   %eax,%eax
  800f1c:	75 1f                	jne    800f3d <forkchild+0x65>
        forktree(nxt);
  800f1e:	83 ec 0c             	sub    $0xc,%esp
  800f21:	8d 45 f3             	lea    -0xd(%ebp),%eax
  800f24:	50                   	push   %eax
  800f25:	e8 15 00 00 00       	call   800f3f <forktree>
  800f2a:	83 c4 10             	add    $0x10,%esp
        yield();
  800f2d:	e8 93 f3 ff ff       	call   8002c5 <yield>
        exit(0);
  800f32:	83 ec 0c             	sub    $0xc,%esp
  800f35:	6a 00                	push   $0x0
  800f37:	e8 26 f3 ff ff       	call   800262 <exit>
        return;
  800f3c:	90                   	nop
    }
}
...
forktree(const char *cur) {
  ...
  800f42:	83 ec 08             	sub    $0x8,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  800f45:	e8 9f f3 ff ff       	call   8002e9 <getpid>
  800f4a:	83 ec 04             	sub    $0x4,%esp
  800f4d:	ff 75 08             	pushl  0x8(%ebp)
  800f50:	50                   	push   %eax
  800f51:	68 a5 12 80 00       	push   $0x8012a5
  800f56:	e8 b6 f1 ff ff       	call   800111 <cprintf>
  800f5b:	83 c4 10             	add    $0x10,%esp

    forkchild(cur, '0');
  800f5e:	83 ec 08             	sub    $0x8,%esp
  800f61:	6a 30                	push   $0x30
  800f63:	ff 75 08             	pushl  0x8(%ebp)
  800f66:	e8 6d ff ff ff       	call   800ed8 <forkchild>
  800f6b:	83 c4 10             	add    $0x10,%esp
    forkchild(cur, '1');
  800f6e:	83 ec 08             	sub    $0x8,%esp
  800f71:	6a 31                	push   $0x31
  800f73:	ff 75 08             	pushl  0x8(%ebp)
  800f76:	e8 5d ff ff ff       	call   800ed8 <forkchild>
...
int
main(void) {
  800f81:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  800f85:	83 e4 f0             	and    $0xfffffff0,%esp
  800f88:	ff 71 fc             	pushl  -0x4(%ecx)
  800f8b:	55                   	push   %ebp
  ...
  800f95:	68 b6 12 80 00       	push   $0x8012b6
  800f9a:	e8 a0 ff ff ff       	call   800f3f <forktree>
  800f9f:	83 c4 10             	add    $0x10,%esp
    return 0;
  800fa2:	b8 00 00 00 00       	mov    $0x0,%eax
}
  800fa7:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  800faa:	c9                   	leave  
  800fab:	8d 61 fc             	lea    -0x4(%ecx),%esp
  800fae:	c3                   	ret    
