...
exit(int error_code) {
  ...
  800306:	c7 04 24 78 10 80 00 	movl   $0x801078,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004e9:	05 a4 11 80 00       	add    $0x8011a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80063d:	8b 04 85 c8 11 80 00 	mov    0x8011c8(,%eax,4),%eax
  ...
  80073f:	c7 44 24 08 be 11 80 	movl   $0x8011be,0x8(%esp)
  800746:	00 
  ...
  80076b:	75 05                	jne    800772 <vprintfmt+0x1a3>
                p = "(null)";
  80076d:	be c1 11 80 00       	mov    $0x8011c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  80101a:	c7 04 24 20 13 80 00 	movl   $0x801320,(%esp)
  801021:	e8 fa f0 ff ff       	call   800120 <cprintf>
    print_pgdir();
  801026:	e8 66 f3 ff ff       	call   800391 <print_pgdir>
    cprintf("pgdir pass.\n");
  80102b:	c7 04 24 37 13 80 00 	movl   $0x801337,(%esp)
  801032:	e8 e9 f0 ff ff       	call   800120 <cprintf>
    return 0;
