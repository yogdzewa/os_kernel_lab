...
main(void) {
  ...
  80104c:	c7 04 24 60 13 80 00 	movl   $0x801360,(%esp)
  801053:	e8 c8 f0 ff ff       	call   800120 <cprintf>
    print_pgdir();
  801058:	e8 51 f3 ff ff       	call   8003ae <print_pgdir>
    cprintf("pgdir pass.\n");
  80105d:	c7 04 24 77 13 80 00 	movl   $0x801377,(%esp)
  801064:	e8 b7 f0 ff ff       	call   800120 <cprintf>
    return 0;
