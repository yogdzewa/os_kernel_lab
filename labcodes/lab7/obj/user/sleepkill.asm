...
exit(int error_code) {
  ...
  800323:	c7 04 24 38 11 80 00 	movl   $0x801138,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80051b:	05 64 12 80 00       	add    $0x801264,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80066f:	8b 04 85 88 12 80 00 	mov    0x801288(,%eax,4),%eax
  ...
  800771:	c7 44 24 08 7e 12 80 	movl   $0x80127e,0x8(%esp)
  800778:	00 
  ...
  80079d:	75 05                	jne    8007a4 <vprintfmt+0x1a3>
                p = "(null)";
  80079f:	be 81 12 80 00       	mov    $0x801281,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801048:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  80104c:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801051:	75 18                	jne    80106b <main+0x31>
        sleep(~0);
  801053:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  80105a:	e8 84 f3 ff ff       	call   8003e3 <sleep>
        exit(0xdead);
  80105f:	c7 04 24 ad de 00 00 	movl   $0xdead,(%esp)
  801066:	e8 a7 f2 ff ff       	call   800312 <exit>
    }
    assert(pid > 0);
  80106b:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801070:	7f 24                	jg     801096 <main+0x5c>
  801072:	c7 44 24 0c e0 13 80 	movl   $0x8013e0,0xc(%esp)
  801079:	00 
  80107a:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  801081:	00 
  801082:	c7 44 24 04 0b 00 00 	movl   $0xb,0x4(%esp)
  801089:	00 
  80108a:	c7 04 24 fd 13 80 00 	movl   $0x8013fd,(%esp)
  801091:	e8 99 ef ff ff       	call   80002f <__panic>

    sleep(100);
  801096:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  80109d:	e8 41 f3 ff ff       	call   8003e3 <sleep>
    assert(kill(pid) == 0);
  8010a2:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010a6:	89 04 24             	mov    %eax,(%esp)
  8010a9:	e8 dc f2 ff ff       	call   80038a <kill>
  8010ae:	85 c0                	test   %eax,%eax
  8010b0:	74 24                	je     8010d6 <main+0x9c>
  8010b2:	c7 44 24 0c 0e 14 80 	movl   $0x80140e,0xc(%esp)
  8010b9:	00 
  8010ba:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  8010c1:	00 
  8010c2:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  8010c9:	00 
  8010ca:	c7 04 24 fd 13 80 00 	movl   $0x8013fd,(%esp)
  8010d1:	e8 59 ef ff ff       	call   80002f <__panic>
    cprintf("sleepkill pass.\n");
  8010d6:	c7 04 24 1d 14 80 00 	movl   $0x80141d,(%esp)
  8010dd:	e8 3e f0 ff ff       	call   800120 <cprintf>
    return 0;
