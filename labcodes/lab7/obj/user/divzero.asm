...
main(void) {
  ...
  801040:	83 ec 10             	sub    $0x10,%esp
    cprintf("value is %d.\n", 1 / zero);
  801043:	8b 0d 08 20 80 00    	mov    0x802008,%ecx
  801049:	b8 01 00 00 00       	mov    $0x1,%eax
  80104e:	99                   	cltd   
  80104f:	f7 f9                	idiv   %ecx
  801051:	89 44 24 04          	mov    %eax,0x4(%esp)
  801055:	c7 04 24 60 13 80 00 	movl   $0x801360,(%esp)
  80105c:	e8 bf f0 ff ff       	call   800120 <cprintf>
    panic("FAIL: T.T\n");
  801061:	c7 44 24 08 6e 13 80 	movl   $0x80136e,0x8(%esp)
  801068:	00 
  801069:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  801070:	00 
  801071:	c7 04 24 79 13 80 00 	movl   $0x801379,(%esp)
