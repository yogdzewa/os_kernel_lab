...
main(void) {
  ...
  800fb8:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  800fbf:	00 
  800fc0:	eb 5f                	jmp    801021 <main+0x72>
        if ((pid = fork()) == 0) {
  800fc2:	e8 19 f3 ff ff       	call   8002e0 <fork>
  800fc7:	89 44 24 18          	mov    %eax,0x18(%esp)
  800fcb:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  800fd0:	75 20                	jne    800ff2 <main+0x43>
            cprintf("I am child %d\n", n);
  800fd2:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  800fd6:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fda:	c7 04 24 c4 13 80 00 	movl   $0x8013c4,(%esp)
  800fe1:	e8 3a f1 ff ff       	call   800120 <cprintf>
            exit(0);
  800fe6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800fed:	e8 cf f2 ff ff       	call   8002c1 <exit>
        }
        assert(pid > 0);
  800ff2:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  800ff7:	7f 24                	jg     80101d <main+0x6e>
  800ff9:	c7 44 24 0c d3 13 80 	movl   $0x8013d3,0xc(%esp)
  801000:	00 
  801001:	c7 44 24 08 db 13 80 	movl   $0x8013db,0x8(%esp)
  801008:	00 
  801009:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801010:	00 
  801011:	c7 04 24 f0 13 80 00 	movl   $0x8013f0,(%esp)
  801018:	e8 12 f0 ff ff       	call   80002f <__panic>
    for (n = 0; n < max_child; n ++) {
  80101d:	ff 44 24 1c          	incl   0x1c(%esp)
  801021:	b8 20 00 00 00       	mov    $0x20,%eax
  801026:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  80102a:	7c 96                	jl     800fc2 <main+0x13>
    }

    if (n > max_child) {
  80102c:	b8 20 00 00 00       	mov    $0x20,%eax
  801031:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801035:	7e 4d                	jle    801084 <main+0xd5>
        panic("fork claimed to work %d times!\n", n);
  801037:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80103b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80103f:	c7 44 24 08 00 14 80 	movl   $0x801400,0x8(%esp)
  801046:	00 
  801047:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  80104e:	00 
  80104f:	c7 04 24 f0 13 80 00 	movl   $0x8013f0,(%esp)
  801056:	e8 d4 ef ff ff       	call   80002f <__panic>
    }

    for (; n > 0; n --) {
        if (wait() != 0) {
  80105b:	e8 8f f2 ff ff       	call   8002ef <wait>
  801060:	85 c0                	test   %eax,%eax
  801062:	74 1c                	je     801080 <main+0xd1>
            panic("wait stopped early\n");
  801064:	c7 44 24 08 20 14 80 	movl   $0x801420,0x8(%esp)
  80106b:	00 
  80106c:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801073:	00 
  801074:	c7 04 24 f0 13 80 00 	movl   $0x8013f0,(%esp)
  80107b:	e8 af ef ff ff       	call   80002f <__panic>
    for (; n > 0; n --) {
  801080:	ff 4c 24 1c          	decl   0x1c(%esp)
  801084:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801089:	7f d0                	jg     80105b <main+0xac>
        }
    }

    if (wait() == 0) {
  80108b:	e8 5f f2 ff ff       	call   8002ef <wait>
  801090:	85 c0                	test   %eax,%eax
  801092:	75 1c                	jne    8010b0 <main+0x101>
        panic("wait got too many\n");
  801094:	c7 44 24 08 34 14 80 	movl   $0x801434,0x8(%esp)
  80109b:	00 
  80109c:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8010a3:	00 
  8010a4:	c7 04 24 f0 13 80 00 	movl   $0x8013f0,(%esp)
  8010ab:	e8 7f ef ff ff       	call   80002f <__panic>
    }

    cprintf("forktest pass.\n");
  8010b0:	c7 04 24 47 14 80 00 	movl   $0x801447,(%esp)
  8010b7:	e8 64 f0 ff ff       	call   800120 <cprintf>
    return 0;
