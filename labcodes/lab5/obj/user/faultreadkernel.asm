...
main(void) {
  ...
  800fb8:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  800fbd:	8b 00                	mov    (%eax),%eax
  800fbf:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fc3:	c7 04 24 e0 12 80 00 	movl   $0x8012e0,(%esp)
  800fca:	e8 51 f1 ff ff       	call   800120 <cprintf>
    panic("FAIL: T.T\n");
  800fcf:	c7 44 24 08 fe 12 80 	movl   $0x8012fe,0x8(%esp)
  800fd6:	00 
  800fd7:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  800fde:	00 
  800fdf:	c7 04 24 09 13 80 00 	movl   $0x801309,(%esp)
  800fe6:	e8 44 f0 ff ff       	call   80002f <__panic>
