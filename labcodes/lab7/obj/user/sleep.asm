...
exit(int error_code) {
  ...
  800323:	c7 04 24 78 11 80 00 	movl   $0x801178,(%esp)
...
umain(void) {
  ...
  8003fb:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003fe:	e8 8a 0c 00 00       	call   80108d <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80051b:	05 a4 12 80 00       	add    $0x8012a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80066f:	8b 04 85 c8 12 80 00 	mov    0x8012c8(,%eax,4),%eax
  ...
  800771:	c7 44 24 08 be 12 80 	movl   $0x8012be,0x8(%esp)
  800778:	00 
  ...
  80079d:	75 05                	jne    8007a4 <vprintfmt+0x1a3>
                p = "(null)";
  80079f:	be c1 12 80 00       	mov    $0x8012c1,%esi
            }
            if (width > 0 && padc != '-') {
...
sleepy(int pid) {
  ...
  80103d:	83 ec 28             	sub    $0x28,%esp
    int i, time = 100;
  801040:	c7 45 f0 64 00 00 00 	movl   $0x64,-0x10(%ebp)
    for (i = 0; i < 10; i ++) {
  801047:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80104e:	eb 2b                	jmp    80107b <sleepy+0x41>
        sleep(time);
  801050:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801053:	89 04 24             	mov    %eax,(%esp)
  801056:	e8 88 f3 ff ff       	call   8003e3 <sleep>
        cprintf("sleep %d x %d slices.\n", i + 1, time);
  80105b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80105e:	8d 50 01             	lea    0x1(%eax),%edx
  801061:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801064:	89 44 24 08          	mov    %eax,0x8(%esp)
  801068:	89 54 24 04          	mov    %edx,0x4(%esp)
  80106c:	c7 04 24 20 14 80 00 	movl   $0x801420,(%esp)
  801073:	e8 a8 f0 ff ff       	call   800120 <cprintf>
    for (i = 0; i < 10; i ++) {
  801078:	ff 45 f4             	incl   -0xc(%ebp)
  80107b:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  80107f:	7e cf                	jle    801050 <sleepy+0x16>
    }
    exit(0);
  801081:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801088:	e8 85 f2 ff ff       	call   800312 <exit>
...
main(void) {
  ...
  801090:	83 e4 f0             	and    $0xfffffff0,%esp
  801093:	83 ec 20             	sub    $0x20,%esp
    unsigned int time = gettime_msec();
  801096:	e8 23 f3 ff ff       	call   8003be <gettime_msec>
  80109b:	89 44 24 1c          	mov    %eax,0x1c(%esp)
    int pid1, exit_code;

    if ((pid1 = fork()) == 0) {
  80109f:	e8 8d f2 ff ff       	call   800331 <fork>
  8010a4:	89 44 24 18          	mov    %eax,0x18(%esp)
  8010a8:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8010ad:	75 0c                	jne    8010bb <main+0x2e>
        sleepy(pid1);
  8010af:	8b 44 24 18          	mov    0x18(%esp),%eax
  8010b3:	89 04 24             	mov    %eax,(%esp)
  8010b6:	e8 7f ff ff ff       	call   80103a <sleepy>
    }
    
    assert(waitpid(pid1, &exit_code) == 0 && exit_code == 0);
  8010bb:	8d 44 24 14          	lea    0x14(%esp),%eax
  8010bf:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010c3:	8b 44 24 18          	mov    0x18(%esp),%eax
  8010c7:	89 04 24             	mov    %eax,(%esp)
  8010ca:	e8 8f f2 ff ff       	call   80035e <waitpid>
  8010cf:	85 c0                	test   %eax,%eax
  8010d1:	75 08                	jne    8010db <main+0x4e>
  8010d3:	8b 44 24 14          	mov    0x14(%esp),%eax
  8010d7:	85 c0                	test   %eax,%eax
  8010d9:	74 24                	je     8010ff <main+0x72>
  8010db:	c7 44 24 0c 38 14 80 	movl   $0x801438,0xc(%esp)
  8010e2:	00 
  8010e3:	c7 44 24 08 69 14 80 	movl   $0x801469,0x8(%esp)
  8010ea:	00 
  8010eb:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  8010f2:	00 
  8010f3:	c7 04 24 7e 14 80 00 	movl   $0x80147e,(%esp)
  8010fa:	e8 30 ef ff ff       	call   80002f <__panic>
    cprintf("use %04d msecs.\n", gettime_msec() - time);
  8010ff:	e8 ba f2 ff ff       	call   8003be <gettime_msec>
  801104:	2b 44 24 1c          	sub    0x1c(%esp),%eax
  801108:	89 44 24 04          	mov    %eax,0x4(%esp)
  80110c:	c7 04 24 8b 14 80 00 	movl   $0x80148b,(%esp)
  801113:	e8 08 f0 ff ff       	call   800120 <cprintf>
    cprintf("sleep pass.\n");
  801118:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
  80111f:	e8 fc ef ff ff       	call   800120 <cprintf>
    return 0;
