...
main(void) {
  ...
  801043:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  801048:	8b 00                	mov    (%eax),%eax
  80104a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80104e:	c7 04 24 60 13 80 00 	movl   $0x801360,(%esp)
  801055:	e8 c6 f0 ff ff       	call   800120 <cprintf>
    panic("FAIL: T.T\n");
  80105a:	c7 44 24 08 7e 13 80 	movl   $0x80137e,0x8(%esp)
  801061:	00 
  801062:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  801069:	00 
  80106a:	c7 04 24 89 13 80 00 	movl   $0x801389,(%esp)
