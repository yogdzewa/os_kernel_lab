...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800044:	68 80 10 80 00       	push   $0x801080
  ...
  800066:	68 9a 10 80 00       	push   $0x80109a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	68 9c 10 80 00       	push   $0x80109c
  ...
  8000b4:	68 9a 10 80 00       	push   $0x80109a
...
exit(int error_code) {
  ...
  800279:	68 b8 10 80 00       	push   $0x8010b8
...
umain(void) {
  ...
  800307:	83 ec 18             	sub    $0x18,%esp
    int ret = main();
  80030a:	e8 86 0c 00 00       	call   800f95 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800411:	05 e4 11 80 00       	add    $0x8011e4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800556:	8b 04 85 08 12 80 00 	mov    0x801208(,%eax,4),%eax
  ...
  800628:	8b 34 9d 80 11 80 00 	mov    0x801180(,%ebx,4),%esi
  80062f:	85 f6                	test   %esi,%esi
  800631:	75 19                	jne    80064c <vprintfmt+0x164>
                printfmt(putch, putdat, "error %d", err);
  800633:	53                   	push   %ebx
  800634:	68 f5 11 80 00       	push   $0x8011f5
  ...
  800647:	e9 37 02 00 00       	jmp    800883 <vprintfmt+0x39b>
                printfmt(putch, putdat, "%s", p);
  80064c:	56                   	push   %esi
  80064d:	68 fe 11 80 00       	push   $0x8011fe
  ...
  800672:	75 05                	jne    800679 <vprintfmt+0x191>
                p = "(null)";
  800674:	be 01 12 80 00       	mov    $0x801201,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  800edb:	83 ec 08             	sub    $0x8,%esp
    yield();
  800ede:	e8 e2 f3 ff ff       	call   8002c5 <yield>
    yield();
  800ee3:	e8 dd f3 ff ff       	call   8002c5 <yield>
    yield();
  800ee8:	e8 d8 f3 ff ff       	call   8002c5 <yield>
    yield();
  800eed:	e8 d3 f3 ff ff       	call   8002c5 <yield>
    yield();
  800ef2:	e8 ce f3 ff ff       	call   8002c5 <yield>
    yield();
  800ef7:	e8 c9 f3 ff ff       	call   8002c5 <yield>
}
  800efc:	90                   	nop
  800efd:	c9                   	leave  
  800efe:	c3                   	ret    
...
loop(void) {
  ...
  800f08:	68 60 13 80 00       	push   $0x801360
  800f0d:	e8 ff f1 ff ff       	call   800111 <cprintf>
  800f12:	83 c4 10             	add    $0x10,%esp
    while (1);
  800f15:	eb fe                	jmp    800f15 <loop+0x16>
...
work(void) {
  ...
  800f20:	68 6a 13 80 00       	push   $0x80136a
  800f25:	e8 e7 f1 ff ff       	call   800111 <cprintf>
  800f2a:	83 c4 10             	add    $0x10,%esp
    do_yield();
  800f2d:	e8 a6 ff ff ff       	call   800ed8 <do_yield>
    if (kill(parent) == 0) {
  800f32:	a1 08 20 80 00       	mov    0x802008,%eax
  800f37:	83 ec 0c             	sub    $0xc,%esp
  800f3a:	50                   	push   %eax
  800f3b:	e8 93 f3 ff ff       	call   8002d3 <kill>
  800f40:	83 c4 10             	add    $0x10,%esp
  800f43:	85 c0                	test   %eax,%eax
  800f45:	75 44                	jne    800f8b <work+0x74>
        cprintf("kill parent ok.\n");
  800f47:	83 ec 0c             	sub    $0xc,%esp
  800f4a:	68 74 13 80 00       	push   $0x801374
  800f4f:	e8 bd f1 ff ff       	call   800111 <cprintf>
  800f54:	83 c4 10             	add    $0x10,%esp
        do_yield();
  800f57:	e8 7c ff ff ff       	call   800ed8 <do_yield>
        if (kill(pid1) == 0) {
  800f5c:	a1 0c 20 80 00       	mov    0x80200c,%eax
  800f61:	83 ec 0c             	sub    $0xc,%esp
  800f64:	50                   	push   %eax
  800f65:	e8 69 f3 ff ff       	call   8002d3 <kill>
  800f6a:	83 c4 10             	add    $0x10,%esp
  800f6d:	85 c0                	test   %eax,%eax
  800f6f:	75 1a                	jne    800f8b <work+0x74>
            cprintf("kill child1 ok.\n");
  800f71:	83 ec 0c             	sub    $0xc,%esp
  800f74:	68 85 13 80 00       	push   $0x801385
  800f79:	e8 93 f1 ff ff       	call   800111 <cprintf>
  800f7e:	83 c4 10             	add    $0x10,%esp
            exit(0);
  800f81:	83 ec 0c             	sub    $0xc,%esp
  800f84:	6a 00                	push   $0x0
  800f86:	e8 d7 f2 ff ff       	call   800262 <exit>
        }
    }
    exit(-1);
  800f8b:	83 ec 0c             	sub    $0xc,%esp
  800f8e:	6a ff                	push   $0xffffffff
  800f90:	e8 cd f2 ff ff       	call   800262 <exit>
...
int
main(void) {
  800f95:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  800f99:	83 e4 f0             	and    $0xfffffff0,%esp
  800f9c:	ff 71 fc             	pushl  -0x4(%ecx)
  800f9f:	55                   	push   %ebp
  800fa0:	89 e5                	mov    %esp,%ebp
  800fa2:	51                   	push   %ecx
  800fa3:	83 ec 04             	sub    $0x4,%esp
    parent = getpid();
  800fa6:	e8 3e f3 ff ff       	call   8002e9 <getpid>
  800fab:	a3 08 20 80 00       	mov    %eax,0x802008
    if ((pid1 = fork()) == 0) {
  800fb0:	e8 d3 f2 ff ff       	call   800288 <fork>
  800fb5:	a3 0c 20 80 00       	mov    %eax,0x80200c
  800fba:	a1 0c 20 80 00       	mov    0x80200c,%eax
  800fbf:	85 c0                	test   %eax,%eax
  800fc1:	75 05                	jne    800fc8 <main+0x33>
        loop();
  800fc3:	e8 37 ff ff ff       	call   800eff <loop>
    }

    assert(pid1 > 0);
  800fc8:	a1 0c 20 80 00       	mov    0x80200c,%eax
  800fcd:	85 c0                	test   %eax,%eax
  800fcf:	7f 16                	jg     800fe7 <main+0x52>
  800fd1:	68 96 13 80 00       	push   $0x801396
  800fd6:	68 9f 13 80 00       	push   $0x80139f
  800fdb:	6a 2c                	push   $0x2c
  800fdd:	68 b4 13 80 00       	push   $0x8013b4
  800fe2:	e8 48 f0 ff ff       	call   80002f <__panic>

    if ((pid2 = fork()) == 0) {
  800fe7:	e8 9c f2 ff ff       	call   800288 <fork>
  800fec:	a3 10 20 80 00       	mov    %eax,0x802010
  800ff1:	a1 10 20 80 00       	mov    0x802010,%eax
  800ff6:	85 c0                	test   %eax,%eax
  800ff8:	75 05                	jne    800fff <main+0x6a>
        work();
  800ffa:	e8 18 ff ff ff       	call   800f17 <work>
    }
    if (pid2 > 0) {
  800fff:	a1 10 20 80 00       	mov    0x802010,%eax
  801004:	85 c0                	test   %eax,%eax
  801006:	7e 3a                	jle    801042 <main+0xad>
        cprintf("wait child 1.\n");
  801008:	83 ec 0c             	sub    $0xc,%esp
  80100b:	68 c4 13 80 00       	push   $0x8013c4
  801010:	e8 fc f0 ff ff       	call   800111 <cprintf>
  801015:	83 c4 10             	add    $0x10,%esp
        waitpid(pid1, NULL);
  801018:	a1 0c 20 80 00       	mov    0x80200c,%eax
  80101d:	83 ec 08             	sub    $0x8,%esp
  801020:	6a 00                	push   $0x0
  801022:	50                   	push   %eax
  801023:	e8 84 f2 ff ff       	call   8002ac <waitpid>
  801028:	83 c4 10             	add    $0x10,%esp
        panic("waitpid %d returns\n", pid1);
  80102b:	a1 0c 20 80 00       	mov    0x80200c,%eax
  801030:	50                   	push   %eax
  801031:	68 d3 13 80 00       	push   $0x8013d3
  801036:	6a 34                	push   $0x34
  801038:	68 b4 13 80 00       	push   $0x8013b4
  80103d:	e8 ed ef ff ff       	call   80002f <__panic>
    }
    else {
        kill(pid1);
  801042:	a1 0c 20 80 00       	mov    0x80200c,%eax
  801047:	83 ec 0c             	sub    $0xc,%esp
  80104a:	50                   	push   %eax
  80104b:	e8 83 f2 ff ff       	call   8002d3 <kill>
  801050:	83 c4 10             	add    $0x10,%esp
    }
    panic("FAIL: T.T\n");
  801053:	83 ec 04             	sub    $0x4,%esp
  801056:	68 e7 13 80 00       	push   $0x8013e7
  80105b:	6a 39                	push   $0x39
  80105d:	68 b4 13 80 00       	push   $0x8013b4
  801062:	e8 c8 ef ff ff       	call   80002f <__panic>
