...
main(void) {
  ...
  800ee6:	83 ec 04             	sub    $0x4,%esp
    cprintf("value is %d.\n", 1 / zero);
  800ee9:	8b 0d 08 20 80 00    	mov    0x802008,%ecx
  800eef:	b8 01 00 00 00       	mov    $0x1,%eax
  800ef4:	99                   	cltd   
  800ef5:	f7 f9                	idiv   %ecx
  800ef7:	83 ec 08             	sub    $0x8,%esp
  800efa:	50                   	push   %eax
  800efb:	68 00 12 80 00       	push   $0x801200
  800f00:	e8 0c f2 ff ff       	call   800111 <cprintf>
  800f05:	83 c4 10             	add    $0x10,%esp
    panic("FAIL: T.T\n");
  800f08:	83 ec 04             	sub    $0x4,%esp
  800f0b:	68 0e 12 80 00       	push   $0x80120e
  800f10:	6a 09                	push   $0x9
  800f12:	68 19 12 80 00       	push   $0x801219
  800f17:	e8 13 f1 ff ff       	call   80002f <__panic>
