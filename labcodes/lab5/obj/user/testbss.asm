...
exit(int error_code) {
  ...
  8002d2:	c7 04 24 18 11 80 00 	movl   $0x801118,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800490:	05 44 12 80 00       	add    $0x801244,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8005e4:	8b 04 85 68 12 80 00 	mov    0x801268(,%eax,4),%eax
  ...
  8006e6:	c7 44 24 08 5e 12 80 	movl   $0x80125e,0x8(%esp)
  8006ed:	00 
  ...
  800712:	75 05                	jne    800719 <vprintfmt+0x1a3>
                p = "(null)";
  800714:	be 61 12 80 00       	mov    $0x801261,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fb8:	c7 04 24 c0 13 80 00 	movl   $0x8013c0,(%esp)
  800fbf:	e8 5c f1 ff ff       	call   800120 <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  800fc4:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  800fcb:	00 
  800fcc:	eb 37                	jmp    801005 <main+0x56>
        if (bigarray[i] != 0) {
  800fce:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  800fd2:	8b 04 85 20 20 80 00 	mov    0x802020(,%eax,4),%eax
  800fd9:	85 c0                	test   %eax,%eax
  800fdb:	74 24                	je     801001 <main+0x52>
            panic("bigarray[%d] isn't cleared!\n", i);
  800fdd:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  800fe1:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800fe5:	c7 44 24 08 e0 13 80 	movl   $0x8013e0,0x8(%esp)
  800fec:	00 
  800fed:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  800ff4:	00 
  800ff5:	c7 04 24 fd 13 80 00 	movl   $0x8013fd,(%esp)
  800ffc:	e8 2e f0 ff ff       	call   80002f <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  801001:	ff 44 24 1c          	incl   0x1c(%esp)
  801005:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  80100c:	00 
  80100d:	7e bf                	jle    800fce <main+0x1f>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80100f:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801016:	00 
  801017:	eb 13                	jmp    80102c <main+0x7d>
        bigarray[i] = i;
  801019:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  80101d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801021:	89 14 85 20 20 80 00 	mov    %edx,0x802020(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
  801028:	ff 44 24 1c          	incl   0x1c(%esp)
  80102c:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801033:	00 
  801034:	7e e3                	jle    801019 <main+0x6a>
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  801036:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80103d:	00 
  80103e:	eb 3b                	jmp    80107b <main+0xcc>
        if (bigarray[i] != i) {
  801040:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801044:	8b 14 85 20 20 80 00 	mov    0x802020(,%eax,4),%edx
  80104b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80104f:	39 c2                	cmp    %eax,%edx
  801051:	74 24                	je     801077 <main+0xc8>
            panic("bigarray[%d] didn't hold its value!\n", i);
  801053:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801057:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80105b:	c7 44 24 08 0c 14 80 	movl   $0x80140c,0x8(%esp)
  801062:	00 
  801063:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  80106a:	00 
  80106b:	c7 04 24 fd 13 80 00 	movl   $0x8013fd,(%esp)
  801072:	e8 b8 ef ff ff       	call   80002f <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  801077:	ff 44 24 1c          	incl   0x1c(%esp)
  80107b:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801082:	00 
  801083:	7e bb                	jle    801040 <main+0x91>
        }
    }

    cprintf("Yes, good.  Now doing a wild write off the end...\n");
  801085:	c7 04 24 34 14 80 00 	movl   $0x801434,(%esp)
  80108c:	e8 8f f0 ff ff       	call   800120 <cprintf>
    cprintf("testbss may pass.\n");
  801091:	c7 04 24 67 14 80 00 	movl   $0x801467,(%esp)
  801098:	e8 83 f0 ff ff       	call   800120 <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
  80109d:	c7 05 20 30 c0 00 00 	movl   $0x0,0xc03020
  8010a4:	00 00 00 
    asm volatile ("int $0x14");
  8010a7:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  8010a9:	c7 44 24 08 7a 14 80 	movl   $0x80147a,0x8(%esp)
  8010b0:	00 
  8010b1:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  8010b8:	00 
  8010b9:	c7 04 24 fd 13 80 00 	movl   $0x8013fd,(%esp)
  8010c0:	e8 6a ef ff ff       	call   80002f <__panic>
