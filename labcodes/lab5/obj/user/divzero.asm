...
main(void) {
  ...
  800fb5:	83 ec 10             	sub    $0x10,%esp
    cprintf("value is %d.\n", 1 / zero);
  800fb8:	8b 0d 08 20 80 00    	mov    0x802008,%ecx
  800fbe:	b8 01 00 00 00       	mov    $0x1,%eax
  800fc3:	99                   	cltd   
  800fc4:	f7 f9                	idiv   %ecx
  800fc6:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fca:	c7 04 24 e0 12 80 00 	movl   $0x8012e0,(%esp)
  800fd1:	e8 4a f1 ff ff       	call   800120 <cprintf>
    panic("FAIL: T.T\n");
  800fd6:	c7 44 24 08 ee 12 80 	movl   $0x8012ee,0x8(%esp)
  800fdd:	00 
  800fde:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  800fe5:	00 
  800fe6:	c7 04 24 f9 12 80 00 	movl   $0x8012f9,(%esp)
  800fed:	e8 3d f0 ff ff       	call   80002f <__panic>
