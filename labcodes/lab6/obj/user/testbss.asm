...
main(void) {
  ...
  80101d:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801024:	00 
  801025:	eb 37                	jmp    80105e <main+0x56>
        if (bigarray[i] != 0) {
  801027:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80102b:	8b 04 85 20 20 80 00 	mov    0x802020(,%eax,4),%eax
  801032:	85 c0                	test   %eax,%eax
  801034:	74 24                	je     80105a <main+0x52>
            panic("bigarray[%d] isn't cleared!\n", i);
  801036:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80103a:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80103e:	c7 44 24 08 20 14 80 	movl   $0x801420,0x8(%esp)
  801045:	00 
  801046:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  80104d:	00 
  80104e:	c7 04 24 3d 14 80 00 	movl   $0x80143d,(%esp)
  801055:	e8 d5 ef ff ff       	call   80002f <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  80105a:	ff 44 24 1c          	incl   0x1c(%esp)
  80105e:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801065:	00 
  801066:	7e bf                	jle    801027 <main+0x1f>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  801068:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80106f:	00 
  801070:	eb 13                	jmp    801085 <main+0x7d>
        bigarray[i] = i;
  801072:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801076:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80107a:	89 14 85 20 20 80 00 	mov    %edx,0x802020(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
  801081:	ff 44 24 1c          	incl   0x1c(%esp)
  801085:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  80108c:	00 
  80108d:	7e e3                	jle    801072 <main+0x6a>
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80108f:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801096:	00 
  801097:	eb 3b                	jmp    8010d4 <main+0xcc>
        if (bigarray[i] != i) {
  801099:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80109d:	8b 14 85 20 20 80 00 	mov    0x802020(,%eax,4),%edx
  8010a4:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010a8:	39 c2                	cmp    %eax,%edx
  8010aa:	74 24                	je     8010d0 <main+0xc8>
            panic("bigarray[%d] didn't hold its value!\n", i);
  8010ac:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010b0:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010b4:	c7 44 24 08 4c 14 80 	movl   $0x80144c,0x8(%esp)
  8010bb:	00 
  8010bc:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  8010c3:	00 
  8010c4:	c7 04 24 3d 14 80 00 	movl   $0x80143d,(%esp)
  8010cb:	e8 5f ef ff ff       	call   80002f <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  8010d0:	ff 44 24 1c          	incl   0x1c(%esp)
  8010d4:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  8010db:	00 
  8010dc:	7e bb                	jle    801099 <main+0x91>
        }
    }

    cprintf("Yes, good.  Now doing a wild write off the end...\n");
  8010de:	c7 04 24 74 14 80 00 	movl   $0x801474,(%esp)
  8010e5:	e8 36 f0 ff ff       	call   800120 <cprintf>
    cprintf("testbss may pass.\n");
  8010ea:	c7 04 24 a7 14 80 00 	movl   $0x8014a7,(%esp)
  8010f1:	e8 2a f0 ff ff       	call   800120 <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
  8010f6:	c7 05 20 30 c0 00 00 	movl   $0x0,0xc03020
  8010fd:	00 00 00 
    asm volatile ("int $0x14");
  801100:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  801102:	c7 44 24 08 ba 14 80 	movl   $0x8014ba,0x8(%esp)
  801109:	00 
  80110a:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  801111:	00 
  801112:	c7 04 24 3d 14 80 00 	movl   $0x80143d,(%esp)
  801119:	e8 11 ef ff ff       	call   80002f <__panic>
