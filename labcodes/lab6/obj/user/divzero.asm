...
main(void) {
  ...
  80100e:	83 ec 10             	sub    $0x10,%esp
    cprintf("value is %d.\n", 1 / zero);
  801011:	8b 0d 08 20 80 00    	mov    0x802008,%ecx
  801017:	b8 01 00 00 00       	mov    $0x1,%eax
  80101c:	99                   	cltd   
  80101d:	f7 f9                	idiv   %ecx
  80101f:	89 44 24 04          	mov    %eax,0x4(%esp)
  801023:	c7 04 24 40 13 80 00 	movl   $0x801340,(%esp)
  80102a:	e8 f1 f0 ff ff       	call   800120 <cprintf>
    panic("FAIL: T.T\n");
  80102f:	c7 44 24 08 4e 13 80 	movl   $0x80134e,0x8(%esp)
  801036:	00 
  801037:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  80103e:	00 
  80103f:	c7 04 24 59 13 80 00 	movl   $0x801359,(%esp)
  801046:	e8 e4 ef ff ff       	call   80002f <__panic>
