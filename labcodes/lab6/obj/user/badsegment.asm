...
main(void) {
  ...
  801011:	66 b8 28 00          	mov    $0x28,%ax
  801015:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  801017:	c7 44 24 08 20 13 80 	movl   $0x801320,0x8(%esp)
  80101e:	00 
  80101f:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  801026:	00 
  801027:	c7 04 24 2b 13 80 00 	movl   $0x80132b,(%esp)
  80102e:	e8 fc ef ff ff       	call   80002f <__panic>
