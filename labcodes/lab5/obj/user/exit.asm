...
exit(int error_code) {
  ...
  8002d2:	c7 04 24 58 11 80 00 	movl   $0x801158,(%esp)
...
umain(void) {
  ...
  800370:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  800373:	e8 37 0c 00 00       	call   800faf <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800490:	05 84 12 80 00       	add    $0x801284,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8005e4:	8b 04 85 a8 12 80 00 	mov    0x8012a8(,%eax,4),%eax
  ...
  8006e6:	c7 44 24 08 9e 12 80 	movl   $0x80129e,0x8(%esp)
  8006ed:	00 
  ...
  800712:	75 05                	jne    800719 <vprintfmt+0x1a3>
                p = "(null)";
  800714:	be a1 12 80 00       	mov    $0x8012a1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fb2:	83 e4 f0             	and    $0xfffffff0,%esp
  800fb5:	83 ec 20             	sub    $0x20,%esp
    int pid, code;
    cprintf("I am the parent. Forking the child...\n");
  800fb8:	c7 04 24 00 14 80 00 	movl   $0x801400,(%esp)
  800fbf:	e8 5c f1 ff ff       	call   800120 <cprintf>
    if ((pid = fork()) == 0) {
  800fc4:	e8 17 f3 ff ff       	call   8002e0 <fork>
  800fc9:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  800fcd:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  800fd2:	75 3c                	jne    801010 <main+0x61>
        cprintf("I am the child.\n");
  800fd4:	c7 04 24 27 14 80 00 	movl   $0x801427,(%esp)
  800fdb:	e8 40 f1 ff ff       	call   800120 <cprintf>
        yield();
  800fe0:	e8 44 f3 ff ff       	call   800329 <yield>
        yield();
  800fe5:	e8 3f f3 ff ff       	call   800329 <yield>
        yield();
  800fea:	e8 3a f3 ff ff       	call   800329 <yield>
        yield();
  800fef:	e8 35 f3 ff ff       	call   800329 <yield>
        yield();
  800ff4:	e8 30 f3 ff ff       	call   800329 <yield>
        yield();
  800ff9:	e8 2b f3 ff ff       	call   800329 <yield>
        yield();
  800ffe:	e8 26 f3 ff ff       	call   800329 <yield>
        exit(magic);
  801003:	a1 08 20 80 00       	mov    0x802008,%eax
  801008:	89 04 24             	mov    %eax,(%esp)
  80100b:	e8 b1 f2 ff ff       	call   8002c1 <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  801010:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801014:	89 44 24 04          	mov    %eax,0x4(%esp)
  801018:	c7 04 24 38 14 80 00 	movl   $0x801438,(%esp)
  80101f:	e8 fc f0 ff ff       	call   800120 <cprintf>
    }
    assert(pid > 0);
  801024:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801029:	7f 24                	jg     80104f <main+0xa0>
  80102b:	c7 44 24 0c 5a 14 80 	movl   $0x80145a,0xc(%esp)
  801032:	00 
  801033:	c7 44 24 08 62 14 80 	movl   $0x801462,0x8(%esp)
  80103a:	00 
  80103b:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  801042:	00 
  801043:	c7 04 24 77 14 80 00 	movl   $0x801477,(%esp)
  80104a:	e8 e0 ef ff ff       	call   80002f <__panic>
    cprintf("I am the parent, waiting now..\n");
  80104f:	c7 04 24 84 14 80 00 	movl   $0x801484,(%esp)
  801056:	e8 c5 f0 ff ff       	call   800120 <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  80105b:	8d 44 24 18          	lea    0x18(%esp),%eax
  80105f:	89 44 24 04          	mov    %eax,0x4(%esp)
  801063:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801067:	89 04 24             	mov    %eax,(%esp)
  80106a:	e8 9e f2 ff ff       	call   80030d <waitpid>
  80106f:	85 c0                	test   %eax,%eax
  801071:	75 0d                	jne    801080 <main+0xd1>
  801073:	8b 54 24 18          	mov    0x18(%esp),%edx
  801077:	a1 08 20 80 00       	mov    0x802008,%eax
  80107c:	39 c2                	cmp    %eax,%edx
  80107e:	74 24                	je     8010a4 <main+0xf5>
  801080:	c7 44 24 0c a4 14 80 	movl   $0x8014a4,0xc(%esp)
  801087:	00 
  801088:	c7 44 24 08 62 14 80 	movl   $0x801462,0x8(%esp)
  80108f:	00 
  801090:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  801097:	00 
  801098:	c7 04 24 77 14 80 00 	movl   $0x801477,(%esp)
  80109f:	e8 8b ef ff ff       	call   80002f <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  8010a4:	8d 44 24 18          	lea    0x18(%esp),%eax
  8010a8:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010ac:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010b0:	89 04 24             	mov    %eax,(%esp)
  8010b3:	e8 55 f2 ff ff       	call   80030d <waitpid>
  8010b8:	85 c0                	test   %eax,%eax
  8010ba:	74 09                	je     8010c5 <main+0x116>
  8010bc:	e8 2e f2 ff ff       	call   8002ef <wait>
  8010c1:	85 c0                	test   %eax,%eax
  8010c3:	75 24                	jne    8010e9 <main+0x13a>
  8010c5:	c7 44 24 0c d0 14 80 	movl   $0x8014d0,0xc(%esp)
  8010cc:	00 
  8010cd:	c7 44 24 08 62 14 80 	movl   $0x801462,0x8(%esp)
  8010d4:	00 
  8010d5:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8010dc:	00 
  8010dd:	c7 04 24 77 14 80 00 	movl   $0x801477,(%esp)
  8010e4:	e8 46 ef ff ff       	call   80002f <__panic>
    cprintf("waitpid %d ok.\n", pid);
  8010e9:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010ed:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010f1:	c7 04 24 f8 14 80 00 	movl   $0x8014f8,(%esp)
  8010f8:	e8 23 f0 ff ff       	call   800120 <cprintf>

    cprintf("exit pass.\n");
  8010fd:	c7 04 24 08 15 80 00 	movl   $0x801508,(%esp)
  801104:	e8 17 f0 ff ff       	call   800120 <cprintf>
    return 0;
