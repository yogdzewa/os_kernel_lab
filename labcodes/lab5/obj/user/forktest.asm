...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800044:	68 e0 0f 80 00       	push   $0x800fe0
  ...
  800066:	68 fa 0f 80 00       	push   $0x800ffa
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	68 fc 0f 80 00       	push   $0x800ffc
  ...
  8000b4:	68 fa 0f 80 00       	push   $0x800ffa
...
exit(int error_code) {
  ...
  800279:	68 18 10 80 00       	push   $0x801018
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800411:	05 44 11 80 00       	add    $0x801144,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800556:	8b 04 85 68 11 80 00 	mov    0x801168(,%eax,4),%eax
  ...
  800628:	8b 34 9d e0 10 80 00 	mov    0x8010e0(,%ebx,4),%esi
  80062f:	85 f6                	test   %esi,%esi
  800631:	75 19                	jne    80064c <vprintfmt+0x164>
                printfmt(putch, putdat, "error %d", err);
  800633:	53                   	push   %ebx
  800634:	68 55 11 80 00       	push   $0x801155
  ...
  800647:	e9 37 02 00 00       	jmp    800883 <vprintfmt+0x39b>
                printfmt(putch, putdat, "%s", p);
  80064c:	56                   	push   %esi
  80064d:	68 5e 11 80 00       	push   $0x80115e
  ...
  800672:	75 05                	jne    800679 <vprintfmt+0x191>
                p = "(null)";
  800674:	be 61 11 80 00       	mov    $0x801161,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800ee9:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  800ef0:	eb 4b                	jmp    800f3d <main+0x65>
        if ((pid = fork()) == 0) {
  800ef2:	e8 91 f3 ff ff       	call   800288 <fork>
  800ef7:	89 45 f0             	mov    %eax,-0x10(%ebp)
  800efa:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  800efe:	75 1d                	jne    800f1d <main+0x45>
            cprintf("I am child %d\n", n);
  800f00:	83 ec 08             	sub    $0x8,%esp
  800f03:	ff 75 f4             	pushl  -0xc(%ebp)
  800f06:	68 c4 12 80 00       	push   $0x8012c4
  800f0b:	e8 01 f2 ff ff       	call   800111 <cprintf>
  800f10:	83 c4 10             	add    $0x10,%esp
            exit(0);
  800f13:	83 ec 0c             	sub    $0xc,%esp
  800f16:	6a 00                	push   $0x0
  800f18:	e8 45 f3 ff ff       	call   800262 <exit>
        }
        assert(pid > 0);
  800f1d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  800f21:	7f 16                	jg     800f39 <main+0x61>
  800f23:	68 d3 12 80 00       	push   $0x8012d3
  800f28:	68 db 12 80 00       	push   $0x8012db
  800f2d:	6a 0e                	push   $0xe
  800f2f:	68 f0 12 80 00       	push   $0x8012f0
  800f34:	e8 f6 f0 ff ff       	call   80002f <__panic>
    for (n = 0; n < max_child; n ++) {
  800f39:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  800f3d:	b8 20 00 00 00       	mov    $0x20,%eax
  800f42:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  800f45:	7c ab                	jl     800ef2 <main+0x1a>
    }

    if (n > max_child) {
  800f47:	b8 20 00 00 00       	mov    $0x20,%eax
  800f4c:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  800f4f:	7e 35                	jle    800f86 <main+0xae>
        panic("fork claimed to work %d times!\n", n);
  800f51:	ff 75 f4             	pushl  -0xc(%ebp)
  800f54:	68 00 13 80 00       	push   $0x801300
  800f59:	6a 12                	push   $0x12
  800f5b:	68 f0 12 80 00       	push   $0x8012f0
  800f60:	e8 ca f0 ff ff       	call   80002f <__panic>
    }

    for (; n > 0; n --) {
        if (wait() != 0) {
  800f65:	e8 2b f3 ff ff       	call   800295 <wait>
  800f6a:	85 c0                	test   %eax,%eax
  800f6c:	74 14                	je     800f82 <main+0xaa>
            panic("wait stopped early\n");
  800f6e:	83 ec 04             	sub    $0x4,%esp
  800f71:	68 20 13 80 00       	push   $0x801320
  800f76:	6a 17                	push   $0x17
  800f78:	68 f0 12 80 00       	push   $0x8012f0
  800f7d:	e8 ad f0 ff ff       	call   80002f <__panic>
    for (; n > 0; n --) {
  800f82:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
  800f86:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  800f8a:	7f d9                	jg     800f65 <main+0x8d>
        }
    }

    if (wait() == 0) {
  800f8c:	e8 04 f3 ff ff       	call   800295 <wait>
  800f91:	85 c0                	test   %eax,%eax
  800f93:	75 14                	jne    800fa9 <main+0xd1>
        panic("wait got too many\n");
  800f95:	83 ec 04             	sub    $0x4,%esp
  800f98:	68 34 13 80 00       	push   $0x801334
  800f9d:	6a 1c                	push   $0x1c
  800f9f:	68 f0 12 80 00       	push   $0x8012f0
  800fa4:	e8 86 f0 ff ff       	call   80002f <__panic>
    }

    cprintf("forktest pass.\n");
  800fa9:	83 ec 0c             	sub    $0xc,%esp
  800fac:	68 47 13 80 00       	push   $0x801347
  800fb1:	e8 5b f1 ff ff       	call   800111 <cprintf>
  800fb6:	83 c4 10             	add    $0x10,%esp
    return 0;
  800fb9:	b8 00 00 00 00       	mov    $0x0,%eax
}
  800fbe:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  800fc1:	c9                   	leave  
  800fc2:	8d 61 fc             	lea    -0x4(%ecx),%esp
  800fc5:	c3                   	ret    
