...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800044:	68 00 0f 80 00       	push   $0x800f00
  ...
  800066:	68 1a 0f 80 00       	push   $0x800f1a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	68 1c 0f 80 00       	push   $0x800f1c
  ...
  8000b4:	68 1a 0f 80 00       	push   $0x800f1a
...
exit(int error_code) {
  ...
  800279:	68 38 0f 80 00       	push   $0x800f38
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800411:	05 64 10 80 00       	add    $0x801064,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800556:	8b 04 85 88 10 80 00 	mov    0x801088(,%eax,4),%eax
  ...
  800628:	8b 34 9d 00 10 80 00 	mov    0x801000(,%ebx,4),%esi
  80062f:	85 f6                	test   %esi,%esi
  800631:	75 19                	jne    80064c <vprintfmt+0x164>
                printfmt(putch, putdat, "error %d", err);
  800633:	53                   	push   %ebx
  800634:	68 75 10 80 00       	push   $0x801075
  ...
  800647:	e9 37 02 00 00       	jmp    800883 <vprintfmt+0x39b>
                printfmt(putch, putdat, "%s", p);
  80064c:	56                   	push   %esi
  80064d:	68 7e 10 80 00       	push   $0x80107e
  ...
  800672:	75 05                	jne    800679 <vprintfmt+0x191>
                p = "(null)";
  800674:	be 81 10 80 00       	mov    $0x801081,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800ee6:	83 ec 04             	sub    $0x4,%esp
    asm volatile("int $14");
  800ee9:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  800eeb:	83 ec 04             	sub    $0x4,%esp
  800eee:	68 e0 11 80 00       	push   $0x8011e0
  800ef3:	6a 07                	push   $0x7
  800ef5:	68 eb 11 80 00       	push   $0x8011eb
  800efa:	e8 30 f1 ff ff       	call   80002f <__panic>
