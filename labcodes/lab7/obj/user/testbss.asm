...
exit(int error_code) {
  ...
  800323:	c7 04 24 98 11 80 00 	movl   $0x801198,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80051b:	05 c4 12 80 00       	add    $0x8012c4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80066f:	8b 04 85 e8 12 80 00 	mov    0x8012e8(,%eax,4),%eax
  ...
  800771:	c7 44 24 08 de 12 80 	movl   $0x8012de,0x8(%esp)
  800778:	00 
  ...
  80079d:	75 05                	jne    8007a4 <vprintfmt+0x1a3>
                p = "(null)";
  80079f:	be e1 12 80 00       	mov    $0x8012e1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801043:	c7 04 24 40 14 80 00 	movl   $0x801440,(%esp)
  80104a:	e8 d1 f0 ff ff       	call   800120 <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  80104f:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801056:	00 
  801057:	eb 37                	jmp    801090 <main+0x56>
        if (bigarray[i] != 0) {
  801059:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80105d:	8b 04 85 20 20 80 00 	mov    0x802020(,%eax,4),%eax
  801064:	85 c0                	test   %eax,%eax
  801066:	74 24                	je     80108c <main+0x52>
            panic("bigarray[%d] isn't cleared!\n", i);
  801068:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80106c:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801070:	c7 44 24 08 60 14 80 	movl   $0x801460,0x8(%esp)
  801077:	00 
  801078:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  80107f:	00 
  801080:	c7 04 24 7d 14 80 00 	movl   $0x80147d,(%esp)
  801087:	e8 a3 ef ff ff       	call   80002f <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  80108c:	ff 44 24 1c          	incl   0x1c(%esp)
  801090:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801097:	00 
  801098:	7e bf                	jle    801059 <main+0x1f>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80109a:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8010a1:	00 
  8010a2:	eb 13                	jmp    8010b7 <main+0x7d>
        bigarray[i] = i;
  8010a4:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8010a8:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010ac:	89 14 85 20 20 80 00 	mov    %edx,0x802020(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
  8010b3:	ff 44 24 1c          	incl   0x1c(%esp)
  8010b7:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  8010be:	00 
  8010bf:	7e e3                	jle    8010a4 <main+0x6a>
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  8010c1:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8010c8:	00 
  8010c9:	eb 3b                	jmp    801106 <main+0xcc>
        if (bigarray[i] != i) {
  8010cb:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010cf:	8b 14 85 20 20 80 00 	mov    0x802020(,%eax,4),%edx
  8010d6:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010da:	39 c2                	cmp    %eax,%edx
  8010dc:	74 24                	je     801102 <main+0xc8>
            panic("bigarray[%d] didn't hold its value!\n", i);
  8010de:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010e2:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010e6:	c7 44 24 08 8c 14 80 	movl   $0x80148c,0x8(%esp)
  8010ed:	00 
  8010ee:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  8010f5:	00 
  8010f6:	c7 04 24 7d 14 80 00 	movl   $0x80147d,(%esp)
  8010fd:	e8 2d ef ff ff       	call   80002f <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  801102:	ff 44 24 1c          	incl   0x1c(%esp)
  801106:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  80110d:	00 
  80110e:	7e bb                	jle    8010cb <main+0x91>
        }
    }

    cprintf("Yes, good.  Now doing a wild write off the end...\n");
  801110:	c7 04 24 b4 14 80 00 	movl   $0x8014b4,(%esp)
  801117:	e8 04 f0 ff ff       	call   800120 <cprintf>
    cprintf("testbss may pass.\n");
  80111c:	c7 04 24 e7 14 80 00 	movl   $0x8014e7,(%esp)
  801123:	e8 f8 ef ff ff       	call   800120 <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
  801128:	c7 05 20 30 c0 00 00 	movl   $0x0,0xc03020
  80112f:	00 00 00 
    asm volatile ("int $0x14");
  801132:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  801134:	c7 44 24 08 fa 14 80 	movl   $0x8014fa,0x8(%esp)
  80113b:	00 
  80113c:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  801143:	00 
  801144:	c7 04 24 7d 14 80 00 	movl   $0x80147d,(%esp)
  80114b:	e8 df ee ff ff       	call   80002f <__panic>
