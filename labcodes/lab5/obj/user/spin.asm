...
main(void) {
  ...
  800eec:	68 e0 12 80 00       	push   $0x8012e0
  ...
  800f05:	75 12                	jne    800f19 <main+0x41>
        cprintf("I am the child. spinning ...\n");
  800f07:	83 ec 0c             	sub    $0xc,%esp
  800f0a:	68 07 13 80 00       	push   $0x801307
  800f0f:	e8 fd f1 ff ff       	call   800111 <cprintf>
  800f14:	83 c4 10             	add    $0x10,%esp
        while (1);
  800f17:	eb fe                	jmp    800f17 <main+0x3f>
    }
    cprintf("I am the parent. Running the child...\n");
  800f19:	83 ec 0c             	sub    $0xc,%esp
  800f1c:	68 28 13 80 00       	push   $0x801328
  800f21:	e8 eb f1 ff ff       	call   800111 <cprintf>
  800f26:	83 c4 10             	add    $0x10,%esp

    yield();
  800f29:	e8 97 f3 ff ff       	call   8002c5 <yield>
    yield();
  800f2e:	e8 92 f3 ff ff       	call   8002c5 <yield>
    yield();
  800f33:	e8 8d f3 ff ff       	call   8002c5 <yield>

    cprintf("I am the parent.  Killing the child...\n");
  800f38:	83 ec 0c             	sub    $0xc,%esp
  800f3b:	68 50 13 80 00       	push   $0x801350
  800f40:	e8 cc f1 ff ff       	call   800111 <cprintf>
  800f45:	83 c4 10             	add    $0x10,%esp

    assert((ret = kill(pid)) == 0);
  800f48:	83 ec 0c             	sub    $0xc,%esp
  800f4b:	ff 75 f4             	pushl  -0xc(%ebp)
  800f4e:	e8 80 f3 ff ff       	call   8002d3 <kill>
  800f53:	83 c4 10             	add    $0x10,%esp
  800f56:	89 45 f0             	mov    %eax,-0x10(%ebp)
  800f59:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  800f5d:	74 16                	je     800f75 <main+0x9d>
  800f5f:	68 78 13 80 00       	push   $0x801378
  800f64:	68 8f 13 80 00       	push   $0x80138f
  800f69:	6a 14                	push   $0x14
  800f6b:	68 a4 13 80 00       	push   $0x8013a4
  800f70:	e8 ba f0 ff ff       	call   80002f <__panic>
    cprintf("kill returns %d\n", ret);
  800f75:	83 ec 08             	sub    $0x8,%esp
  800f78:	ff 75 f0             	pushl  -0x10(%ebp)
  800f7b:	68 b0 13 80 00       	push   $0x8013b0
  800f80:	e8 8c f1 ff ff       	call   800111 <cprintf>
  ...
  800f90:	e8 17 f3 ff ff       	call   8002ac <waitpid>
  800f95:	83 c4 10             	add    $0x10,%esp
  800f98:	89 45 f0             	mov    %eax,-0x10(%ebp)
  800f9b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  800f9f:	74 16                	je     800fb7 <main+0xdf>
  800fa1:	68 c4 13 80 00       	push   $0x8013c4
  800fa6:	68 8f 13 80 00       	push   $0x80138f
  800fab:	6a 17                	push   $0x17
  800fad:	68 a4 13 80 00       	push   $0x8013a4
  800fb2:	e8 78 f0 ff ff       	call   80002f <__panic>
    cprintf("wait returns %d\n", ret);
  800fb7:	83 ec 08             	sub    $0x8,%esp
  800fba:	ff 75 f0             	pushl  -0x10(%ebp)
  800fbd:	68 e4 13 80 00       	push   $0x8013e4
  800fc2:	e8 4a f1 ff ff       	call   800111 <cprintf>
  800fc7:	83 c4 10             	add    $0x10,%esp

    cprintf("spin may pass.\n");
  800fca:	83 ec 0c             	sub    $0xc,%esp
  800fcd:	68 f5 13 80 00       	push   $0x8013f5
  800fd2:	e8 3a f1 ff ff       	call   800111 <cprintf>
  ...
  800fe2:	c9                   	leave  
  800fe3:	8d 61 fc             	lea    -0x4(%ecx),%esp
  800fe6:	c3                   	ret    
