...
main(void) {
  ...
  801040:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  801043:	e8 e9 f2 ff ff       	call   800331 <fork>
  801048:	89 44 24 18          	mov    %eax,0x18(%esp)
  80104c:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801051:	75 32                	jne    801085 <main+0x4b>
        cprintf("fork ok.\n");
  801053:	c7 04 24 80 14 80 00 	movl   $0x801480,(%esp)
  80105a:	e8 c1 f0 ff ff       	call   800120 <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  80105f:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801066:	00 
  801067:	eb 09                	jmp    801072 <main+0x38>
            yield();
  801069:	e8 0c f3 ff ff       	call   80037a <yield>
        for (i = 0; i < 10; i ++) {
  80106e:	ff 44 24 1c          	incl   0x1c(%esp)
  801072:	83 7c 24 1c 09       	cmpl   $0x9,0x1c(%esp)
  801077:	7e f0                	jle    801069 <main+0x2f>
        }
        exit(0xbeaf);
  801079:	c7 04 24 af be 00 00 	movl   $0xbeaf,(%esp)
  801080:	e8 8d f2 ff ff       	call   800312 <exit>
    }
    assert(pid > 0);
  801085:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80108a:	7f 24                	jg     8010b0 <main+0x76>
  80108c:	c7 44 24 0c 8a 14 80 	movl   $0x80148a,0xc(%esp)
  801093:	00 
  801094:	c7 44 24 08 92 14 80 	movl   $0x801492,0x8(%esp)
  80109b:	00 
  80109c:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  8010a3:	00 
  8010a4:	c7 04 24 a7 14 80 00 	movl   $0x8014a7,(%esp)
  8010ab:	e8 7f ef ff ff       	call   80002f <__panic>
    assert(waitpid(-1, NULL) != 0);
  8010b0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8010b7:	00 
  8010b8:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  8010bf:	e8 9a f2 ff ff       	call   80035e <waitpid>
  8010c4:	85 c0                	test   %eax,%eax
  8010c6:	75 24                	jne    8010ec <main+0xb2>
  8010c8:	c7 44 24 0c b5 14 80 	movl   $0x8014b5,0xc(%esp)
  8010cf:	00 
  8010d0:	c7 44 24 08 92 14 80 	movl   $0x801492,0x8(%esp)
  8010d7:	00 
  8010d8:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  8010df:	00 
  8010e0:	c7 04 24 a7 14 80 00 	movl   $0x8014a7,(%esp)
  8010e7:	e8 43 ef ff ff       	call   80002f <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  8010ec:	c7 44 24 04 00 00 00 	movl   $0xc0000000,0x4(%esp)
  8010f3:	c0 
  8010f4:	8b 44 24 18          	mov    0x18(%esp),%eax
  8010f8:	89 04 24             	mov    %eax,(%esp)
  8010fb:	e8 5e f2 ff ff       	call   80035e <waitpid>
  801100:	85 c0                	test   %eax,%eax
  801102:	75 24                	jne    801128 <main+0xee>
  801104:	c7 44 24 0c cc 14 80 	movl   $0x8014cc,0xc(%esp)
  80110b:	00 
  80110c:	c7 44 24 08 92 14 80 	movl   $0x801492,0x8(%esp)
  801113:	00 
  801114:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  80111b:	00 
  80111c:	c7 04 24 a7 14 80 00 	movl   $0x8014a7,(%esp)
  801123:	e8 07 ef ff ff       	call   80002f <__panic>
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  801128:	8d 44 24 14          	lea    0x14(%esp),%eax
  80112c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801130:	8b 44 24 18          	mov    0x18(%esp),%eax
  801134:	89 04 24             	mov    %eax,(%esp)
  801137:	e8 22 f2 ff ff       	call   80035e <waitpid>
  80113c:	85 c0                	test   %eax,%eax
  80113e:	75 0b                	jne    80114b <main+0x111>
  801140:	8b 44 24 14          	mov    0x14(%esp),%eax
  801144:	3d af be 00 00       	cmp    $0xbeaf,%eax
  801149:	74 24                	je     80116f <main+0x135>
  80114b:	c7 44 24 0c f4 14 80 	movl   $0x8014f4,0xc(%esp)
  801152:	00 
  801153:	c7 44 24 08 92 14 80 	movl   $0x801492,0x8(%esp)
  80115a:	00 
  80115b:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  801162:	00 
  801163:	c7 04 24 a7 14 80 00 	movl   $0x8014a7,(%esp)
  80116a:	e8 c0 ee ff ff       	call   80002f <__panic>
    cprintf("badarg pass.\n");
  80116f:	c7 04 24 29 15 80 00 	movl   $0x801529,(%esp)
  801176:	e8 a5 ef ff ff       	call   800120 <cprintf>
    return 0;
