...
exit(int error_code) {
  ...
  800306:	c7 04 24 d8 11 80 00 	movl   $0x8011d8,(%esp)
...
umain(void) {
  ...
  8003c9:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003cc:	e8 e2 0c 00 00       	call   8010b3 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004e9:	05 04 13 80 00       	add    $0x801304,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80063d:	8b 04 85 28 13 80 00 	mov    0x801328(,%eax,4),%eax
  ...
  80073f:	c7 44 24 08 1e 13 80 	movl   $0x80131e,0x8(%esp)
  800746:	00 
  ...
  80076b:	75 05                	jne    800772 <vprintfmt+0x1a3>
                p = "(null)";
  80076d:	be 21 13 80 00       	mov    $0x801321,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  80100b:	83 ec 08             	sub    $0x8,%esp
    yield();
  80100e:	e8 4a f3 ff ff       	call   80035d <yield>
    yield();
  801013:	e8 45 f3 ff ff       	call   80035d <yield>
    yield();
  801018:	e8 40 f3 ff ff       	call   80035d <yield>
    yield();
  80101d:	e8 3b f3 ff ff       	call   80035d <yield>
    yield();
  801022:	e8 36 f3 ff ff       	call   80035d <yield>
    yield();
  801027:	e8 31 f3 ff ff       	call   80035d <yield>
}
  80102c:	90                   	nop
...
loop(void) {
  ...
  801034:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  801037:	c7 04 24 80 14 80 00 	movl   $0x801480,(%esp)
  80103e:	e8 dd f0 ff ff       	call   800120 <cprintf>
    while (1);
  801043:	eb fe                	jmp    801043 <loop+0x12>
...
work(void) {
  ...
  801048:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  80104b:	c7 04 24 8a 14 80 00 	movl   $0x80148a,(%esp)
  801052:	e8 c9 f0 ff ff       	call   800120 <cprintf>
    do_yield();
  801057:	e8 ac ff ff ff       	call   801008 <do_yield>
    if (kill(parent) == 0) {
  80105c:	a1 08 20 80 00       	mov    0x802008,%eax
  801061:	89 04 24             	mov    %eax,(%esp)
  801064:	e8 04 f3 ff ff       	call   80036d <kill>
  801069:	85 c0                	test   %eax,%eax
  80106b:	75 3a                	jne    8010a7 <work+0x62>
        cprintf("kill parent ok.\n");
  80106d:	c7 04 24 94 14 80 00 	movl   $0x801494,(%esp)
  801074:	e8 a7 f0 ff ff       	call   800120 <cprintf>
        do_yield();
  801079:	e8 8a ff ff ff       	call   801008 <do_yield>
        if (kill(pid1) == 0) {
  80107e:	a1 0c 20 80 00       	mov    0x80200c,%eax
  801083:	89 04 24             	mov    %eax,(%esp)
  801086:	e8 e2 f2 ff ff       	call   80036d <kill>
  80108b:	85 c0                	test   %eax,%eax
  80108d:	75 18                	jne    8010a7 <work+0x62>
            cprintf("kill child1 ok.\n");
  80108f:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
  801096:	e8 85 f0 ff ff       	call   800120 <cprintf>
            exit(0);
  80109b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8010a2:	e8 4e f2 ff ff       	call   8002f5 <exit>
        }
    }
    exit(-1);
  8010a7:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  8010ae:	e8 42 f2 ff ff       	call   8002f5 <exit>
...
main(void) {
  ...
  8010b6:	83 e4 f0             	and    $0xfffffff0,%esp
  8010b9:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  8010bc:	e8 c1 f2 ff ff       	call   800382 <getpid>
  8010c1:	a3 08 20 80 00       	mov    %eax,0x802008
    if ((pid1 = fork()) == 0) {
  8010c6:	e8 49 f2 ff ff       	call   800314 <fork>
  8010cb:	a3 0c 20 80 00       	mov    %eax,0x80200c
  8010d0:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8010d5:	85 c0                	test   %eax,%eax
  8010d7:	75 05                	jne    8010de <main+0x2b>
        loop();
  8010d9:	e8 53 ff ff ff       	call   801031 <loop>
    }

    assert(pid1 > 0);
  8010de:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8010e3:	85 c0                	test   %eax,%eax
  8010e5:	7f 24                	jg     80110b <main+0x58>
  8010e7:	c7 44 24 0c b6 14 80 	movl   $0x8014b6,0xc(%esp)
  8010ee:	00 
  8010ef:	c7 44 24 08 bf 14 80 	movl   $0x8014bf,0x8(%esp)
  8010f6:	00 
  8010f7:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  8010fe:	00 
  8010ff:	c7 04 24 d4 14 80 00 	movl   $0x8014d4,(%esp)
  801106:	e8 24 ef ff ff       	call   80002f <__panic>

    if ((pid2 = fork()) == 0) {
  80110b:	e8 04 f2 ff ff       	call   800314 <fork>
  801110:	a3 10 20 80 00       	mov    %eax,0x802010
  801115:	a1 10 20 80 00       	mov    0x802010,%eax
  80111a:	85 c0                	test   %eax,%eax
  80111c:	75 05                	jne    801123 <main+0x70>
        work();
  80111e:	e8 22 ff ff ff       	call   801045 <work>
    }
    if (pid2 > 0) {
  801123:	a1 10 20 80 00       	mov    0x802010,%eax
  801128:	85 c0                	test   %eax,%eax
  80112a:	7e 46                	jle    801172 <main+0xbf>
        cprintf("wait child 1.\n");
  80112c:	c7 04 24 e4 14 80 00 	movl   $0x8014e4,(%esp)
  801133:	e8 e8 ef ff ff       	call   800120 <cprintf>
        waitpid(pid1, NULL);
  801138:	a1 0c 20 80 00       	mov    0x80200c,%eax
  80113d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801144:	00 
  801145:	89 04 24             	mov    %eax,(%esp)
  801148:	e8 f4 f1 ff ff       	call   800341 <waitpid>
        panic("waitpid %d returns\n", pid1);
  80114d:	a1 0c 20 80 00       	mov    0x80200c,%eax
  801152:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801156:	c7 44 24 08 f3 14 80 	movl   $0x8014f3,0x8(%esp)
  80115d:	00 
  80115e:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  801165:	00 
  801166:	c7 04 24 d4 14 80 00 	movl   $0x8014d4,(%esp)
  80116d:	e8 bd ee ff ff       	call   80002f <__panic>
    }
    else {
        kill(pid1);
  801172:	a1 0c 20 80 00       	mov    0x80200c,%eax
  801177:	89 04 24             	mov    %eax,(%esp)
  80117a:	e8 ee f1 ff ff       	call   80036d <kill>
    }
    panic("FAIL: T.T\n");
  80117f:	c7 44 24 08 07 15 80 	movl   $0x801507,0x8(%esp)
  801186:	00 
  801187:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  80118e:	00 
  80118f:	c7 04 24 d4 14 80 00 	movl   $0x8014d4,(%esp)
  801196:	e8 94 ee ff ff       	call   80002f <__panic>
