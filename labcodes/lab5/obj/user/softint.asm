...
main(void) {
  ...
  800fb5:	83 ec 10             	sub    $0x10,%esp
    asm volatile("int $14");
  800fb8:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  800fba:	c7 44 24 08 c0 12 80 	movl   $0x8012c0,0x8(%esp)
  800fc1:	00 
  800fc2:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  800fc9:	00 
  800fca:	c7 04 24 cb 12 80 00 	movl   $0x8012cb,(%esp)
  800fd1:	e8 59 f0 ff ff       	call   80002f <__panic>
