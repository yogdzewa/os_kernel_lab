...
exit(int error_code) {
  ...
  800306:	c7 04 24 b8 11 80 00 	movl   $0x8011b8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004e9:	05 e4 12 80 00       	add    $0x8012e4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80063d:	8b 04 85 08 13 80 00 	mov    0x801308(,%eax,4),%eax
  ...
  80073f:	c7 44 24 08 fe 12 80 	movl   $0x8012fe,0x8(%esp)
  800746:	00 
  ...
  80076b:	75 05                	jne    800772 <vprintfmt+0x1a3>
                p = "(null)";
  80076d:	be 01 13 80 00       	mov    $0x801301,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801011:	c7 04 24 60 14 80 00 	movl   $0x801460,(%esp)
  801018:	e8 03 f1 ff ff       	call   800120 <cprintf>
    if ((pid = fork()) == 0) {
  80101d:	e8 f2 f2 ff ff       	call   800314 <fork>
  801022:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  801026:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  80102b:	75 3c                	jne    801069 <main+0x61>
        cprintf("I am the child.\n");
  80102d:	c7 04 24 87 14 80 00 	movl   $0x801487,(%esp)
  801034:	e8 e7 f0 ff ff       	call   800120 <cprintf>
        yield();
  801039:	e8 1f f3 ff ff       	call   80035d <yield>
        yield();
  80103e:	e8 1a f3 ff ff       	call   80035d <yield>
        yield();
  801043:	e8 15 f3 ff ff       	call   80035d <yield>
        yield();
  801048:	e8 10 f3 ff ff       	call   80035d <yield>
        yield();
  80104d:	e8 0b f3 ff ff       	call   80035d <yield>
        yield();
  801052:	e8 06 f3 ff ff       	call   80035d <yield>
        yield();
  801057:	e8 01 f3 ff ff       	call   80035d <yield>
        exit(magic);
  80105c:	a1 08 20 80 00       	mov    0x802008,%eax
  801061:	89 04 24             	mov    %eax,(%esp)
  801064:	e8 8c f2 ff ff       	call   8002f5 <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  801069:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80106d:	89 44 24 04          	mov    %eax,0x4(%esp)
  801071:	c7 04 24 98 14 80 00 	movl   $0x801498,(%esp)
  801078:	e8 a3 f0 ff ff       	call   800120 <cprintf>
    }
    assert(pid > 0);
  80107d:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801082:	7f 24                	jg     8010a8 <main+0xa0>
  801084:	c7 44 24 0c ba 14 80 	movl   $0x8014ba,0xc(%esp)
  80108b:	00 
  80108c:	c7 44 24 08 c2 14 80 	movl   $0x8014c2,0x8(%esp)
  801093:	00 
  801094:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  80109b:	00 
  80109c:	c7 04 24 d7 14 80 00 	movl   $0x8014d7,(%esp)
  8010a3:	e8 87 ef ff ff       	call   80002f <__panic>
    cprintf("I am the parent, waiting now..\n");
  8010a8:	c7 04 24 e4 14 80 00 	movl   $0x8014e4,(%esp)
  8010af:	e8 6c f0 ff ff       	call   800120 <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  8010b4:	8d 44 24 18          	lea    0x18(%esp),%eax
  8010b8:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010bc:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010c0:	89 04 24             	mov    %eax,(%esp)
  8010c3:	e8 79 f2 ff ff       	call   800341 <waitpid>
  8010c8:	85 c0                	test   %eax,%eax
  8010ca:	75 0d                	jne    8010d9 <main+0xd1>
  8010cc:	8b 54 24 18          	mov    0x18(%esp),%edx
  8010d0:	a1 08 20 80 00       	mov    0x802008,%eax
  8010d5:	39 c2                	cmp    %eax,%edx
  8010d7:	74 24                	je     8010fd <main+0xf5>
  8010d9:	c7 44 24 0c 04 15 80 	movl   $0x801504,0xc(%esp)
  8010e0:	00 
  8010e1:	c7 44 24 08 c2 14 80 	movl   $0x8014c2,0x8(%esp)
  8010e8:	00 
  8010e9:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  8010f0:	00 
  8010f1:	c7 04 24 d7 14 80 00 	movl   $0x8014d7,(%esp)
  8010f8:	e8 32 ef ff ff       	call   80002f <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  8010fd:	8d 44 24 18          	lea    0x18(%esp),%eax
  801101:	89 44 24 04          	mov    %eax,0x4(%esp)
  801105:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801109:	89 04 24             	mov    %eax,(%esp)
  80110c:	e8 30 f2 ff ff       	call   800341 <waitpid>
  801111:	85 c0                	test   %eax,%eax
  801113:	74 09                	je     80111e <main+0x116>
  801115:	e8 09 f2 ff ff       	call   800323 <wait>
  80111a:	85 c0                	test   %eax,%eax
  80111c:	75 24                	jne    801142 <main+0x13a>
  80111e:	c7 44 24 0c 30 15 80 	movl   $0x801530,0xc(%esp)
  801125:	00 
  801126:	c7 44 24 08 c2 14 80 	movl   $0x8014c2,0x8(%esp)
  80112d:	00 
  80112e:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  801135:	00 
  801136:	c7 04 24 d7 14 80 00 	movl   $0x8014d7,(%esp)
  80113d:	e8 ed ee ff ff       	call   80002f <__panic>
    cprintf("waitpid %d ok.\n", pid);
  801142:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801146:	89 44 24 04          	mov    %eax,0x4(%esp)
  80114a:	c7 04 24 58 15 80 00 	movl   $0x801558,(%esp)
  801151:	e8 ca ef ff ff       	call   800120 <cprintf>

    cprintf("exit pass.\n");
  801156:	c7 04 24 68 15 80 00 	movl   $0x801568,(%esp)
  80115d:	e8 be ef ff ff       	call   800120 <cprintf>
    return 0;
