...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800049:	c7 04 24 40 13 80 00 	movl   $0x801340,(%esp)
  ...
  800062:	e8 84 00 00 00       	call   8000eb <vcprintf>
    cprintf("\n");
  800067:	c7 04 24 5a 13 80 00 	movl   $0x80135a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800099:	c7 04 24 5c 13 80 00 	movl   $0x80135c,(%esp)
  ...
  8000b2:	e8 34 00 00 00       	call   8000eb <vcprintf>
    cprintf("\n");
  8000b7:	c7 04 24 5a 13 80 00 	movl   $0x80135a,(%esp)
...
exit(int error_code) {
  ...
  800323:	c7 04 24 78 13 80 00 	movl   $0x801378,(%esp)
...
umain(void) {
  ...
  8003fb:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003fe:	e8 66 0c 00 00       	call   801069 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80051b:	05 a4 14 80 00       	add    $0x8014a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80066f:	8b 04 85 c8 14 80 00 	mov    0x8014c8(,%eax,4),%eax
  ...
  800771:	c7 44 24 08 be 14 80 	movl   $0x8014be,0x8(%esp)
  800778:	00 
  ...
  80079d:	75 05                	jne    8007a4 <vprintfmt+0x1a3>
                p = "(null)";
  80079f:	be c1 14 80 00       	mov    $0x8014c1,%esi
            }
            if (width > 0 && padc != '-') {
...
spin_delay(void)
{
  ...
  801047:	eb 11                	jmp    80105a <spin_delay+0x20>
     {
          j = !j;
  801049:	8b 45 f8             	mov    -0x8(%ebp),%eax
  80104c:	85 c0                	test   %eax,%eax
  80104e:	0f 94 c0             	sete   %al
  801051:	0f b6 c0             	movzbl %al,%eax
  801054:	89 45 f8             	mov    %eax,-0x8(%ebp)
     for (i = 0; i != 200; ++ i)
  801057:	ff 45 fc             	incl   -0x4(%ebp)
  80105a:	81 7d fc c8 00 00 00 	cmpl   $0xc8,-0x4(%ebp)
  801061:	75 e6                	jne    801049 <spin_delay+0xf>
     }
}
  801063:	90                   	nop
  801064:	90                   	nop
...
main(void) {
  ...
  801072:	83 ec 20             	sub    $0x20,%esp
  801075:	89 5d fc             	mov    %ebx,-0x4(%ebp)
     int i,time;
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
  801078:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  80107f:	00 
  801080:	c7 04 24 20 16 80 00 	movl   $0x801620,(%esp)
  801087:	e8 94 f0 ff ff       	call   800120 <cprintf>
     sleep(SLEEP_TIME);
  80108c:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  801093:	e8 4b f3 ff ff       	call   8003e3 <sleep>
     memset(pids, 0, sizeof(pids));
  801098:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
  80109f:	00 
  8010a0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8010a7:	00 
  8010a8:	c7 04 24 30 20 80 00 	movl   $0x802030,(%esp)
  8010af:	e8 fa fd ff ff       	call   800eae <memset>
     lab6_set_priority(TOTAL + 1);
  8010b4:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  8010bb:	e8 0d f3 ff ff       	call   8003cd <lab6_set_priority>

     for (i = 0; i < TOTAL; i ++) {
  8010c0:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8010c7:	00 
  8010c8:	e9 fc 00 00 00       	jmp    8011c9 <main+0x160>
          acc[i]=0;
  8010cd:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010d1:	c7 04 85 08 20 80 00 	movl   $0x0,0x802008(,%eax,4)
  8010d8:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  8010dc:	e8 50 f2 ff ff       	call   800331 <fork>
  8010e1:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8010e5:	89 04 95 30 20 80 00 	mov    %eax,0x802030(,%edx,4)
  8010ec:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010f0:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  8010f7:	85 c0                	test   %eax,%eax
  8010f9:	0f 85 b3 00 00 00    	jne    8011b2 <main+0x149>
               lab6_set_priority(i + 1);
  8010ff:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801103:	40                   	inc    %eax
  801104:	89 04 24             	mov    %eax,(%esp)
  801107:	e8 c1 f2 ff ff       	call   8003cd <lab6_set_priority>
               acc[i] = 0;
  80110c:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801110:	c7 04 85 08 20 80 00 	movl   $0x0,0x802008(,%eax,4)
  801117:	00 00 00 00 
               while (1) {
                    spin_delay();
  80111b:	e8 1a ff ff ff       	call   80103a <spin_delay>
                    ++ acc[i];
  801120:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801124:	8b 04 85 08 20 80 00 	mov    0x802008(,%eax,4),%eax
  80112b:	8d 50 01             	lea    0x1(%eax),%edx
  80112e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801132:	89 14 85 08 20 80 00 	mov    %edx,0x802008(,%eax,4)
                    if(acc[i]%4000==0) {
  801139:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80113d:	8b 0c 85 08 20 80 00 	mov    0x802008(,%eax,4),%ecx
  801144:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  801149:	89 c8                	mov    %ecx,%eax
  80114b:	f7 e2                	mul    %edx
  80114d:	89 d0                	mov    %edx,%eax
  80114f:	c1 e8 08             	shr    $0x8,%eax
  801152:	69 d0 a0 0f 00 00    	imul   $0xfa0,%eax,%edx
  801158:	89 c8                	mov    %ecx,%eax
  80115a:	29 d0                	sub    %edx,%eax
  80115c:	85 c0                	test   %eax,%eax
  80115e:	75 bb                	jne    80111b <main+0xb2>
                        if((time=gettime_msec())>MAX_TIME+SLEEP_TIME) {
  801160:	e8 59 f2 ff ff       	call   8003be <gettime_msec>
  801165:	89 44 24 18          	mov    %eax,0x18(%esp)
  801169:	81 7c 24 18 78 05 00 	cmpl   $0x578,0x18(%esp)
  801170:	00 
  801171:	7e a8                	jle    80111b <main+0xb2>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  801173:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801177:	8b 1c 85 08 20 80 00 	mov    0x802008(,%eax,4),%ebx
  80117e:	e8 1c f2 ff ff       	call   80039f <getpid>
  801183:	8b 54 24 18          	mov    0x18(%esp),%edx
  801187:	89 54 24 0c          	mov    %edx,0xc(%esp)
  80118b:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80118f:	89 44 24 04          	mov    %eax,0x4(%esp)
  801193:	c7 04 24 48 16 80 00 	movl   $0x801648,(%esp)
  80119a:	e8 81 ef ff ff       	call   800120 <cprintf>
                            exit(acc[i]);
  80119f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8011a3:	8b 04 85 08 20 80 00 	mov    0x802008(,%eax,4),%eax
  8011aa:	89 04 24             	mov    %eax,(%esp)
  8011ad:	e8 60 f1 ff ff       	call   800312 <exit>
                        }
                    }
               }
          ...
          if (pids[i] < 0) {
  8011b2:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8011b6:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  8011bd:	85 c0                	test   %eax,%eax
  8011bf:	0f 88 06 01 00 00    	js     8012cb <main+0x262>
     for (i = 0; i < TOTAL; i ++) {
  8011c5:	ff 44 24 1c          	incl   0x1c(%esp)
  8011c9:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  8011ce:	0f 8e f9 fe ff ff    	jle    8010cd <main+0x64>
               goto failed;
          }
     }

     cprintf("main: fork ok,now need to wait pids.\n");
  8011d4:	c7 04 24 68 16 80 00 	movl   $0x801668,(%esp)
  8011db:	e8 40 ef ff ff       	call   800120 <cprintf>

     for (i = 0; i < TOTAL; i ++) {
  8011e0:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8011e7:	00 
  8011e8:	eb 6a                	jmp    801254 <main+0x1eb>
         status[i]=0;
  8011ea:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8011ee:	c7 04 85 1c 20 80 00 	movl   $0x0,0x80201c(,%eax,4)
  8011f5:	00 00 00 00 
         waitpid(pids[i],&status[i]);
  8011f9:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8011fd:	c1 e0 02             	shl    $0x2,%eax
  801200:	8d 90 1c 20 80 00    	lea    0x80201c(%eax),%edx
  801206:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80120a:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  801211:	89 54 24 04          	mov    %edx,0x4(%esp)
  801215:	89 04 24             	mov    %eax,(%esp)
  801218:	e8 41 f1 ff ff       	call   80035e <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  80121d:	e8 9c f1 ff ff       	call   8003be <gettime_msec>
  801222:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801226:	8b 0c 95 1c 20 80 00 	mov    0x80201c(,%edx,4),%ecx
  80122d:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801231:	8b 14 95 30 20 80 00 	mov    0x802030(,%edx,4),%edx
  801238:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80123c:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  801240:	89 54 24 04          	mov    %edx,0x4(%esp)
  801244:	c7 04 24 90 16 80 00 	movl   $0x801690,(%esp)
  80124b:	e8 d0 ee ff ff       	call   800120 <cprintf>
     for (i = 0; i < TOTAL; i ++) {
  801250:	ff 44 24 1c          	incl   0x1c(%esp)
  801254:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801259:	7e 8f                	jle    8011ea <main+0x181>
     }
     cprintf("main: wait pids over\n");
  80125b:	c7 04 24 af 16 80 00 	movl   $0x8016af,(%esp)
  801262:	e8 b9 ee ff ff       	call   800120 <cprintf>
     cprintf("stride sched correct result:");
  801267:	c7 04 24 c5 16 80 00 	movl   $0x8016c5,(%esp)
  80126e:	e8 ad ee ff ff       	call   800120 <cprintf>
     for (i = 0; i < TOTAL; i ++)
  801273:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80127a:	00 
  80127b:	eb 34                	jmp    8012b1 <main+0x248>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
  80127d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801281:	8b 04 85 1c 20 80 00 	mov    0x80201c(,%eax,4),%eax
  801288:	01 c0                	add    %eax,%eax
  80128a:	8b 1d 1c 20 80 00    	mov    0x80201c,%ebx
  801290:	99                   	cltd   
  801291:	f7 fb                	idiv   %ebx
  801293:	40                   	inc    %eax
  801294:	89 c2                	mov    %eax,%edx
  801296:	c1 ea 1f             	shr    $0x1f,%edx
  801299:	01 d0                	add    %edx,%eax
  80129b:	d1 f8                	sar    %eax
  80129d:	89 44 24 04          	mov    %eax,0x4(%esp)
  8012a1:	c7 04 24 e2 16 80 00 	movl   $0x8016e2,(%esp)
  8012a8:	e8 73 ee ff ff       	call   800120 <cprintf>
     for (i = 0; i < TOTAL; i ++)
  8012ad:	ff 44 24 1c          	incl   0x1c(%esp)
  8012b1:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  8012b6:	7e c5                	jle    80127d <main+0x214>
     }
     cprintf("\n");
  8012b8:	c7 04 24 e6 16 80 00 	movl   $0x8016e6,(%esp)
  8012bf:	e8 5c ee ff ff       	call   800120 <cprintf>

     return 0;
  8012c4:	b8 00 00 00 00       	mov    $0x0,%eax
  8012c9:	eb 54                	jmp    80131f <main+0x2b6>
               goto failed;
  8012cb:	90                   	nop

failed:
     for (i = 0; i < TOTAL; i ++) {
  8012cc:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8012d3:	00 
  8012d4:	eb 26                	jmp    8012fc <main+0x293>
          if (pids[i] > 0) {
  8012d6:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8012da:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  8012e1:	85 c0                	test   %eax,%eax
  8012e3:	7e 13                	jle    8012f8 <main+0x28f>
               kill(pids[i]);
  8012e5:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8012e9:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  8012f0:	89 04 24             	mov    %eax,(%esp)
  8012f3:	e8 92 f0 ff ff       	call   80038a <kill>
     for (i = 0; i < TOTAL; i ++) {
  8012f8:	ff 44 24 1c          	incl   0x1c(%esp)
  8012fc:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801301:	7e d3                	jle    8012d6 <main+0x26d>
          }
     }
     panic("FAIL: T.T\n");
  801303:	c7 44 24 08 e8 16 80 	movl   $0x8016e8,0x8(%esp)
  80130a:	00 
  80130b:	c7 44 24 04 4e 00 00 	movl   $0x4e,0x4(%esp)
  801312:	00 
  801313:	c7 04 24 f3 16 80 00 	movl   $0x8016f3,(%esp)
  80131a:	e8 10 ed ff ff       	call   80002f <__panic>
}
