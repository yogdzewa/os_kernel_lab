...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800066:	68 5a 0f 80 00       	push   $0x800f5a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	68 5c 0f 80 00       	push   $0x800f5c
  ...
  8000b4:	68 5a 0f 80 00       	push   $0x800f5a
...
exit(int error_code) {
  ...
  800279:	68 78 0f 80 00       	push   $0x800f78
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800411:	05 a4 10 80 00       	add    $0x8010a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800556:	8b 04 85 c8 10 80 00 	mov    0x8010c8(,%eax,4),%eax
  ...
  800628:	8b 34 9d 40 10 80 00 	mov    0x801040(,%ebx,4),%esi
  80062f:	85 f6                	test   %esi,%esi
  800631:	75 19                	jne    80064c <vprintfmt+0x164>
                printfmt(putch, putdat, "error %d", err);
  800633:	53                   	push   %ebx
  800634:	68 b5 10 80 00       	push   $0x8010b5
  ...
  800647:	e9 37 02 00 00       	jmp    800883 <vprintfmt+0x39b>
                printfmt(putch, putdat, "%s", p);
  80064c:	56                   	push   %esi
  80064d:	68 be 10 80 00       	push   $0x8010be
  ...
  800672:	75 05                	jne    800679 <vprintfmt+0x191>
                p = "(null)";
  800674:	be c1 10 80 00       	mov    $0x8010c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800eec:	68 20 12 80 00       	push   $0x801220
  800ef1:	e8 1b f2 ff ff       	call   800111 <cprintf>
  800ef6:	83 c4 10             	add    $0x10,%esp
    cprintf("I am process %d.\n", getpid());
  800ef9:	e8 eb f3 ff ff       	call   8002e9 <getpid>
  800efe:	83 ec 08             	sub    $0x8,%esp
  800f01:	50                   	push   %eax
  800f02:	68 30 12 80 00       	push   $0x801230
  800f07:	e8 05 f2 ff ff       	call   800111 <cprintf>
  800f0c:	83 c4 10             	add    $0x10,%esp
    cprintf("hello pass.\n");
  800f0f:	83 ec 0c             	sub    $0xc,%esp
  800f12:	68 42 12 80 00       	push   $0x801242
  800f17:	e8 f5 f1 ff ff       	call   800111 <cprintf>
  800f1c:	83 c4 10             	add    $0x10,%esp
    return 0;
  800f1f:	b8 00 00 00 00       	mov    $0x0,%eax
}
  800f24:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  800f27:	c9                   	leave  
  800f28:	8d 61 fc             	lea    -0x4(%ecx),%esp
  800f2b:	c3                   	ret    
