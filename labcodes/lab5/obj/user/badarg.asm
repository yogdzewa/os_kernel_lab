...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800044:	68 00 10 80 00       	push   $0x801000
  ...
  800066:	68 1a 10 80 00       	push   $0x80101a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	68 1c 10 80 00       	push   $0x80101c
  ...
  8000b4:	68 1a 10 80 00       	push   $0x80101a
...
exit(int error_code) {
  ...
  800279:	68 38 10 80 00       	push   $0x801038
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800411:	05 64 11 80 00       	add    $0x801164,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800556:	8b 04 85 88 11 80 00 	mov    0x801188(,%eax,4),%eax
  ...
  800628:	8b 34 9d 00 11 80 00 	mov    0x801100(,%ebx,4),%esi
  80062f:	85 f6                	test   %esi,%esi
  800631:	75 19                	jne    80064c <vprintfmt+0x164>
                printfmt(putch, putdat, "error %d", err);
  800633:	53                   	push   %ebx
  800634:	68 75 11 80 00       	push   $0x801175
  ...
  800647:	e9 37 02 00 00       	jmp    800883 <vprintfmt+0x39b>
                printfmt(putch, putdat, "%s", p);
  80064c:	56                   	push   %esi
  80064d:	68 7e 11 80 00       	push   $0x80117e
  ...
  800672:	75 05                	jne    800679 <vprintfmt+0x191>
                p = "(null)";
  800674:	be 81 11 80 00       	mov    $0x801181,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800ee6:	83 ec 14             	sub    $0x14,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  800ee9:	e8 9a f3 ff ff       	call   800288 <fork>
  800eee:	89 45 f0             	mov    %eax,-0x10(%ebp)
  800ef1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  800ef5:	75 35                	jne    800f2c <main+0x54>
        cprintf("fork ok.\n");
  800ef7:	83 ec 0c             	sub    $0xc,%esp
  800efa:	68 e0 12 80 00       	push   $0x8012e0
  800eff:	e8 0d f2 ff ff       	call   800111 <cprintf>
  800f04:	83 c4 10             	add    $0x10,%esp
        int i;
        for (i = 0; i < 10; i ++) {
  800f07:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  800f0e:	eb 09                	jmp    800f19 <main+0x41>
            yield();
  800f10:	e8 b0 f3 ff ff       	call   8002c5 <yield>
        for (i = 0; i < 10; i ++) {
  800f15:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  800f19:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  800f1d:	7e f1                	jle    800f10 <main+0x38>
        }
        exit(0xbeaf);
  800f1f:	83 ec 0c             	sub    $0xc,%esp
  800f22:	68 af be 00 00       	push   $0xbeaf
  800f27:	e8 36 f3 ff ff       	call   800262 <exit>
    }
    assert(pid > 0);
  800f2c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  800f30:	7f 16                	jg     800f48 <main+0x70>
  800f32:	68 ea 12 80 00       	push   $0x8012ea
  800f37:	68 f2 12 80 00       	push   $0x8012f2
  800f3c:	6a 0f                	push   $0xf
  800f3e:	68 07 13 80 00       	push   $0x801307
  800f43:	e8 e7 f0 ff ff       	call   80002f <__panic>
    assert(waitpid(-1, NULL) != 0);
  800f48:	83 ec 08             	sub    $0x8,%esp
  800f4b:	6a 00                	push   $0x0
  800f4d:	6a ff                	push   $0xffffffff
  800f4f:	e8 58 f3 ff ff       	call   8002ac <waitpid>
  800f54:	83 c4 10             	add    $0x10,%esp
  800f57:	85 c0                	test   %eax,%eax
  800f59:	75 16                	jne    800f71 <main+0x99>
  800f5b:	68 15 13 80 00       	push   $0x801315
  800f60:	68 f2 12 80 00       	push   $0x8012f2
  800f65:	6a 10                	push   $0x10
  800f67:	68 07 13 80 00       	push   $0x801307
  800f6c:	e8 be f0 ff ff       	call   80002f <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  800f71:	83 ec 08             	sub    $0x8,%esp
  800f74:	68 00 00 00 c0       	push   $0xc0000000
  800f79:	ff 75 f0             	pushl  -0x10(%ebp)
  800f7c:	e8 2b f3 ff ff       	call   8002ac <waitpid>
  800f81:	83 c4 10             	add    $0x10,%esp
  800f84:	85 c0                	test   %eax,%eax
  800f86:	75 16                	jne    800f9e <main+0xc6>
  800f88:	68 2c 13 80 00       	push   $0x80132c
  800f8d:	68 f2 12 80 00       	push   $0x8012f2
  800f92:	6a 11                	push   $0x11
  800f94:	68 07 13 80 00       	push   $0x801307
  800f99:	e8 91 f0 ff ff       	call   80002f <__panic>
  ...
  800fa8:	e8 ff f2 ff ff       	call   8002ac <waitpid>
  800fad:	83 c4 10             	add    $0x10,%esp
  800fb0:	85 c0                	test   %eax,%eax
  800fb2:	75 0a                	jne    800fbe <main+0xe6>
  800fb4:	8b 45 ec             	mov    -0x14(%ebp),%eax
  800fb7:	3d af be 00 00       	cmp    $0xbeaf,%eax
  800fbc:	74 16                	je     800fd4 <main+0xfc>
  800fbe:	68 54 13 80 00       	push   $0x801354
  800fc3:	68 f2 12 80 00       	push   $0x8012f2
  800fc8:	6a 12                	push   $0x12
  800fca:	68 07 13 80 00       	push   $0x801307
  800fcf:	e8 5b f0 ff ff       	call   80002f <__panic>
    cprintf("badarg pass.\n");
  800fd4:	83 ec 0c             	sub    $0xc,%esp
  800fd7:	68 89 13 80 00       	push   $0x801389
  800fdc:	e8 30 f1 ff ff       	call   800111 <cprintf>
  800fe1:	83 c4 10             	add    $0x10,%esp
    return 0;
  800fe4:	b8 00 00 00 00       	mov    $0x0,%eax
}
  800fe9:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  800fec:	c9                   	leave  
  800fed:	8d 61 fc             	lea    -0x4(%ecx),%esp
  800ff0:	c3                   	ret    
