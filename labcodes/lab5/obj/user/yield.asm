...
exit(int error_code) {
  ...
  8002d2:	c7 04 24 78 10 80 00 	movl   $0x801078,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800490:	05 a4 11 80 00       	add    $0x8011a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8005e4:	8b 04 85 c8 11 80 00 	mov    0x8011c8(,%eax,4),%eax
  ...
  8006e6:	c7 44 24 08 be 11 80 	movl   $0x8011be,0x8(%esp)
  8006ed:	00 
  ...
  800712:	75 05                	jne    800719 <vprintfmt+0x1a3>
                p = "(null)";
  800714:	be c1 11 80 00       	mov    $0x8011c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fb8:	e8 91 f3 ff ff       	call   80034e <getpid>
  800fbd:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fc1:	c7 04 24 20 13 80 00 	movl   $0x801320,(%esp)
  800fc8:	e8 53 f1 ff ff       	call   800120 <cprintf>
    for (i = 0; i < 5; i ++) {
  800fcd:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  800fd4:	00 
  800fd5:	eb 26                	jmp    800ffd <main+0x4e>
        yield();
  800fd7:	e8 4d f3 ff ff       	call   800329 <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  800fdc:	e8 6d f3 ff ff       	call   80034e <getpid>
  800fe1:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  800fe5:	89 54 24 08          	mov    %edx,0x8(%esp)
  800fe9:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fed:	c7 04 24 3c 13 80 00 	movl   $0x80133c,(%esp)
  800ff4:	e8 27 f1 ff ff       	call   800120 <cprintf>
    for (i = 0; i < 5; i ++) {
  800ff9:	ff 44 24 1c          	incl   0x1c(%esp)
  800ffd:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801002:	7e d3                	jle    800fd7 <main+0x28>
    }
    cprintf("All done in process %d.\n", getpid());
  801004:	e8 45 f3 ff ff       	call   80034e <getpid>
  801009:	89 44 24 04          	mov    %eax,0x4(%esp)
  80100d:	c7 04 24 5f 13 80 00 	movl   $0x80135f,(%esp)
  801014:	e8 07 f1 ff ff       	call   800120 <cprintf>
    cprintf("yield pass.\n");
  801019:	c7 04 24 78 13 80 00 	movl   $0x801378,(%esp)
  801020:	e8 fb f0 ff ff       	call   800120 <cprintf>
    return 0;
