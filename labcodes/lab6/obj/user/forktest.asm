...
main(void) {
  ...
  801011:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801018:	00 
  801019:	eb 5f                	jmp    80107a <main+0x72>
        if ((pid = fork()) == 0) {
  80101b:	e8 f4 f2 ff ff       	call   800314 <fork>
  801020:	89 44 24 18          	mov    %eax,0x18(%esp)
  801024:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801029:	75 20                	jne    80104b <main+0x43>
            cprintf("I am child %d\n", n);
  80102b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80102f:	89 44 24 04          	mov    %eax,0x4(%esp)
  801033:	c7 04 24 04 14 80 00 	movl   $0x801404,(%esp)
  80103a:	e8 e1 f0 ff ff       	call   800120 <cprintf>
            exit(0);
  80103f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801046:	e8 aa f2 ff ff       	call   8002f5 <exit>
        }
        assert(pid > 0);
  80104b:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801050:	7f 24                	jg     801076 <main+0x6e>
  801052:	c7 44 24 0c 13 14 80 	movl   $0x801413,0xc(%esp)
  801059:	00 
  80105a:	c7 44 24 08 1b 14 80 	movl   $0x80141b,0x8(%esp)
  801061:	00 
  801062:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801069:	00 
  80106a:	c7 04 24 30 14 80 00 	movl   $0x801430,(%esp)
  801071:	e8 b9 ef ff ff       	call   80002f <__panic>
    for (n = 0; n < max_child; n ++) {
  801076:	ff 44 24 1c          	incl   0x1c(%esp)
  80107a:	b8 20 00 00 00       	mov    $0x20,%eax
  80107f:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801083:	7c 96                	jl     80101b <main+0x13>
    }

    if (n > max_child) {
  801085:	b8 20 00 00 00       	mov    $0x20,%eax
  80108a:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  80108e:	7e 4d                	jle    8010dd <main+0xd5>
        panic("fork claimed to work %d times!\n", n);
  801090:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801094:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801098:	c7 44 24 08 40 14 80 	movl   $0x801440,0x8(%esp)
  80109f:	00 
  8010a0:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  8010a7:	00 
  8010a8:	c7 04 24 30 14 80 00 	movl   $0x801430,(%esp)
  8010af:	e8 7b ef ff ff       	call   80002f <__panic>
    }

    for (; n > 0; n --) {
        if (wait() != 0) {
  8010b4:	e8 6a f2 ff ff       	call   800323 <wait>
  8010b9:	85 c0                	test   %eax,%eax
  8010bb:	74 1c                	je     8010d9 <main+0xd1>
            panic("wait stopped early\n");
  8010bd:	c7 44 24 08 60 14 80 	movl   $0x801460,0x8(%esp)
  8010c4:	00 
  8010c5:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  8010cc:	00 
  8010cd:	c7 04 24 30 14 80 00 	movl   $0x801430,(%esp)
  8010d4:	e8 56 ef ff ff       	call   80002f <__panic>
    for (; n > 0; n --) {
  8010d9:	ff 4c 24 1c          	decl   0x1c(%esp)
  8010dd:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8010e2:	7f d0                	jg     8010b4 <main+0xac>
        }
    }

    if (wait() == 0) {
  8010e4:	e8 3a f2 ff ff       	call   800323 <wait>
  8010e9:	85 c0                	test   %eax,%eax
  8010eb:	75 1c                	jne    801109 <main+0x101>
        panic("wait got too many\n");
  8010ed:	c7 44 24 08 74 14 80 	movl   $0x801474,0x8(%esp)
  8010f4:	00 
  8010f5:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8010fc:	00 
  8010fd:	c7 04 24 30 14 80 00 	movl   $0x801430,(%esp)
  801104:	e8 26 ef ff ff       	call   80002f <__panic>
    }

    cprintf("forktest pass.\n");
  801109:	c7 04 24 87 14 80 00 	movl   $0x801487,(%esp)
  801110:	e8 0b f0 ff ff       	call   800120 <cprintf>
    return 0;
