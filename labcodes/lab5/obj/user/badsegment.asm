...
exit(int error_code) {
  ...
  8002d2:	c7 04 24 18 10 80 00 	movl   $0x801018,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800490:	05 44 11 80 00       	add    $0x801144,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8005e4:	8b 04 85 68 11 80 00 	mov    0x801168(,%eax,4),%eax
  ...
  8006e6:	c7 44 24 08 5e 11 80 	movl   $0x80115e,0x8(%esp)
  8006ed:	00 
  ...
  800712:	75 05                	jne    800719 <vprintfmt+0x1a3>
                p = "(null)";
  800714:	be 61 11 80 00       	mov    $0x801161,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fb8:	66 b8 28 00          	mov    $0x28,%ax
  800fbc:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  800fbe:	c7 44 24 08 c0 12 80 	movl   $0x8012c0,0x8(%esp)
  800fc5:	00 
  800fc6:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  800fcd:	00 
  800fce:	c7 04 24 cb 12 80 00 	movl   $0x8012cb,(%esp)
  800fd5:	e8 55 f0 ff ff       	call   80002f <__panic>
