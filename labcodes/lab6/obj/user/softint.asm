...
main(void) {
  ...
  80100e:	83 ec 10             	sub    $0x10,%esp
    asm volatile("int $14");
  801011:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  801013:	c7 44 24 08 20 13 80 	movl   $0x801320,0x8(%esp)
  80101a:	00 
  80101b:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  801022:	00 
  801023:	c7 04 24 2b 13 80 00 	movl   $0x80132b,(%esp)
  80102a:	e8 00 f0 ff ff       	call   80002f <__panic>
