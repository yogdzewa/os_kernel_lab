...
exit(int error_code) {
  ...
  800306:	c7 04 24 d8 10 80 00 	movl   $0x8010d8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004e9:	05 04 12 80 00       	add    $0x801204,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80063d:	8b 04 85 28 12 80 00 	mov    0x801228(,%eax,4),%eax
  ...
  80073f:	c7 44 24 08 1e 12 80 	movl   $0x80121e,0x8(%esp)
  800746:	00 
  ...
  80076b:	75 05                	jne    800772 <vprintfmt+0x1a3>
                p = "(null)";
  80076d:	be 21 12 80 00       	mov    $0x801221,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801011:	e8 6c f3 ff ff       	call   800382 <getpid>
  801016:	89 44 24 04          	mov    %eax,0x4(%esp)
  80101a:	c7 04 24 80 13 80 00 	movl   $0x801380,(%esp)
  801021:	e8 fa f0 ff ff       	call   800120 <cprintf>
    for (i = 0; i < 5; i ++) {
  801026:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80102d:	00 
  80102e:	eb 26                	jmp    801056 <main+0x4e>
        yield();
  801030:	e8 28 f3 ff ff       	call   80035d <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  801035:	e8 48 f3 ff ff       	call   800382 <getpid>
  80103a:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  80103e:	89 54 24 08          	mov    %edx,0x8(%esp)
  801042:	89 44 24 04          	mov    %eax,0x4(%esp)
  801046:	c7 04 24 9c 13 80 00 	movl   $0x80139c,(%esp)
  80104d:	e8 ce f0 ff ff       	call   800120 <cprintf>
    for (i = 0; i < 5; i ++) {
  801052:	ff 44 24 1c          	incl   0x1c(%esp)
  801056:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  80105b:	7e d3                	jle    801030 <main+0x28>
    }
    cprintf("All done in process %d.\n", getpid());
  80105d:	e8 20 f3 ff ff       	call   800382 <getpid>
  801062:	89 44 24 04          	mov    %eax,0x4(%esp)
  801066:	c7 04 24 bf 13 80 00 	movl   $0x8013bf,(%esp)
  80106d:	e8 ae f0 ff ff       	call   800120 <cprintf>
    cprintf("yield pass.\n");
  801072:	c7 04 24 d8 13 80 00 	movl   $0x8013d8,(%esp)
  801079:	e8 a2 f0 ff ff       	call   800120 <cprintf>
    return 0;
