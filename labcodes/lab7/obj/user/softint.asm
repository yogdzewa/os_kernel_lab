...
main(void) {
  ...
  801040:	83 ec 10             	sub    $0x10,%esp
    asm volatile("int $14");
  801043:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  801045:	c7 44 24 08 60 13 80 	movl   $0x801360,0x8(%esp)
  80104c:	00 
  80104d:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  801054:	00 
  801055:	c7 04 24 6b 13 80 00 	movl   $0x80136b,(%esp)
