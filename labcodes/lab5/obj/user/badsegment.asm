...
main(void) {
  ...
  800ee9:	66 b8 28 00          	mov    $0x28,%ax
  800eed:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  800eef:	83 ec 04             	sub    $0x4,%esp
  800ef2:	68 00 12 80 00       	push   $0x801200
  800ef7:	6a 09                	push   $0x9
  800ef9:	68 0b 12 80 00       	push   $0x80120b
  800efe:	e8 2c f1 ff ff       	call   80002f <__panic>
