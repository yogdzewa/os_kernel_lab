...
main(void) {
  ...
  800fd2:	75 0e                	jne    800fe2 <main+0x33>
        cprintf("I am the child. spinning ...\n");
  800fd4:	c7 04 24 e7 13 80 00 	movl   $0x8013e7,(%esp)
  800fdb:	e8 40 f1 ff ff       	call   800120 <cprintf>
        while (1);
  800fe0:	eb fe                	jmp    800fe0 <main+0x31>
    }
    cprintf("I am the parent. Running the child...\n");
  800fe2:	c7 04 24 08 14 80 00 	movl   $0x801408,(%esp)
  800fe9:	e8 32 f1 ff ff       	call   800120 <cprintf>

    yield();
  800fee:	e8 36 f3 ff ff       	call   800329 <yield>
    yield();
  800ff3:	e8 31 f3 ff ff       	call   800329 <yield>
    yield();
  800ff8:	e8 2c f3 ff ff       	call   800329 <yield>

    cprintf("I am the parent.  Killing the child...\n");
  800ffd:	c7 04 24 30 14 80 00 	movl   $0x801430,(%esp)
  801004:	e8 17 f1 ff ff       	call   800120 <cprintf>

    assert((ret = kill(pid)) == 0);
  801009:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80100d:	89 04 24             	mov    %eax,(%esp)
  801010:	e8 24 f3 ff ff       	call   800339 <kill>
  801015:	89 44 24 18          	mov    %eax,0x18(%esp)
  801019:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80101e:	74 24                	je     801044 <main+0x95>
  801020:	c7 44 24 0c 58 14 80 	movl   $0x801458,0xc(%esp)
  801027:	00 
  801028:	c7 44 24 08 6f 14 80 	movl   $0x80146f,0x8(%esp)
  80102f:	00 
  801030:	c7 44 24 04 14 00 00 	movl   $0x14,0x4(%esp)
  801037:	00 
  801038:	c7 04 24 84 14 80 00 	movl   $0x801484,(%esp)
  80103f:	e8 eb ef ff ff       	call   80002f <__panic>
    cprintf("kill returns %d\n", ret);
  801044:	8b 44 24 18          	mov    0x18(%esp),%eax
  801048:	89 44 24 04          	mov    %eax,0x4(%esp)
  80104c:	c7 04 24 90 14 80 00 	movl   $0x801490,(%esp)
  801053:	e8 c8 f0 ff ff       	call   800120 <cprintf>

    assert((ret = waitpid(pid, NULL)) == 0);
  801058:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80105f:	00 
  801060:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801064:	89 04 24             	mov    %eax,(%esp)
  801067:	e8 a1 f2 ff ff       	call   80030d <waitpid>
  80106c:	89 44 24 18          	mov    %eax,0x18(%esp)
  801070:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801075:	74 24                	je     80109b <main+0xec>
  801077:	c7 44 24 0c a4 14 80 	movl   $0x8014a4,0xc(%esp)
  80107e:	00 
  80107f:	c7 44 24 08 6f 14 80 	movl   $0x80146f,0x8(%esp)
  801086:	00 
  801087:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  80108e:	00 
  80108f:	c7 04 24 84 14 80 00 	movl   $0x801484,(%esp)
  801096:	e8 94 ef ff ff       	call   80002f <__panic>
    cprintf("wait returns %d\n", ret);
  80109b:	8b 44 24 18          	mov    0x18(%esp),%eax
  80109f:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010a3:	c7 04 24 c4 14 80 00 	movl   $0x8014c4,(%esp)
  8010aa:	e8 71 f0 ff ff       	call   800120 <cprintf>

    cprintf("spin may pass.\n");
  8010af:	c7 04 24 d5 14 80 00 	movl   $0x8014d5,(%esp)
  8010b6:	e8 65 f0 ff ff       	call   800120 <cprintf>
    return 0;
